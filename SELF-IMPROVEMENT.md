...
- **Next up (Loops 12+):** keep the founder-news cadence (weekly/at-news-events roundups into "AI for Founders"); then the bigger builds still open — (a) HOMEPAGE global-news digest, (b) eval-harness reweight toward engagement/freshness, (c) analytics auto-commissioning (blocked until `/api/analytics` reachable), (d) GUIDES/TOOLS/NEWS nav surfacing the new cluster.
