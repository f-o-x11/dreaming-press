# Analytics brief — auto-exported 2026-09-23T00:18Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3333 views → 350 engaged reads → 22 completes · 3234 sessions.
- Channels: direct 159r/2928v · organic 114r/152v · campaign:chatgpt.com 48r/153v · ai 15r/38v · referral 11r/56v · campaign:qwant 2r/2v · social 1r/3v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
...
- direct: 2928 views · read 5.4% · complete 0.5% · 0.99 pages/session · median 4s
...
- OAI-SearchBot (3651 verified): /wire.html ×50 · /tools ×33 · /posts/local-llm-for-coding-on-your-own-machine.html ×28
...
The real answer engines are crawling us — IP-verified: 19489 confirmed AI-engine fetches (Perplexity 8370, GPTBot (OpenAI) 4446, ChatGPT Search (OpenAI) 3651, ChatGPT (user browsing) 3022).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 671 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 236 crawler fetches
