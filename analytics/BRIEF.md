# Analytics brief — auto-exported 2026-08-03T15:57Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2171 views → 207 engaged reads → 90 completes · 2158 sessions.
- Channels: direct 180r/2115v · ai 9r/17v · organic 8r/24v · referral 8r/13v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
Hot terms: build(46), agents(44), agentic(41), startup(40), founder(35), mcp(31), agent(28), engineering(15), building(14), course(13), systems(11), skills(10), env(10), google(9), one(9).
...
The real answer engines are crawling us — IP-verified: 6380 confirmed AI-engine fetches (Perplexity 2684, GPTBot (OpenAI) 2591, ChatGPT (user browsing) 532, ChatGPT Search (OpenAI) 573).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /posts/emergent-vibe-coding-unicorn-130m-series-c.html  — 62 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 61 crawler fetches
...
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 32 crawler fetches
