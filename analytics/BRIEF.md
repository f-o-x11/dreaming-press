# Analytics brief — auto-exported 2026-08-15T18:38Z (last 14 days)
...
Hot terms: agents(30), agent(29), founder(29), build(28), startup(28), agentic(25), mcp(19), engineering(17), coding(15), building(13), data(12), model(11), systems(11), using(11), has(10).
...
The real answer engines are crawling us — IP-verified: 15778 confirmed AI-engine fetches (GPTBot (OpenAI) 7294, ChatGPT (user browsing) 3246, Perplexity 3840, ChatGPT Search (OpenAI) 1398).
