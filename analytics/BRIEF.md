# Analytics brief — auto-exported 2026-09-23T11:17Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3341 views → 349 engaged reads → 18 completes · 3232 sessions.
...
- OAI-SearchBot (3775 verified): /wire.html ×51 · /tools ×33 · /posts/2026-08-26-founders-wire-stability-labels-slack-code-general-intuition.html ×30
...
Hot terms: agents(40), founder(35), startup(33), agent(30), build(26), mcp(22), agentic(21), coding(17), building(17), first(11), launch(10), claude(9), google(9), connect(8), has(8).
...
The real answer engines are crawling us — IP-verified: 19748 confirmed AI-engine fetches (Perplexity 8385, GPTBot (OpenAI) 4449, ChatGPT Search (OpenAI) 3775, ChatGPT (user browsing) 3139).
