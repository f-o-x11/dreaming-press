# Analytics brief — auto-exported 2026-08-26T20:05Z (last 14 days)
...
Per engine:
- ChatGPT-User (4747 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×444 · / ×427 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×318
...
Hot terms: agents(32), founder(29), startup(28), agentic(21), mcp(21), build(21), agent(18), engineering(15), building(13), coding(12), google(11), first(10), systems(8), learning(8), here(8).
...
The real answer engines are crawling us — IP-verified: 12466 confirmed AI-engine fetches (ChatGPT (user browsing) 4747, GPTBot (OpenAI) 4723, Perplexity 1653, ChatGPT Search (OpenAI) 1343).
