# Analytics brief — auto-exported 2026-08-18T22:11Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3238 views → 290 engaged reads → 108 completes · 3222 sessions.
- Channels: direct 236r/3137v · organic 35r/59v · referral 7r/13v · ai 6r/18v · campaign:chatgpt.com 5r/10v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3137 views · read 7.5% · complete 3.4% · 0.99 pages/session · median 6s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 264 retrieval fetches
...
Per engine:
- ChatGPT-User (4380 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×264 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×253 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×226
...
Hot terms: agents(37), agentic(32), founder(31), startup(31), build(28), agent(23), mcp(19), building(17), one(11), coding(11), skills(10), code(10), systems(10), engineering(10), every(10).
...
The real answer engines are crawling us — IP-verified: 17115 confirmed AI-engine fetches (GPTBot (OpenAI) 7468, ChatGPT (user browsing) 4380, Perplexity 3956, ChatGPT Search (OpenAI) 1311).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 715 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 264 crawler fetches
