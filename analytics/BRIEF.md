# Analytics brief — auto-exported 2026-08-23T21:15Z (last 14 days)
...
- OAI-SearchBot (1152 verified): /build ×23 · / ×11 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×5
...
Hot terms: agents(40), founder(32), agentic(31), startup(25), agent(23), mcp(20), build(20), coding(17), building(16), code(13), one(12), about(12), claude(11), first(10), launch(9).
...
The real answer engines are crawling us — IP-verified: 13978 confirmed AI-engine fetches (ChatGPT (user browsing) 5019, GPTBot (OpenAI) 4723, Perplexity 3084, ChatGPT Search (OpenAI) 1152).
