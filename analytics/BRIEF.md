# Analytics brief — auto-exported 2026-09-25T22:30Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3307 views → 320 engaged reads → 14 completes · 3189 sessions.
- Channels: direct 154r/2843v · organic 96r/138v · campaign:chatgpt.com 39r/222v · ai 14r/35v · referral 13r/61v · campaign:qwant 4r/6v · campaign:producthunt/ 0r/1v · social 0r/1v · internal-nav 0r/0v.
...
- OAI-SearchBot (4514 verified): /wire.html ×60 · /tools ×35 · /posts/2026-08-31-founders-wire-openai-cursor-cutoff-claudeforce-a16z-machine-age.html ×30
...
Hot terms: agents(38), agent(36), founder(36), startup(28), build(24), agentic(24), coding(20), building(17), mcp(15), jev(11), claude(9), one(9), big(8), day(8), make(8).
...
The real answer engines are crawling us — IP-verified: 20561 confirmed AI-engine fetches (Perplexity 7891, GPTBot (OpenAI) 4925, ChatGPT Search (OpenAI) 4514, ChatGPT (user browsing) 3231).
