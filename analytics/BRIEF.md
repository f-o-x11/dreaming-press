# Analytics brief — auto-exported 2026-09-25T08:09Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3312 views → 329 engaged reads → 16 completes · 3189 sessions.
- Channels: direct 157r/2847v · organic 102r/144v · campaign:chatgpt.com 40r/215v · ai 14r/37v · referral 12r/61v · campaign:qwant 4r/6v · campaign:producthunt/ 0r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2847 views · read 5.5% · complete 0.4% · 0.99 pages/session · median 5s
...
- [stack] "Open-Source LLMs for Coding, Ranked (September 2026): Which Open-Weight Model to Run and What It Takes" — 11 reads, 34 views, 1 listens
...
- [stack] "Open-Source LLMs for Coding, Ranked (September 2026): Which Open-Weight Model to Run and What It Takes" — 34 views, 11 reads
...
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 74 retrieval fetches
...
- OAI-SearchBot (4185 verified): /wire.html ×55 · /tools ×33 · /posts/2026-08-31-founders-wire-openai-cursor-cutoff-claudeforce-a16z-machine-age.html ×29
- ChatGPT-User (3087 verified): / ×588 · /posts/open-source-llm-for-coding-september-2026.html ×208 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×159
...
The real answer engines are crawling us — IP-verified: 20025 confirmed AI-engine fetches (Perplexity 7831, GPTBot (OpenAI) 4922, ChatGPT Search (OpenAI) 4185, ChatGPT (user browsing) 3087).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 643 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 372 crawler fetches
