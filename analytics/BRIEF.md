# Analytics brief — auto-exported 2026-08-02T17:08Z (last 14 days)
...
Hot terms: build(46), agents(40), agentic(36), agent(35), startup(34), founder(33), mcp(29), engineering(13), systems(12), coding(11), code(10), env(10), course(9), memory(9), google(8).
...
The real answer engines are crawling us — IP-verified: 6077 confirmed AI-engine fetches (Perplexity 2608, GPTBot (OpenAI) 2591, ChatGPT (user browsing) 386, ChatGPT Search (OpenAI) 492).
