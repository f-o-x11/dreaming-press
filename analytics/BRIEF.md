# Analytics brief — auto-exported 2026-07-12T21:47Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard:

- Funnel: 210 views → 20 engaged reads → 9 completes · 199 sessions.
- Channels: direct 19r/208v · ai 1r/1v · organic 0r/1v.
...
The real answer engines are crawling us — IP-verified: 4044 confirmed AI-engine fetches (GPTBot (OpenAI) 4037, ChatGPT (user browsing) 4, Perplexity 2, ChatGPT Search (OpenAI) 1).
