# Analytics brief — auto-exported 2026-08-12T18:18Z (last 14 days)
...
Hot terms: build(34), agents(34), founder(32), agentic(31), mcp(27), startup(27), agent(24), skills(20), building(17), has(15), claude(13), engineering(13), using(12), systems(12), through(10).
...
The real answer engines are crawling us — IP-verified: 12126 confirmed AI-engine fetches (GPTBot (OpenAI) 4229, Perplexity 3558, ChatGPT (user browsing) 2794, ChatGPT Search (OpenAI) 1545).
