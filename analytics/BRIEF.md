# Analytics brief — auto-exported 2026-09-08T14:47Z (last 14 days)
...
- ChatGPT-User (3016 verified): / ×555 · /posts/agent-funding-august-2026-control-won-the-summer.html ×147 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×100
...
Hot terms: agents(34), agentic(31), startup(28), build(27), founder(24), mcp(20), building(19), coding(16), code(16), agent(14), model(10), claude(10), co-founder(10), own(9), launch(9).
...
The real answer engines are crawling us — IP-verified: 17079 confirmed AI-engine fetches (Perplexity 8334, ChatGPT Search (OpenAI) 3465, ChatGPT (user browsing) 3016, GPTBot (OpenAI) 2264).
