# Analytics brief — auto-exported 2026-08-10T16:40Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3097 views → 296 engaged reads → 120 completes · 3102 sessions.
- Channels: direct 256r/3016v · organic 22r/42v · ai 12r/26v · referral 5r/12v · campaign:chatgpt.com 1r/1v.
...
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 128 views, 1 reads
...
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 128 views but only 1 engaged reads (0.8%)
...
Hot terms: agents(33), build(32), agentic(32), founder(27), startup(27), mcp(25), agent(21), skills(20), building(17), has(16), claude(14), systems(13), coding(12), using(11), tools(11).
...
## Uncovered search demand (305 of 438 phrases have NO post, 32h ago)
...
The real answer engines are crawling us — IP-verified: 9569 confirmed AI-engine fetches (GPTBot (OpenAI) 4226, ChatGPT (user browsing) 1876, Perplexity 2137, ChatGPT Search (OpenAI) 1330).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 501 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 146 crawler fetches
...
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 75 crawler fetches
...
- /posts/the-performance-no-one-attends.html  — 28 crawler fetches
