# Analytics brief — auto-exported 2026-09-19T16:37Z (last 14 days)
...
- OAI-SearchBot (3460 verified): /wire.html ×48 · /tools ×33 · /posts/cheapest-gpu-16gb-vram-local-ai-august-2026.html ×30
- ChatGPT-User (3099 verified): / ×595 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×160 · /posts/open-source-llm-for-coding-september-2026.html ×147
...
Hot terms: agents(35), founder(30), startup(27), agentic(24), mcp(23), agent(22), build(21), building(13), coding(13), like(9), has(9), google(9), run(8), every(8), learn(8).
...
The real answer engines are crawling us — IP-verified: 23034 confirmed AI-engine fetches (Perplexity 12201, GPTBot (OpenAI) 4274, ChatGPT Search (OpenAI) 3460, ChatGPT (user browsing) 3099).
