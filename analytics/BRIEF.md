# Analytics brief — auto-exported 2026-09-23T18:14Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3317 views → 347 engaged reads → 19 completes · 3191 sessions.
- Channels: direct 163r/2912v · organic 112r/154v · campaign:chatgpt.com 40r/143v · ai 16r/40v · referral 11r/59v · campaign:qwant 4r/5v · social 1r/3v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
...
- organic: 154 views · read 72.7% · complete 0.6% · 1.31 pages/session · median ?s
...
- ChatGPT-User (3215 verified): / ×608 · /posts/open-source-llm-for-coding-september-2026.html ×215 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×160
...
Hot terms: agents(40), founder(36), startup(34), agent(29), build(28), agentic(22), mcp(20), building(19), coding(18), first(10), claude(9), google(9), launch(9), like(8), has(8).
...
The real answer engines are crawling us — IP-verified: 20339 confirmed AI-engine fetches (Perplexity 8391, GPTBot (OpenAI) 4919, ChatGPT Search (OpenAI) 3814, ChatGPT (user browsing) 3215).
