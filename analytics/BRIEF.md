# Analytics brief — auto-exported 2026-08-14T16:52Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2951 views → 303 engaged reads → 115 completes · 2949 sessions.
- Channels: direct 250r/2851v · organic 28r/52v · ai 14r/30v · referral 5r/11v · campaign:chatgpt.com 5r/6v · campaign:copilot.com 1r/1v.
...
Hot terms: founder(32), build(31), startup(30), agents(29), agentic(29), agent(23), mcp(21), coding(15), systems(14), building(14), through(13), has(13), stack(12), using(12), model(11).
...
## Uncovered search demand (290 of 439 phrases have NO post, 5h ago)
...
The real answer engines are crawling us — IP-verified: 12934 confirmed AI-engine fetches (GPTBot (OpenAI) 4471, ChatGPT (user browsing) 3272, Perplexity 3767, ChatGPT Search (OpenAI) 1424).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 580 crawler fetches
...
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 124 crawler fetches
- /posts/2026-07-22-founders-wire-portable-context-agents-in-chat-open-coders.html  — 120 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 120 crawler fetches
