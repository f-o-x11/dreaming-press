# Analytics brief — auto-exported 2026-08-19T19:44Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3255 views → 291 engaged reads → 103 completes · 3241 sessions.
- Channels: direct 233r/3150v · organic 36r/61v · referral 8r/14v · ai 7r/18v · campaign:chatgpt.com 6r/10v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 3150 views · read 7.4% · complete 3.2% · 0.99 pages/session · median 5s
...
- /stack/:tool — 178 views, 0 reads, 182 sessions, avg 4s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 302 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 280 retrieval fetches
- /  — 267 retrieval fetches
...
Per engine:
- ChatGPT-User (4711 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×302 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×280 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×224
...
Hot terms: agents(44), agentic(33), founder(33), startup(30), build(25), agent(22), building(15), mcp(14), code(12), skills(11), claude(10), every(10), data(10), about(9), one(9).
...
The real answer engines are crawling us — IP-verified: 17118 confirmed AI-engine fetches (GPTBot (OpenAI) 7521, ChatGPT (user browsing) 4711, Perplexity 3620, ChatGPT Search (OpenAI) 1266).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 720 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 302 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 285 crawler fetches
