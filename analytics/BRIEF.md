# Analytics brief — auto-exported 2026-09-25T15:57Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3305 views → 327 engaged reads → 15 completes · 3178 sessions.
- Channels: direct 158r/2840v · organic 99r/141v · campaign:chatgpt.com 39r/219v · ai 14r/35v · referral 13r/62v · campaign:qwant 4r/6v · campaign:producthunt/ 0r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2840 views · read 5.6% · complete 0.4% · 1 pages/session · median 5s
...
- OAI-SearchBot (4349 verified): /wire.html ×58 · /tools ×33 · /posts/local-llm-for-coding-on-your-own-machine.html ×30
...
The real answer engines are crawling us — IP-verified: 20300 confirmed AI-engine fetches (Perplexity 7857, GPTBot (OpenAI) 4922, ChatGPT Search (OpenAI) 4349, ChatGPT (user browsing) 3172).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 650 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 400 crawler fetches
