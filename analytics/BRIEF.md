# Analytics brief — auto-exported 2026-08-10T10:05Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3071 views → 294 engaged reads → 116 completes · 3075 sessions.
- Channels: direct 252r/2988v · organic 23r/43v · ai 12r/26v · referral 6r/13v · campaign:chatgpt.com 1r/1v.
...
The real answer engines are crawling us — IP-verified: 9296 confirmed AI-engine fetches (GPTBot (OpenAI) 4225, ChatGPT (user browsing) 1757, Perplexity 2019, ChatGPT Search (OpenAI) 1295).
