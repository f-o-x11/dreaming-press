# Analytics brief — auto-exported 2026-08-15T19:18Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2983 views → 311 engaged reads → 108 completes · 2975 sessions.
- Channels: direct 259r/2890v · organic 28r/53v · ai 12r/22v · referral 6r/11v · campaign:chatgpt.com 5r/6v · campaign:copilot.com 1r/1v.
...
Hot terms: agent(30), agents(30), founder(29), build(28), startup(28), agentic(26), mcp(19), engineering(17), coding(15), building(13), data(12), model(11), systems(11), using(11), has(10).
...
## Uncovered search demand (290 of 439 phrases have NO post, 31h ago)
...
The real answer engines are crawling us — IP-verified: 15782 confirmed AI-engine fetches (GPTBot (OpenAI) 7294, ChatGPT (user browsing) 3250, Perplexity 3840, ChatGPT Search (OpenAI) 1398).
...
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 146 crawler fetches
