# Analytics brief — auto-exported 2026-08-19T16:23Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3339 views → 292 engaged reads → 104 completes · 3324 sessions.
- Channels: direct 234r/3234v · organic 36r/61v · referral 8r/14v · ai 7r/18v · campaign:chatgpt.com 6r/10v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 3234 views · read 7.2% · complete 3.2% · 0.99 pages/session · median 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 298 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 276 retrieval fetches
...
Per engine:
- ChatGPT-User (4648 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×298 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×276 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×222
...
The real answer engines are crawling us — IP-verified: 17045 confirmed AI-engine fetches (GPTBot (OpenAI) 7520, ChatGPT (user browsing) 4648, Perplexity 3620, ChatGPT Search (OpenAI) 1257).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 716 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 298 crawler fetches
