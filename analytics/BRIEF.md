# Analytics brief — auto-exported 2026-08-19T01:45Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3255 views → 289 engaged reads → 107 completes · 3238 sessions.
- Channels: direct 235r/3154v · organic 35r/59v · referral 7r/13v · ai 6r/18v · campaign:chatgpt.com 5r/10v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3154 views · read 7.5% · complete 3.3% · 0.99 pages/session · median 6s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 270 retrieval fetches
...
Per engine:
- ChatGPT-User (4367 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×270 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×258 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×213
...
The real answer engines are crawling us — IP-verified: 16622 confirmed AI-engine fetches (GPTBot (OpenAI) 7463, ChatGPT (user browsing) 4367, Perplexity 3541, ChatGPT Search (OpenAI) 1251).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 695 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 270 crawler fetches
