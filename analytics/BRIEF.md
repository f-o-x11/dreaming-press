# Analytics brief — auto-exported 2026-08-19T08:29Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3284 views → 290 engaged reads → 105 completes · 3269 sessions.
- Channels: direct 234r/3178v · organic 34r/60v · referral 8r/15v · ai 7r/19v · campaign:chatgpt.com 6r/10v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 3178 views · read 7.4% · complete 3.2% · 0.99 pages/session · median 5s
- organic: 60 views · read 56.7% · complete 3.3% · 1.03 pages/session · median ?s
...
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 7 reads, 30 views, 0 listens
...
- /stack/:tool — 161 views, 0 reads, 165 sessions, avg 5s
...
- /series — 4 views, 0 reads, 4 sessions, avg 3s
...
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 30 views, 7 reads
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 282 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 266 retrieval fetches
- /  — 248 retrieval fetches
...
Per engine:
- ChatGPT-User (4484 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×282 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×266 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×216
...
Hot terms: agents(38), agentic(34), founder(31), startup(30), build(22), agent(21), building(16), mcp(16), skills(11), every(11), claude(10), systems(10), one(9), code(9), coding(9).
...
## Uncovered search demand (286 of 438 phrases have NO post, 45h ago)
...
The real answer engines are crawling us — IP-verified: 16742 confirmed AI-engine fetches (GPTBot (OpenAI) 7464, ChatGPT (user browsing) 4484, Perplexity 3541, ChatGPT Search (OpenAI) 1253).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 703 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 282 crawler fetches
