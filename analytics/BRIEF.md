# Analytics brief — auto-exported 2026-09-23T23:08Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3326 views → 346 engaged reads → 20 completes · 3198 sessions.
- Channels: direct 164r/2921v · organic 110r/150v · campaign:chatgpt.com 40r/148v · ai 16r/40v · referral 11r/58v · campaign:qwant 4r/5v · social 1r/3v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
- AI assistants (our real front door): ChatGPT 42r/162v · Doubao 11r/15v · Perplexity 2r/5v · Claude 1r/1v · Kimi 0r/4v · DeepSeek 0r/1v.
- Referrers: mail.google.com, bing.com, chatgpt.com, duckduckgo.com, cn.bing.com, doubao.com, search.brave.com, brand, dash-range, nav-cmp.
- Engaged-read winners by section: wire=7, stack=8.

## NEXT-CLICK SURFACES (what actually earns the second pageview)
- brand: 12 clicks from 9 sessions
...
- btn-agents: 5 clicks from 3 sessions
...
- direct: 2921 views · read 5.6% · complete 0.5% · 0.99 pages/session · median 5s
- organic: 150 views · read 73.3% · complete 0.7% · 1.3 pages/session · median ?s
- campaign:chatgpt.com: 148 views · read 27.0% · complete 1.4% · 1.02 pages/session · median ?s
- referral: 58 views · read 19.0% · complete 0.0% · 1.04 pages/session · median ?s
- ai: 40 views · read 40.0% · complete 2.5% · 0.74 pages/session · median 26s
...
- [stack] "The Open-Source LLM Leaderboard, September 2026: The Best Open-Weight Models to Run Locally (and Which You Can Actually Ship)" — 11 reads, 38 views, 1 listens
...
- [wire] "Playwright MCP vs the CLI: Why Your Browser Agent Burns 114K Tokens When It Could Use 27K" — 6 reads, 15 views, 0 listens
- [wire] "vLLM v0.24 Makes Model Runner V2 the Default. The Win Isn't a Faster Kernel — It's Never Waiting on the CPU." — 6 reads, 13 views, 0 listens
...
- [wire] "Where to Actually Rent a GPU to Serve an Open Model in 2026: CoreWeave vs Lambda vs Nebius vs RunPod vs Together" — 5 reads, 11 views, 0 listens

## Top by listens (audio is now on every piece — Item 1)
- [stack] "Open-Source LLMs for Coding, Ranked (September 2026): Which Open-Weight Model to Run and What It Takes" — 1 listens, 12 reads
...
- [wire] "Best LLM for Function Calling: Why the Leaderboard Score Lies" — 1 listens, 2 reads

## Hubs and tools (non-article routes)
The interactive surfaces. /build is the most-crawled path on the whole domain,
so what these earn from humans is the other half of the picture.
- /stack/:tool — 393 views, 0 reads, 393 sessions, avg 3s
- / — 120 views, 1 reads, 119 sessions, avg 12s
- /build — 41 views, 0 reads, 41 sessions, avg 5s
- /best/:cat — 39 views, 0 reads, 39 sessions, avg 4s
- /dashboard — 27 views, 0 reads, 14 sessions, avg 8s
- /compare/:pair — 24 views, 2 reads, 24 sessions, avg 27s
...
- [stack] "The Open-Source LLM Leaderboard, September 2026: The Best Open-Weight Models to Run Locally (and Which You Can Actually Ship)" — 38 views, 11 reads
...
- [wire] "China Regulated What an AI May Pretend to Be — So Doubao and Qwen Switched Their Companion Agents Off Rather Than Comply" — 29 views, 0 reads
...
- [wire] "China Regulated What an AI May Pretend to Be — So Doubao and Qwen Switched Their Companion Agents Off Rather Than Comply" — 29 views but only 0 engaged reads (0.0%)
- [stack] "The Best Open-Source Frameworks for Training AI Agents with Reinforcement Learning" — 27 views but only 0 engaged reads (0.0%)
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in September 2026" — 23 views but only 1 engaged reads (4.3%)
...
- /posts/gpu-rental-price-september-2026-b200-floor-under-4.html  — 193 retrieval fetches
- /build  — 85 retrieval fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 68 retrieval fetches
- /posts/how-to-implement-contextual-retrieval-hybrid-bm25-rerank.html  — 63 retrieval fetches
...
Per engine:
- PerplexityBot (8410 verified): /build ×85 · / ×28 · /posts/2026-09-08-founders-wire-nvidia-hugging-face-openai-managed-agents-anthropic-payments.html ×23
- OAI-SearchBot (3875 verified): /wire.html ×53 · /tools ×34 · /posts/local-llm-for-coding-on-your-own-machine.html ×30
- ChatGPT-User (3254 verified): / ×616 · /posts/open-source-llm-for-coding-september-2026.html ×216 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×163
...
Hot terms: agents(43), founder(35), startup(32), agent(29), build(26), agentic(21), building(20), coding(19), mcp(18), google(9), security(8), claude(8), like(8), launch(8), first(8).
...
## Uncovered search demand (248 of 450 phrases have NO post, 59h ago)
...
The real answer engines are crawling us — IP-verified: 20459 confirmed AI-engine fetches (Perplexity 8410, GPTBot (OpenAI) 4920, ChatGPT Search (OpenAI) 3875, ChatGPT (user browsing) 3254).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 696 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 227 crawler fetches
- /posts/open-source-llm-for-coding-september-2026.html  — 226 crawler fetches
- /posts/gpu-rental-price-september-2026-b200-floor-under-4.html  — 198 crawler fetches
- /posts/2026-06-21-routellm-vs-notdiamond-vs-martian.html  — 191 crawler fetches
...
- /posts/how-to-implement-contextual-retrieval-hybrid-bm25-rerank.html  — 63 crawler fetches
- /tools  — 37 crawler fetches
- /posts/gpt-5-6-terra-vs-kimi-k3-mid-tier-agent-backend.html  — 34 crawler fetches
