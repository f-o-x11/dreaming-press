# Analytics brief — auto-exported 2026-08-24T07:56Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2869 views → 248 engaged reads → 80 completes · 2825 sessions.
- Channels: direct 178r/2739v · organic 40r/66v · referral 11r/26v · ai 9r/19v · campaign:chatgpt.com 9r/16v · campaign:copilot.com 1r/1v · campaign:perplexity 0r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2739 views · read 6.5% · complete 2.8% · 1 pages/session · median 4s
...
- /stack/:tool — 325 views, 0 reads, 328 sessions, avg 4s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 404 retrieval fetches
...
Per engine:
- ChatGPT-User (4855 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×404 · / ×348 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×327
...
The real answer engines are crawling us — IP-verified: 13606 confirmed AI-engine fetches (ChatGPT (user browsing) 4855, GPTBot (OpenAI) 4721, Perplexity 2966, ChatGPT Search (OpenAI) 1064).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 741 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 408 crawler fetches
...
- /posts/how-to-harden-your-repo-against-ai-agent-poisoned-prs.html  — 121 crawler fetches
