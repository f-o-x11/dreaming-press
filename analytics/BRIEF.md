# Analytics brief — auto-exported 2026-08-02T06:32Z (last 14 days)
...
Hot terms: build(45), agents(42), startup(35), founder(34), agentic(32), agent(32), mcp(26), engineering(13), code(11), systems(11), building(11), coding(10), env(10), model(9), course(8).
...
The real answer engines are crawling us — IP-verified: 6009 confirmed AI-engine fetches (Perplexity 2608, GPTBot (OpenAI) 2589, ChatGPT (user browsing) 344, ChatGPT Search (OpenAI) 468).
