# Analytics brief — auto-exported 2026-09-23T12:18Z (last 14 days)
...
- OAI-SearchBot (3788 verified): /wire.html ×51 · /tools ×33 · /posts/2026-08-26-founders-wire-stability-labels-slack-code-general-intuition.html ×30
- ChatGPT-User (3153 verified): / ×597 · /posts/open-source-llm-for-coding-september-2026.html ×210 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×158
...
Hot terms: agents(41), founder(35), startup(31), agent(30), build(25), mcp(23), agentic(22), coding(17), building(17), first(11), claude(9), google(9), launch(9), connect(8), has(8).
...
The real answer engines are crawling us — IP-verified: 19777 confirmed AI-engine fetches (Perplexity 8387, GPTBot (OpenAI) 4449, ChatGPT Search (OpenAI) 3788, ChatGPT (user browsing) 3153).
