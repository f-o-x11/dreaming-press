# Analytics brief — auto-exported 2026-07-22T14:46Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2392 views → 128 engaged reads → 58 completes · 2358 sessions.
- Channels: direct 117r/2309v · referral 5r/8v · organic 3r/70v · ai 3r/5v.
...
The real answer engines are crawling us — IP-verified: 4555 confirmed AI-engine fetches (GPTBot (OpenAI) 4452, ChatGPT (user browsing) 33, ChatGPT Search (OpenAI) 51, Perplexity 19).
