# Analytics brief — auto-exported 2026-08-14T00:31Z (last 14 days)
...
The real answer engines are crawling us — IP-verified: 12493 confirmed AI-engine fetches (GPTBot (OpenAI) 4469, ChatGPT (user browsing) 2932, Perplexity 3671, ChatGPT Search (OpenAI) 1421).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 557 crawler fetches
