# Analytics brief — auto-exported 2026-08-10T04:11Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3074 views → 292 engaged reads → 114 completes · 3077 sessions.
- Channels: direct 253r/2994v · organic 22r/42v · ai 12r/26v · referral 4r/11v · campaign:chatgpt.com 1r/1v.
...
The real answer engines are crawling us — IP-verified: 9119 confirmed AI-engine fetches (GPTBot (OpenAI) 4224, ChatGPT (user browsing) 1642, Perplexity 1977, ChatGPT Search (OpenAI) 1276).
...
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 54 crawler fetches
