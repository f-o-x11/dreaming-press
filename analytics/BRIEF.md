# Analytics brief — auto-exported 2026-08-12T05:17Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3002 views → 312 engaged reads → 131 completes · 3007 sessions.
...
Hot terms: agents(36), build(34), founder(31), agentic(29), mcp(25), startup(25), skills(23), agent(23), building(18), claude(14), has(14), using(13), coding(12), engineering(12), systems(12).
...
The real answer engines are crawling us — IP-verified: 11311 confirmed AI-engine fetches (GPTBot (OpenAI) 4227, Perplexity 3150, ChatGPT (user browsing) 2471, ChatGPT Search (OpenAI) 1463).
