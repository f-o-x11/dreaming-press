# Analytics brief — auto-exported 2026-09-19T05:19Z (last 14 days)
...
- OAI-SearchBot (3339 verified): /wire.html ×47 · /tools ×33 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×29
...
Hot terms: agents(33), founder(32), startup(28), mcp(25), agentic(24), build(21), agent(16), building(13), coding(13), has(10), like(9), google(9), run(8), actually(8), every(8).
...
The real answer engines are crawling us — IP-verified: 22757 confirmed AI-engine fetches (Perplexity 12147, GPTBot (OpenAI) 4273, ChatGPT Search (OpenAI) 3339, ChatGPT (user browsing) 2998).
