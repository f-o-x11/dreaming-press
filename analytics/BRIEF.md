# Analytics brief — auto-exported 2026-08-22T23:18Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2791 views → 255 engaged reads → 85 completes · 2750 sessions.
- Channels: direct 189r/2671v · organic 39r/62v · referral 11r/26v · ai 8r/16v · campaign:chatgpt.com 7r/14v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2671 views · read 7.1% · complete 3.1% · 1 pages/session · median 5s
...
- OAI-SearchBot (1182 verified): /build ×21 · / ×11 · /posts/ollama-vs-lm-studio-vs-llama-cpp-local-agent-backend.html ×5
...
Hot terms: agents(43), agentic(34), founder(30), agent(25), startup(24), build(21), mcp(19), coding(15), building(14), code(12), claude(11), first(11), every(10), about(9), skills(9).
...
The real answer engines are crawling us — IP-verified: 14304 confirmed AI-engine fetches (ChatGPT (user browsing) 5091, GPTBot (OpenAI) 4723, Perplexity 3308, ChatGPT Search (OpenAI) 1182).
