# Analytics brief — auto-exported 2026-09-11T00:16Z (last 14 days)
...
- /posts/gpu-rental-price-september-2026-b200-floor-under-4.html  — 66 retrieval fetches
...
- /posts/ai-coding-agent-ranking-2026.html  — 21 retrieval fetches
- /dashboard  — 18 retrieval fetches

Per engine:
- PerplexityBot (9338 verified): /build ×153 · / ×25 · /dashboard ×18
- OAI-SearchBot (3080 verified): / ×24 · /build ×24 · /posts/kimi-k3-vs-opus-vs-gpt-56-coding-agent-cost.html ×22
- ChatGPT-User (2916 verified): / ×543 · /posts/agent-funding-august-2026-control-won-the-summer.html ×101 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×80
...
Hot terms: startup(36), agents(35), founder(31), agentic(30), build(26), mcp(20), building(17), agent(11), product(11), saas(11), has(10), own(10), code(10), use(10), claude(9).
...
## Uncovered search demand (265 of 457 phrases have NO post, 25h ago)
...
The real answer engines are crawling us — IP-verified: 17597 confirmed AI-engine fetches (Perplexity 9338, ChatGPT Search (OpenAI) 3080, ChatGPT (user browsing) 2916, GPTBot (OpenAI) 2263).
...
- /posts/gpu-rental-price-september-2026-b200-floor-under-4.html  — 66 crawler fetches
