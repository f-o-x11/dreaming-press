# Analytics brief — auto-exported 2026-07-21T17:40Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2260 views → 125 engaged reads → 54 completes · 2226 sessions.
- Channels: direct 113r/2180v · referral 5r/8v · ai 4r/5v · organic 3r/67v.
...
Hot terms: agents(47), build(41), agent(41), mcp(40), founder(33), agentic(31), startup(31), building(23), skills(23), one(18), claude(16), scratch(13), about(13), course(12), anthropic(12).
