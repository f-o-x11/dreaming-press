# Analytics brief — auto-exported 2026-08-12T15:46Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3015 views → 314 engaged reads → 132 completes · 3020 sessions.
- Channels: direct 272r/2932v · organic 21r/41v · ai 13r/27v · referral 5r/12v · campaign:chatgpt.com 2r/2v · campaign:copilot.com 1r/1v.
...
Hot terms: agents(35), build(33), founder(33), agentic(31), startup(27), mcp(26), agent(24), skills(21), building(17), has(15), claude(13), using(13), engineering(13), systems(12), through(11).
...
## Uncovered search demand (296 of 440 phrases have NO post, 4h ago)
...
The real answer engines are crawling us — IP-verified: 12027 confirmed AI-engine fetches (GPTBot (OpenAI) 4228, Perplexity 3557, ChatGPT (user browsing) 2722, ChatGPT Search (OpenAI) 1520).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 539 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 181 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 135 crawler fetches
