# Analytics brief — auto-exported 2026-08-14T10:57Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2936 views → 298 engaged reads → 115 completes · 2935 sessions.
...
The real answer engines are crawling us — IP-verified: 12732 confirmed AI-engine fetches (GPTBot (OpenAI) 4470, ChatGPT (user browsing) 3131, Perplexity 3707, ChatGPT Search (OpenAI) 1424).
