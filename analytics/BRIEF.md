# Analytics brief — auto-exported 2026-08-11T04:58Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2990 views → 301 engaged reads → 126 completes · 2996 sessions.
- Channels: direct 261r/2909v · organic 21r/41v · ai 12r/26v · referral 5r/12v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v.
- AI assistants (our real front door): Kimi 8r/22v · Yuanbao 2r/2v · Perplexity 1r/1v · Doubao 1r/1v.
- Referrers: bing.com, duckduckgo.com, google.com, cn.bing.com, yuanbao.tencent.com, 114.114.114.114:9421, search.brave.com, d71be6a0eb0d4535877b5dfddc39973f.bj4.agentos-app.net, bytedance.larkoffice.com, yandex.ru.
...
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 12 reads, 52 views, 0 listens
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 9 reads, 28 views, 0 listens
...
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 52 views, 12 reads
- [wire] "China Regulated the AI Persona, Not the Model — So Doubao and Qwen Are Killing Their Agents on July 15" — 44 views, 0 reads
- [wire] "The Founder's Wire, Week of August 10: Claude Code Patched Three Agent-Permission Bypasses, Codex Started Redacting Secrets, and Stateless MCP Landed in Both" — 41 views, 1 reads
- [wire] "vLLM 0.26 and SGLang 0.5.16 Shipped the Same Day. This Time They Fought Over Memory." — 29 views, 4 reads
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 28 views, 9 reads
...
- [wire] "China Regulated the AI Persona, Not the Model — So Doubao and Qwen Are Killing Their Agents on July 15" — 44 views but only 0 engaged reads (0.0%)
- [wire] "The Founder's Wire, Week of August 10: Claude Code Patched Three Agent-Permission Bypasses, Codex Started Redacting Secrets, and Stateless MCP Landed in Both" — 41 views but only 1 engaged reads (2.4%)
...
- Words that recur in winning titles: august(5), openai(3), agent(3), founder(2), wire(2), week(2), free(2), day(2), memory(2), picking(2), rag(2), sqlite-vec(2).
...
Hot terms: build(34), agentic(33), agents(32), founder(28), startup(28), mcp(26), agent(24), skills(20), building(18), claude(14), systems(13), has(13), engineering(12), using(12), coding(11).
...
## Uncovered search demand (305 of 438 phrases have NO post, 44h ago)
...
The real answer engines are crawling us — IP-verified: 9791 confirmed AI-engine fetches (GPTBot (OpenAI) 4225, ChatGPT (user browsing) 2044, Perplexity 2134, ChatGPT Search (OpenAI) 1388).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 480 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 152 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 115 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 107 crawler fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 81 crawler fetches
...
- /posts/the-performance-no-one-attends.html  — 31 crawler fetches
