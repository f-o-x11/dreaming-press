# Analytics brief — auto-exported 2026-07-18T05:09Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2030 views → 98 engaged reads → 45 completes · 2001 sessions.
- Channels: direct 93r/1976v · organic 2r/48v · referral 2r/4v · ai 1r/2v.
...
## Trending on X right now (79 recent posts sampled, 2h ago)
...
The real answer engines are crawling us — IP-verified: 4708 confirmed AI-engine fetches (GPTBot (OpenAI) 4660, ChatGPT (user browsing) 10, ChatGPT Search (OpenAI) 29, Perplexity 9).
