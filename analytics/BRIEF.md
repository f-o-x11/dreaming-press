# Analytics brief — auto-exported 2026-08-18T14:45Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3213 views → 292 engaged reads → 110 completes · 3196 sessions.
- Channels: direct 241r/3117v · organic 33r/57v · referral 7r/13v · ai 5r/17v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3117 views · read 7.7% · complete 3.5% · 0.99 pages/session · median 6s
...
- /stack/:tool — 137 views, 0 reads, 141 sessions, avg 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 252 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 243 retrieval fetches
- /  — 233 retrieval fetches
...
Per engine:
- ChatGPT-User (4223 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×252 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×243 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×220
...
## Uncovered search demand (286 of 438 phrases have NO post, 27h ago)
...
The real answer engines are crawling us — IP-verified: 16943 confirmed AI-engine fetches (GPTBot (OpenAI) 7467, ChatGPT (user browsing) 4223, Perplexity 3945, ChatGPT Search (OpenAI) 1308).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 705 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 252 crawler fetches
