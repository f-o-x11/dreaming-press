# Analytics brief — auto-exported 2026-08-14T17:22Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2954 views → 303 engaged reads → 115 completes · 2952 sessions.
- Channels: direct 250r/2854v · organic 28r/52v · ai 14r/30v · referral 5r/11v · campaign:chatgpt.com 5r/6v · campaign:copilot.com 1r/1v.
...
Hot terms: founder(32), startup(30), build(29), agents(28), agentic(27), agent(23), mcp(19), coding(15), building(14), has(13), systems(12), through(12), model(11), stack(11), using(11).
...
The real answer engines are crawling us — IP-verified: 13039 confirmed AI-engine fetches (GPTBot (OpenAI) 4472, ChatGPT (user browsing) 3280, Perplexity 3861, ChatGPT Search (OpenAI) 1426).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 582 crawler fetches
