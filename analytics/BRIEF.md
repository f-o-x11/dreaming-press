# Analytics brief — auto-exported 2026-09-26T14:37Z (last 14 days)
...
- OAI-SearchBot (4705 verified): /wire.html ×59 · /tools ×35 · /posts/2026-08-31-founders-wire-openai-cursor-cutoff-claudeforce-a16z-machine-age.html ×31
- ChatGPT-User (3115 verified): / ×597 · /posts/open-source-llm-for-coding-september-2026.html ×207 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×159
...
Hot terms: agents(40), founder(36), agent(34), startup(27), agentic(25), build(23), coding(21), building(18), mcp(16), claude(14), jev(11), code(9), one(9), workflows(9), apps(7).
...
The real answer engines are crawling us — IP-verified: 19343 confirmed AI-engine fetches (Perplexity 7449, ChatGPT Search (OpenAI) 4705, GPTBot (OpenAI) 4074, ChatGPT (user browsing) 3115).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 608 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 465 crawler fetches
