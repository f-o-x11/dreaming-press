# Analytics brief — auto-exported 2026-08-10T19:02Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3095 views → 299 engaged reads → 122 completes · 3100 sessions.
- Channels: direct 258r/3013v · organic 22r/42v · ai 12r/26v · referral 5r/12v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v.
...
Hot terms: build(34), agents(33), agentic(30), founder(28), startup(28), mcp(26), agent(21), skills(20), building(16), systems(13), has(13), using(12), claude(12), over(11), tools(11).
Hashtags: #ai, #startup, #founder, #productmanagement, #agenticai, #mcp, #aiagents, #helyes, #aijobs, #techjobs.
...
The real answer engines are crawling us — IP-verified: 9621 confirmed AI-engine fetches (GPTBot (OpenAI) 4227, ChatGPT (user browsing) 1908, Perplexity 2155, ChatGPT Search (OpenAI) 1331).
