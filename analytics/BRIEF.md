# Analytics brief — auto-exported 2026-08-17T18:33Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3140 views → 292 engaged reads → 110 completes · 3121 sessions.
- Channels: direct 243r/3046v · organic 31r/55v · ai 7r/18v · referral 5r/12v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3046 views · read 8.0% · complete 3.6% · 1 pages/session · median 6s
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 218 retrieval fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 216 retrieval fetches
- /  — 211 retrieval fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 165 retrieval fetches
...
Per engine:
- ChatGPT-User (3885 verified): /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×226 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×218 · /posts/agent-funding-august-2026-control-won-the-summer.html ×216
- PerplexityBot (4199 verified): /build ×35 · / ×29 · /apps ×17
- OAI-SearchBot (1318 verified): / ×15 · /build ×15 · /fetch ×5
...
Hot terms: agents(32), agentic(31), agent(28), founder(28), startup(27), build(25), mcp(20), coding(17), building(13), systems(12), engineering(12), skills(10), code(10), data(10), claude(9).
...
## Uncovered search demand (286 of 438 phrases have NO post, 7h ago)
...
The real answer engines are crawling us — IP-verified: 16871 confirmed AI-engine fetches (GPTBot (OpenAI) 7469, ChatGPT (user browsing) 3885, Perplexity 4199, ChatGPT Search (OpenAI) 1318).
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 223 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 216 crawler fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 170 crawler fetches
