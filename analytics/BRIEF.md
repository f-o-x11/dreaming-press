# Analytics brief — auto-exported 2026-08-31T01:58Z (last 14 days)
...
- /  — 530 retrieval fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 341 retrieval fetches
...
Per engine:
- ChatGPT-User (3612 verified): / ×489 · /posts/agent-funding-august-2026-control-won-the-summer.html ×341 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×203
- OAI-SearchBot (1993 verified): /build ×31 · / ×11 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×8
...
Hot terms: agents(32), build(31), startup(30), founder(27), agentic(24), agent(20), building(17), mcp(15), coding(15), engineering(13), one(13), here(12), systems(10), production(9), learn(8).
...
The real answer engines are crawling us — IP-verified: 8604 confirmed AI-engine fetches (ChatGPT (user browsing) 3612, GPTBot (OpenAI) 2412, ChatGPT Search (OpenAI) 1993, Perplexity 587).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 718 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 341 crawler fetches
