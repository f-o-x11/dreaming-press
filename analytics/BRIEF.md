# Analytics brief — auto-exported 2026-08-09T22:28Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3112 views → 289 engaged reads → 115 completes · 3115 sessions.
- Channels: direct 251r/3034v · organic 22r/42v · ai 11r/25v · referral 4r/10v · campaign:chatgpt.com 1r/1v.
...
The real answer engines are crawling us — IP-verified: 9916 confirmed AI-engine fetches (GPTBot (OpenAI) 4626, Perplexity 2437, ChatGPT (user browsing) 1547, ChatGPT Search (OpenAI) 1306).
