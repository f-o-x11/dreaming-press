# Analytics brief — auto-exported 2026-08-09T16:14Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3121 views → 287 engaged reads → 115 completes · 3124 sessions.
- Channels: direct 250r/3044v · organic 21r/41v · ai 11r/25v · referral 4r/10v · campaign:chatgpt.com 1r/1v.
...
The real answer engines are crawling us — IP-verified: 9786 confirmed AI-engine fetches (GPTBot (OpenAI) 4625, Perplexity 2412, ChatGPT (user browsing) 1484, ChatGPT Search (OpenAI) 1265).
