# Analytics brief — auto-exported 2026-07-23T04:58Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2464 views → 134 engaged reads → 61 completes · 2429 sessions.
- Channels: direct 123r/2380v · referral 5r/8v · organic 3r/71v · ai 3r/5v.
...
Hot terms: agents(46), build(44), mcp(38), agentic(31), agent(30), startup(30), founder(29), building(25), skills(18), one(14), systems(13), robinhood(11), claude(11), tools(11), about(11).
...
The real answer engines are crawling us — IP-verified: 4573 confirmed AI-engine fetches (GPTBot (OpenAI) 4453, ChatGPT (user browsing) 42, ChatGPT Search (OpenAI) 54, Perplexity 24).
