# Analytics brief — auto-exported 2026-09-25T02:14Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3375 views → 330 engaged reads → 16 completes · 3254 sessions.
...
- direct: 2908 views · read 5.4% · complete 0.4% · 0.99 pages/session · median 5s
...
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 67 retrieval fetches
...
Per engine:
- PerplexityBot (7750 verified): /build ×82 · / ×25 · /posts/2026-09-08-founders-wire-nvidia-hugging-face-openai-managed-agents-anthropic-payments.html ×19
- OAI-SearchBot (4102 verified): /wire.html ×55 · /tools ×33 · /posts/2026-08-31-founders-wire-openai-cursor-cutoff-claudeforce-a16z-machine-age.html ×29
- ChatGPT-User (3029 verified): / ×577 · /posts/open-source-llm-for-coding-september-2026.html ×204 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×156
...
## Uncovered search demand (250 of 451 phrases have NO post, 14h ago)
...
The real answer engines are crawling us — IP-verified: 19802 confirmed AI-engine fetches (Perplexity 7750, GPTBot (OpenAI) 4921, ChatGPT Search (OpenAI) 4102, ChatGPT (user browsing) 3029).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 637 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 354 crawler fetches
