# Analytics brief — auto-exported 2026-09-19T12:04Z (last 14 days)
...
- OAI-SearchBot (3419 verified): /wire.html ×48 · /tools ×33 · /posts/2026-08-26-founders-wire-stability-labels-slack-code-general-intuition.html ×29
- ChatGPT-User (3050 verified): / ×588 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×158 · /posts/open-source-llm-for-coding-september-2026.html ×145
...
Hot terms: agents(35), founder(31), startup(28), mcp(23), agentic(20), build(20), agent(19), coding(14), building(12), like(9), has(9), google(9), co-founder(9), run(8), actually(8).
...
The real answer engines are crawling us — IP-verified: 22921 confirmed AI-engine fetches (Perplexity 12178, GPTBot (OpenAI) 4274, ChatGPT Search (OpenAI) 3419, ChatGPT (user browsing) 3050).
