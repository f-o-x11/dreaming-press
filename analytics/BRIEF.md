# Analytics brief — auto-exported 2026-08-29T23:07Z (last 14 days)
...
Per engine:
- ChatGPT-User (4074 verified): / ×487 · /posts/agent-funding-august-2026-control-won-the-summer.html ×402 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×245
- OAI-SearchBot (1866 verified): /build ×28 · / ×10 · /posts/groq-vs-cerebras-vs-sambanova-fast-inference.html ×9
...
Hot terms: agents(33), startup(31), build(30), founder(26), agentic(20), agent(19), building(18), one(15), mcp(14), engineering(14), coding(13), here(12), systems(10), production(9), has(9).
...
The real answer engines are crawling us — IP-verified: 12168 confirmed AI-engine fetches (GPTBot (OpenAI) 5364, ChatGPT (user browsing) 4074, ChatGPT Search (OpenAI) 1866, Perplexity 864).
