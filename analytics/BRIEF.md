# Analytics brief — auto-exported 2026-09-26T00:41Z (last 14 days)
...
- OAI-SearchBot (4464 verified): /wire.html ×59 · /tools ×35 · /posts/2026-08-31-founders-wire-openai-cursor-cutoff-claudeforce-a16z-machine-age.html ×30
- ChatGPT-User (3023 verified): / ×574 · /posts/open-source-llm-for-coding-september-2026.html ×201 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×154
...
Hot terms: agents(40), agent(36), founder(36), startup(28), agentic(25), build(24), coding(19), building(17), mcp(16), claude(11), jev(11), one(9), big(8), code(8), day(8).
...
The real answer engines are crawling us — IP-verified: 18928 confirmed AI-engine fetches (Perplexity 7369, ChatGPT Search (OpenAI) 4464, GPTBot (OpenAI) 4072, ChatGPT (user browsing) 3023).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 599 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 430 crawler fetches
