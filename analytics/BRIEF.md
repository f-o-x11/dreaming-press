# Analytics brief — auto-exported 2026-08-02T12:15Z (last 14 days)
...
Hot terms: build(44), agents(43), startup(36), founder(34), agent(33), agentic(32), mcp(27), engineering(12), systems(12), code(10), coding(10), env(10), building(9), course(8), memory(8).
...
The real answer engines are crawling us — IP-verified: 6057 confirmed AI-engine fetches (Perplexity 2608, GPTBot (OpenAI) 2589, ChatGPT (user browsing) 369, ChatGPT Search (OpenAI) 491).
