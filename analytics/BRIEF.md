# Analytics brief — auto-exported 2026-07-22T17:28Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2397 views → 130 engaged reads → 59 completes · 2362 sessions.
- Channels: direct 119r/2314v · referral 5r/8v · organic 3r/70v · ai 3r/5v.
...
- [wire] "Microsoft Agent Framework 1.12 Ships Today: Native MCP Hosting and Persistent Cosmos Memory" — 32 views, 1 reads
...
The real answer engines are crawling us — IP-verified: 4559 confirmed AI-engine fetches (GPTBot (OpenAI) 4453, ChatGPT (user browsing) 35, ChatGPT Search (OpenAI) 52, Perplexity 19).
