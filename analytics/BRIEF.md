# Analytics brief — auto-exported 2026-08-16T22:26Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2991 views → 307 engaged reads → 107 completes · 2981 sessions.
- Channels: direct 258r/2899v · organic 29r/56v · ai 8r/17v · referral 6r/11v · campaign:chatgpt.com 5r/7v · campaign:copilot.com 1r/1v.
...
- [wire] "The Founder's Wire, August 15: OpenAI Hits Real-Time Speed, Google Halves Gemini Flash, and China's GLM-5.3 Tops the Open-Weights Coding Board" — 69 views, 0 reads
...
- [wire] "The Founder's Wire, August 15: OpenAI Hits Real-Time Speed, Google Halves Gemini Flash, and China's GLM-5.3 Tops the Open-Weights Coding Board" — 69 views but only 0 engaged reads (0.0%)
...
Hot terms: agentic(33), agents(33), founder(30), agent(28), startup(27), build(24), coding(19), mcp(19), engineering(17), building(15), systems(14), skills(10), code(10), through(10), data(10).
...
## Uncovered search demand (286 of 439 phrases have NO post, 11h ago)
...
The real answer engines are crawling us — IP-verified: 16251 confirmed AI-engine fetches (GPTBot (OpenAI) 7423, ChatGPT (user browsing) 3464, Perplexity 3966, ChatGPT Search (OpenAI) 1398).
