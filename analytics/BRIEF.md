# Analytics brief — auto-exported 2026-08-07T16:31Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2843 views → 265 engaged reads → 108 completes · 2846 sessions.
- Channels: direct 229r/2773v · organic 18r/31v · ai 11r/25v · referral 4r/11v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
Hot terms: agentic(38), build(37), agents(34), mcp(31), startup(24), skills(23), agent(22), founder(22), building(20), engineering(16), course(14), claude(13), coding(12), tools(10), systems(10).
...
The real answer engines are crawling us — IP-verified: 9395 confirmed AI-engine fetches (GPTBot (OpenAI) 5137, Perplexity 2217, ChatGPT (user browsing) 1022, ChatGPT Search (OpenAI) 1019).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 108 crawler fetches
