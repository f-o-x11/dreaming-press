# Analytics brief — auto-exported 2026-09-22T18:54Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3334 views → 349 engaged reads → 22 completes · 3235 sessions.
- Channels: direct 160r/2931v · organic 113r/150v · campaign:chatgpt.com 47r/152v · ai 15r/38v · referral 11r/57v · campaign:qwant 2r/2v · social 1r/3v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
...
- direct: 2931 views · read 5.5% · complete 0.5% · 0.99 pages/session · median 4s
...
- OAI-SearchBot (3758 verified): /wire.html ×50 · /tools ×34 · /posts/local-llm-for-coding-on-your-own-machine.html ×30
...
Hot terms: agents(39), founder(36), startup(34), agent(27), build(24), agentic(22), mcp(19), coding(18), building(15), its(10), google(9), has(9), launch(9), every(8), first(8).
...
The real answer engines are crawling us — IP-verified: 20076 confirmed AI-engine fetches (Perplexity 8681, GPTBot (OpenAI) 4432, ChatGPT Search (OpenAI) 3758, ChatGPT (user browsing) 3205).
