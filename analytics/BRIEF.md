# Analytics brief — auto-exported 2026-08-22T12:14Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2756 views → 264 engaged reads → 90 completes · 2716 sessions.
- Channels: direct 197r/2638v · organic 41r/65v · referral 11r/24v · campaign:chatgpt.com 7r/14v · ai 7r/13v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2638 views · read 7.5% · complete 3.3% · 1 pages/session · median 5s
...
Per engine:
- ChatGPT-User (5050 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×377 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×325 · / ×293
...
The real answer engines are crawling us — IP-verified: 14083 confirmed AI-engine fetches (ChatGPT (user browsing) 5050, GPTBot (OpenAI) 4721, Perplexity 3259, ChatGPT Search (OpenAI) 1053).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 685 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 382 crawler fetches
