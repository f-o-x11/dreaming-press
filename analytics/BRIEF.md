# Analytics brief — auto-exported 2026-09-26T09:05Z (last 14 days)
...
- OAI-SearchBot (4606 verified): /wire.html ×59 · /tools ×35 · /posts/2026-08-31-founders-wire-openai-cursor-cutoff-claudeforce-a16z-machine-age.html ×31
- ChatGPT-User (3079 verified): / ×588 · /posts/open-source-llm-for-coding-september-2026.html ×205 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×158
...
Hot terms: agents(39), founder(37), agent(33), agentic(29), startup(28), build(23), coding(18), mcp(17), building(17), claude(11), jev(11), workflows(9), big(8), code(8), one(8).
...
The real answer engines are crawling us — IP-verified: 19195 confirmed AI-engine fetches (Perplexity 7436, ChatGPT Search (OpenAI) 4606, GPTBot (OpenAI) 4074, ChatGPT (user browsing) 3079).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 605 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 453 crawler fetches
