# Analytics brief — auto-exported 2026-08-17T10:01Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3113 views → 312 engaged reads → 110 completes · 3104 sessions.
- Channels: direct 262r/3021v · organic 31r/55v · ai 7r/16v · referral 6r/12v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v.
...
- direct: 3021 views · read 8.7% · complete 3.6% · 0.99 pages/session · median 6s
...
- /stack/:tool — 61 views, 0 reads, 63 sessions, avg 5s
- /best/:cat — 10 views, 0 reads, 10 sessions, avg 4s
- /build — 9 views, 0 reads, 9 sessions, avg 4s
...
- /  — 203 retrieval fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 200 retrieval fetches
...
Per engine:
- ChatGPT-User (3701 verified): /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×219 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×208 · /posts/agent-funding-august-2026-control-won-the-summer.html ×200
...
Hot terms: agentic(33), agents(32), agent(30), founder(29), startup(26), build(23), coding(19), mcp(19), building(14), systems(13), engineering(13), data(12), skills(11), code(10), using(10).
...
The real answer engines are crawling us — IP-verified: 16625 confirmed AI-engine fetches (GPTBot (OpenAI) 7421, ChatGPT (user browsing) 3701, Perplexity 4194, ChatGPT Search (OpenAI) 1309).
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 200 crawler fetches
