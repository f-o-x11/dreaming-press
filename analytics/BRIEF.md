# Analytics brief — auto-exported 2026-08-12T13:33Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3007 views → 312 engaged reads → 130 completes · 3012 sessions.
- Channels: direct 270r/2924v · organic 21r/41v · ai 13r/27v · referral 5r/12v · campaign:chatgpt.com 2r/2v · campaign:copilot.com 1r/1v.
...
Hot terms: agents(36), build(34), founder(32), agentic(30), mcp(27), startup(26), agent(24), skills(23), building(17), claude(14), has(14), using(13), engineering(13), coding(12), systems(12).
...
The real answer engines are crawling us — IP-verified: 11949 confirmed AI-engine fetches (GPTBot (OpenAI) 4227, Perplexity 3555, ChatGPT (user browsing) 2662, ChatGPT Search (OpenAI) 1505).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 537 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 179 crawler fetches
