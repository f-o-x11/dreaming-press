# Analytics brief — auto-exported 2026-08-11T13:56Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3000 views → 309 engaged reads → 128 completes · 3006 sessions.
- Channels: direct 267r/2917v · organic 22r/42v · ai 13r/27v · referral 5r/12v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v.
...
Hot terms: build(33), agents(32), agentic(30), founder(29), startup(27), mcp(26), agent(23), skills(21), building(19), systems(14), using(12), claude(12), through(12), tools(12), has(12).
...
## Uncovered search demand (305 of 438 phrases have NO post, 53h ago)
...
The real answer engines are crawling us — IP-verified: 11008 confirmed AI-engine fetches (GPTBot (OpenAI) 4225, Perplexity 3132, ChatGPT (user browsing) 2201, ChatGPT Search (OpenAI) 1450).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 501 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 157 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 121 crawler fetches
