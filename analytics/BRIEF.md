# Analytics brief — auto-exported 2026-08-02T15:07Z (last 14 days)
...
Hot terms: build(45), agents(41), startup(37), agentic(35), founder(35), agent(33), mcp(29), engineering(13), systems(12), env(10), code(9), course(9), memory(9), tools(9), coding(9).
