# Analytics brief — auto-exported 2026-08-13T12:52Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2946 views → 303 engaged reads → 123 completes · 2949 sessions.
- Channels: direct 254r/2855v · organic 24r/46v · ai 14r/28v · referral 6r/12v · campaign:chatgpt.com 4r/4v · campaign:copilot.com 1r/1v.
...
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 12 reads, 62 views, 0 listens
...
- Words that recur in winning titles: august(6), founder(3), wire(3), week(3), openai(3), agent(3), claude(2), code(2), free(2), day(2), memory(2), picking(2).
...
Hot terms: build(37), founder(35), agents(33), agentic(32), startup(29), mcp(28), agent(24), skills(21), building(15), claude(13), using(13), has(13), through(12), data(12), systems(12).
...
## Uncovered search demand (296 of 440 phrases have NO post, 25h ago)
...
The real answer engines are crawling us — IP-verified: 13449 confirmed AI-engine fetches (GPTBot (OpenAI) 5385, Perplexity 3638, ChatGPT (user browsing) 2947, ChatGPT Search (OpenAI) 1479).
...
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 141 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 129 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 103 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 99 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 97 crawler fetches
- /posts/2026-07-22-founders-wire-portable-context-agents-in-chat-open-coders.html  — 96 crawler fetches
- /posts/ai-agent-memory-benchmarks-locomo-mem0-zep.html  — 51 crawler fetches
