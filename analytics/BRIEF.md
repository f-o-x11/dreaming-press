# Analytics brief — auto-exported 2026-09-06T22:56Z (last 14 days)
...
- ChatGPT-User (2897 verified): / ×564 · /posts/agent-funding-august-2026-control-won-the-summer.html ×180 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×104
...
Hot terms: agents(36), startup(30), founder(26), agent(25), building(23), agentic(22), mcp(18), coding(18), build(17), code(14), claude(12), model(11), launch(10), co-founder(9), first(8).
...
The real answer engines are crawling us — IP-verified: 16090 confirmed AI-engine fetches (Perplexity 7493, ChatGPT Search (OpenAI) 3438, ChatGPT (user browsing) 2897, GPTBot (OpenAI) 2262).
