# Analytics brief — auto-exported 2026-08-06T18:47Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2751 views → 239 engaged reads → 111 completes · 2753 sessions.
- Channels: direct 206r/2683v · organic 14r/26v · ai 11r/25v · referral 6r/15v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
Hot terms: agents(38), build(37), agentic(34), mcp(31), startup(23), founder(23), agent(22), building(18), engineering(17), skills(14), coding(13), systems(12), tools(11), course(10), one(10).
...
The real answer engines are crawling us — IP-verified: 10868 confirmed AI-engine fetches (GPTBot (OpenAI) 5439, Perplexity 3456, ChatGPT (user browsing) 1030, ChatGPT Search (OpenAI) 943).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 98 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 96 crawler fetches
