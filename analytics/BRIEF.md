# Analytics brief — auto-exported 2026-09-26T16:38Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3314 views → 330 engaged reads → 13 completes · 3197 sessions.
...
- OAI-SearchBot (4708 verified): /wire.html ×59 · /tools ×35 · /posts/2026-08-31-founders-wire-openai-cursor-cutoff-claudeforce-a16z-machine-age.html ×31
...
Hot terms: agents(40), founder(36), agent(35), startup(27), agentic(26), build(25), coding(22), building(18), mcp(14), claude(13), jev(11), code(10), one(10), workflows(9), systems(8).
...
The real answer engines are crawling us — IP-verified: 19366 confirmed AI-engine fetches (Perplexity 7454, ChatGPT Search (OpenAI) 4708, GPTBot (OpenAI) 4074, ChatGPT (user browsing) 3130).
