# Analytics brief — auto-exported 2026-08-20T05:25Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3017 views → 284 engaged reads → 96 completes · 2987 sessions.
- Channels: direct 226r/2917v · organic 37r/62v · referral 8r/14v · ai 6r/12v · campaign:chatgpt.com 6r/10v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2917 views · read 7.7% · complete 3.2% · 1 pages/session · median 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 318 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 292 retrieval fetches
- /  — 275 retrieval fetches
...
Per engine:
- ChatGPT-User (4722 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×318 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×292 · / ×230
...
## Uncovered search demand (286 of 438 phrases have NO post, 66h ago)
...
The real answer engines are crawling us — IP-verified: 13603 confirmed AI-engine fetches (ChatGPT (user browsing) 4722, GPTBot (OpenAI) 4267, Perplexity 3480, ChatGPT Search (OpenAI) 1134).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 625 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 318 crawler fetches
