# Analytics brief — auto-exported 2026-08-14T02:52Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2923 views → 299 engaged reads → 119 completes · 2925 sessions.
- Channels: direct 247r/2828v · organic 27r/50v · ai 14r/28v · referral 5r/11v · campaign:chatgpt.com 5r/5v · campaign:copilot.com 1r/1v.
...
The real answer engines are crawling us — IP-verified: 12543 confirmed AI-engine fetches (GPTBot (OpenAI) 4469, ChatGPT (user browsing) 2980, Perplexity 3672, ChatGPT Search (OpenAI) 1422).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 561 crawler fetches
