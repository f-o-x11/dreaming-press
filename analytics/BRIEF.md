# Analytics brief — auto-exported 2026-07-31T15:37Z (last 14 days)
...
Hot terms: agents(53), build(48), mcp(42), agentic(40), founder(36), agent(34), startup(33), engineering(21), building(16), google(13), course(11), loops(11), 1-hour(10), systems(10), tools(10).
...
The real answer engines are crawling us — IP-verified: 6530 confirmed AI-engine fetches (GPTBot (OpenAI) 3376, Perplexity 2417, ChatGPT (user browsing) 268, ChatGPT Search (OpenAI) 469).
...
- /posts/lm-studio-bionic-local-agent-open-models.html  — 15 crawler fetches
...
- /stack/portkey  — 12 crawler fetches
