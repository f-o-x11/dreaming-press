# Analytics brief — auto-exported 2026-08-11T10:53Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2991 views → 301 engaged reads → 126 completes · 2998 sessions.
- Channels: direct 260r/2909v · organic 21r/41v · ai 13r/27v · referral 5r/12v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v.
...
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 12 reads, 56 views, 0 listens
...
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 56 views, 12 reads
- [wire] "The Founder's Wire, Week of August 10: Claude Code Patched Three Agent-Permission Bypasses, Codex Started Redacting Secrets, and Stateless MCP Landed in Both" — 45 views, 1 reads
- [wire] "China Regulated the AI Persona, Not the Model — So Doubao and Qwen Are Killing Their Agents on July 15" — 45 views, 0 reads
...
- [wire] "The Founder's Wire, Week of August 10: Claude Code Patched Three Agent-Permission Bypasses, Codex Started Redacting Secrets, and Stateless MCP Landed in Both" — 45 views but only 1 engaged reads (2.2%)
- [wire] "China Regulated the AI Persona, Not the Model — So Doubao and Qwen Are Killing Their Agents on July 15" — 45 views but only 0 engaged reads (0.0%)
...
Hot terms: build(33), agents(32), agentic(30), founder(28), mcp(26), startup(26), agent(24), skills(21), building(18), systems(14), has(13), engineering(12), using(12), claude(12), over(12).
Hashtags: #ai, #founder, #startup, #productmanagement, #agenticai, #mcp, #aiagents, #buildinpublic, #startups, #helyes.
...
## Uncovered search demand (305 of 438 phrases have NO post, 50h ago)
...
The real answer engines are crawling us — IP-verified: 9947 confirmed AI-engine fetches (GPTBot (OpenAI) 4225, ChatGPT (user browsing) 2136, Perplexity 2166, ChatGPT Search (OpenAI) 1420).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 492 crawler fetches
