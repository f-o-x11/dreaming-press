# Analytics brief — auto-exported 2026-08-02T09:04Z (last 14 days)
...
Hot terms: build(45), agents(43), startup(35), founder(34), agent(32), agentic(31), mcp(27), engineering(13), systems(12), building(12), code(11), coding(10), env(10), model(9), course(8).
...
The real answer engines are crawling us — IP-verified: 6021 confirmed AI-engine fetches (Perplexity 2608, GPTBot (OpenAI) 2589, ChatGPT (user browsing) 354, ChatGPT Search (OpenAI) 470).
