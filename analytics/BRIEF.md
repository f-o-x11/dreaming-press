# Analytics brief — auto-exported 2026-08-14T16:01Z (last 14 days)
...
Hot terms: founder(32), build(30), startup(30), agents(29), agentic(28), agent(23), mcp(20), coding(15), building(14), systems(13), through(13), has(13), engineering(13), stack(12), using(12).
...
The real answer engines are crawling us — IP-verified: 12911 confirmed AI-engine fetches (GPTBot (OpenAI) 4471, ChatGPT (user browsing) 3249, Perplexity 3767, ChatGPT Search (OpenAI) 1424).
...
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 155 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 139 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 139 crawler fetches
