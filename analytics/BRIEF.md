# Analytics brief — auto-exported 2026-08-12T17:48Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3016 views → 316 engaged reads → 132 completes · 3021 sessions.
- Channels: direct 274r/2933v · organic 21r/41v · ai 13r/27v · referral 5r/12v · campaign:chatgpt.com 2r/2v · campaign:copilot.com 1r/1v.
...
Hot terms: agents(34), build(33), founder(33), agentic(31), mcp(27), startup(27), agent(24), skills(20), building(17), has(15), claude(13), engineering(13), using(12), systems(12), through(10).
...
## Uncovered search demand (296 of 440 phrases have NO post, 6h ago)
...
The real answer engines are crawling us — IP-verified: 12106 confirmed AI-engine fetches (GPTBot (OpenAI) 4229, Perplexity 3558, ChatGPT (user browsing) 2781, ChatGPT Search (OpenAI) 1538).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 543 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 183 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 137 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 123 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 83 crawler fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 83 crawler fetches
- /posts/yubikey-5-8-verified-authorization-agent-actions.html  — 81 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 81 crawler fetches
- /posts/ai-agent-memory-benchmarks-locomo-mem0-zep.html  — 47 crawler fetches
