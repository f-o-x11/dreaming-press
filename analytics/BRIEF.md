# Analytics brief — auto-exported 2026-09-04T15:51Z (last 14 days)
...
- /stack/:tool — 393 views, 0 reads, 390 sessions, avg 4s
...
- ChatGPT-User (2846 verified): / ×549 · /posts/agent-funding-august-2026-control-won-the-summer.html ×210 · /posts/ai-coding-agent-ranking-2026.html ×129
- PerplexityBot (2083 verified): /build ×35 · / ×29 · /tags/opinionated ×7
...
Hot terms: agents(34), agent(30), startup(27), founder(26), coding(23), build(20), agentic(19), building(17), one(11), code(11), mcp(10), week(10), co-founder(10), systems(9), launch(8).
...
The real answer engines are crawling us — IP-verified: 10560 confirmed AI-engine fetches (ChatGPT Search (OpenAI) 2923, ChatGPT (user browsing) 2846, GPTBot (OpenAI) 2708, Perplexity 2083).
