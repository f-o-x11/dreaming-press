# Analytics brief — auto-exported 2026-08-22T11:03Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2752 views → 265 engaged reads → 90 completes · 2712 sessions.
- Channels: direct 198r/2634v · organic 41r/65v · referral 11r/24v · campaign:chatgpt.com 7r/14v · ai 7r/13v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2634 views · read 7.5% · complete 3.3% · 1 pages/session · median 5s
...
Per engine:
- ChatGPT-User (5047 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×376 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×325 · / ×291
...
The real answer engines are crawling us — IP-verified: 14080 confirmed AI-engine fetches (ChatGPT (user browsing) 5047, GPTBot (OpenAI) 4721, Perplexity 3259, ChatGPT Search (OpenAI) 1053).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 682 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 381 crawler fetches
