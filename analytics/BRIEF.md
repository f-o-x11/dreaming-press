# Analytics brief — auto-exported 2026-08-18T12:55Z (last 14 days)
...
- /stack/:tool — 134 views, 0 reads, 138 sessions, avg 5s
...
Per engine:
- ChatGPT-User (4182 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×249 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×241 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×218
...
Hot terms: agents(38), agentic(32), founder(31), startup(30), build(26), agent(23), mcp(18), building(16), coding(15), one(12), code(12), data(11), systems(10), engineering(10), skills(9).
...
The real answer engines are crawling us — IP-verified: 16899 confirmed AI-engine fetches (GPTBot (OpenAI) 7466, ChatGPT (user browsing) 4182, Perplexity 3943, ChatGPT Search (OpenAI) 1308).
