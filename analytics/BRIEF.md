# Analytics brief — auto-exported 2026-08-25T06:42Z (last 14 days)
...
Per engine:
- ChatGPT-User (4719 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×424 · / ×373 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×323
...
Hot terms: agents(34), founder(29), agentic(27), startup(26), build(21), mcp(20), agent(19), coding(14), building(14), google(13), code(11), about(11), tools(10), first(9), claude(8).
...
The real answer engines are crawling us — IP-verified: 13275 confirmed AI-engine fetches (ChatGPT (user browsing) 4719, GPTBot (OpenAI) 4721, Perplexity 2726, ChatGPT Search (OpenAI) 1109).
