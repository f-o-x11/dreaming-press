# Analytics brief — auto-exported 2026-08-18T12:44Z (last 14 days)
...
Per engine:
- ChatGPT-User (4178 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×248 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×241 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×217
...
Hot terms: agents(38), agentic(32), founder(31), startup(30), build(26), agent(23), mcp(18), building(16), coding(15), engineering(14), code(12), one(11), data(11), systems(10), skills(9).
...
The real answer engines are crawling us — IP-verified: 16893 confirmed AI-engine fetches (GPTBot (OpenAI) 7466, ChatGPT (user browsing) 4178, Perplexity 3941, ChatGPT Search (OpenAI) 1308).
