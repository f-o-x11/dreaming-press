# Analytics brief — auto-exported 2026-09-23T04:32Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3349 views → 351 engaged reads → 21 completes · 3246 sessions.
- Channels: direct 160r/2938v · organic 113r/152v · campaign:chatgpt.com 48r/154v · ai 16r/40v · referral 11r/59v · campaign:qwant 2r/2v · social 1r/3v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
...
- OAI-SearchBot (3702 verified): /wire.html ×50 · /tools ×33 · /posts/local-llm-for-coding-on-your-own-machine.html ×29
...
Hot terms: agents(40), founder(35), startup(33), agent(28), build(25), agentic(22), mcp(21), coding(17), building(16), first(10), launch(10), google(9), has(9), every(8), today(8).
...
The real answer engines are crawling us — IP-verified: 19579 confirmed AI-engine fetches (Perplexity 8376, GPTBot (OpenAI) 4447, ChatGPT Search (OpenAI) 3702, ChatGPT (user browsing) 3054).
