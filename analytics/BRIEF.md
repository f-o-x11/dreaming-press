# Analytics brief — auto-exported 2026-08-10T03:11Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3079 views → 292 engaged reads → 114 completes · 3082 sessions.
- Channels: direct 253r/2999v · organic 22r/42v · ai 12r/26v · referral 4r/11v · campaign:chatgpt.com 1r/1v.
- AI assistants (our real front door): Kimi 8r/22v · Yuanbao 2r/2v · Perplexity 1r/1v · Doubao 1r/1v.
- Referrers: bing.com, duckduckgo.com, cn.bing.com, google.com, bytedance.larkoffice.com, yuanbao.tencent.com, search.brave.com, d71be6a0eb0d4535877b5dfddc39973f.bj4.agentos-app.net, yandex.ru, perplexity.ai.
...
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 131 views, 2 reads
...
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 131 views but only 2 engaged reads (1.5%)
...
Hot terms: build(37), agentic(35), agents(32), startup(32), founder(29), mcp(28), agent(22), skills(19), building(17), claude(14), has(14), coding(11), systems(11), engineering(10), using(10).
...
## Uncovered search demand (305 of 438 phrases have NO post, 18h ago)
...
The real answer engines are crawling us — IP-verified: 9103 confirmed AI-engine fetches (GPTBot (OpenAI) 4224, ChatGPT (user browsing) 1626, Perplexity 1977, ChatGPT Search (OpenAI) 1276).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 487 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 132 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 104 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 102 crawler fetches
...
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 52 crawler fetches
