# Analytics brief — auto-exported 2026-09-13T19:09Z (last 14 days)
...
Per engine:
- PerplexityBot (10905 verified): /build ×170 · / ×25 · /dashboard ×20
...
- ChatGPT-User (3020 verified): / ×583 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×89 · /posts/agent-funding-august-2026-control-won-the-summer.html ×74
...
Hot terms: founder(27), agentic(26), startup(26), build(25), agents(24), building(20), mcp(17), agent(15), own(10), systems(10), python(9), claude(9), about(9), has(8), have(8).
...
## Uncovered search demand (264 of 456 phrases have NO post, 32h ago)
...
The real answer engines are crawling us — IP-verified: 18737 confirmed AI-engine fetches (Perplexity 10905, ChatGPT Search (OpenAI) 3496, ChatGPT (user browsing) 3020, GPTBot (OpenAI) 1316).
