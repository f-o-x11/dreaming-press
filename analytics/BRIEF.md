# Analytics brief — auto-exported 2026-08-11T19:50Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2996 views → 310 engaged reads → 129 completes · 3002 sessions.
- Channels: direct 268r/2913v · organic 22r/42v · ai 13r/27v · referral 5r/12v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v.
...
Hot terms: agents(33), build(31), founder(29), agentic(27), startup(26), mcp(24), skills(22), agent(21), building(16), claude(14), systems(13), has(13), using(11), through(11), coding(10).
Hashtags: #ai, #startup, #founder, #aiagents, #buildinpublic, #startups, #helyes, #productmanagement, #aipm, #agenticai.
...
## Uncovered search demand (305 of 438 phrases have NO post, 59h ago)
...
The real answer engines are crawling us — IP-verified: 11236 confirmed AI-engine fetches (GPTBot (OpenAI) 4227, Perplexity 3202, ChatGPT (user browsing) 2324, ChatGPT Search (OpenAI) 1483).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 511 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 163 crawler fetches
