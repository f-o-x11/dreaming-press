# Analytics brief — auto-exported 2026-08-12T16:46Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3015 views → 315 engaged reads → 132 completes · 3020 sessions.
- Channels: direct 273r/2932v · organic 21r/41v · ai 13r/27v · referral 5r/12v · campaign:chatgpt.com 2r/2v · campaign:copilot.com 1r/1v.
...
Hot terms: build(34), agents(34), founder(33), agentic(32), mcp(28), startup(27), agent(24), skills(21), building(17), has(15), claude(13), using(13), systems(13), engineering(13), through(11).
...
## Uncovered search demand (296 of 440 phrases have NO post, 5h ago)
...
The real answer engines are crawling us — IP-verified: 12055 confirmed AI-engine fetches (GPTBot (OpenAI) 4228, Perplexity 3557, ChatGPT (user browsing) 2749, ChatGPT Search (OpenAI) 1521).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 542 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 182 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 136 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 122 crawler fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 83 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 82 crawler fetches
- /posts/yubikey-5-8-verified-authorization-agent-actions.html  — 81 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 80 crawler fetches
