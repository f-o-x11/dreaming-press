# Analytics brief — auto-exported 2026-08-25T01:57Z (last 14 days)
...
Per engine:
- ChatGPT-User (4679 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×417 · / ×365 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×323
...
Hot terms: agents(35), founder(30), agentic(29), startup(25), mcp(21), agent(20), build(20), coding(14), building(13), code(11), about(11), google(10), tools(10), first(9), claude(8).
...
The real answer engines are crawling us — IP-verified: 13214 confirmed AI-engine fetches (ChatGPT (user browsing) 4679, GPTBot (OpenAI) 4720, Perplexity 2724, ChatGPT Search (OpenAI) 1091).
