# Analytics brief — auto-exported 2026-08-28T19:58Z (last 14 days)
...
Per engine:
- ChatGPT-User (4339 verified): / ×461 · /posts/agent-funding-august-2026-control-won-the-summer.html ×426 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×270
...
Hot terms: agents(31), startup(31), build(30), founder(25), agentic(24), engineering(16), agent(16), mcp(15), building(15), one(12), systems(11), coding(11), here(11), learn(9), production(8).
...
The real answer engines are crawling us — IP-verified: 12407 confirmed AI-engine fetches (GPTBot (OpenAI) 5363, ChatGPT (user browsing) 4339, ChatGPT Search (OpenAI) 1618, Perplexity 1087).
