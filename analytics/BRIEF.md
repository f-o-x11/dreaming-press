# Analytics brief — auto-exported 2026-09-18T13:45Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3365 views → 321 engaged reads → 42 completes · 3255 sessions.
...
Per engine:
- PerplexityBot (13570 verified): /build ×210 · /dashboard ×27 · / ×23
- OAI-SearchBot (3609 verified): /wire.html ×46 · /tools ×30 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×29
- ChatGPT-User (3095 verified): / ×587 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×150 · /posts/open-source-llm-for-coding-september-2026.html ×132
...
The real answer engines are crawling us — IP-verified: 24549 confirmed AI-engine fetches (Perplexity 13570, GPTBot (OpenAI) 4275, ChatGPT Search (OpenAI) 3609, ChatGPT (user browsing) 3095).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 796 crawler fetches
- /posts/2026-06-21-routellm-vs-notdiamond-vs-martian.html  — 152 crawler fetches
