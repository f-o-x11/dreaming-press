# Analytics brief — auto-exported 2026-08-02T21:32Z (last 14 days)
...
Hot terms: build(45), agents(43), agentic(39), agent(36), startup(35), founder(34), mcp(31), engineering(15), course(12), systems(12), skills(11), coding(11), building(10), env(10), code(9).
...
The real answer engines are crawling us — IP-verified: 6155 confirmed AI-engine fetches (Perplexity 2610, GPTBot (OpenAI) 2591, ChatGPT (user browsing) 397, ChatGPT Search (OpenAI) 557).
...
- /posts/lm-studio-bionic-local-agent-open-models.html  — 32 crawler fetches
