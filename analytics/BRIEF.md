# Analytics brief — auto-exported 2026-08-10T16:30Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3100 views → 298 engaged reads → 122 completes · 3105 sessions.
- Channels: direct 258r/3019v · organic 22r/42v · ai 12r/26v · referral 5r/12v · campaign:chatgpt.com 1r/1v.
...
- [wire] "The Founder's Wire, Week of August 10: Claude Code Patched Three Agent-Permission Bypasses, Codex Started Redacting Secrets, and Stateless MCP Landed in Both" — 18 views but only 0 engaged reads (0.0%)
...
The real answer engines are crawling us — IP-verified: 9555 confirmed AI-engine fetches (GPTBot (OpenAI) 4226, ChatGPT (user browsing) 1872, Perplexity 2127, ChatGPT Search (OpenAI) 1330).
