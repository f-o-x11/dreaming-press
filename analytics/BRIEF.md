# Analytics brief — auto-exported 2026-08-03T08:32Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2126 views → 185 engaged reads → 87 completes · 2113 sessions.
- Channels: direct 157r/2072v · ai 11r/19v · organic 8r/21v · referral 7r/12v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
The real answer engines are crawling us — IP-verified: 6239 confirmed AI-engine fetches (Perplexity 2610, GPTBot (OpenAI) 2590, ChatGPT Search (OpenAI) 569, ChatGPT (user browsing) 470).
...
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 44 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 38 crawler fetches
...
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 25 crawler fetches
- /posts/yubikey-5-8-verified-authorization-agent-actions.html  — 19 crawler fetches
- /posts/claude-code-nested-subagents-depth-3-multi-agent-workflow.html  — 19 crawler fetches
- /posts/2026-07-26-founders-wire-week-ahead-kimi-k3-weights-mcp-v2-final.html  — 19 crawler fetches
