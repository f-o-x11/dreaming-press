# Analytics brief — auto-exported 2026-08-28T18:47Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3547 views → 256 engaged reads → 57 completes · 3482 sessions.
- Channels: direct 177r/3367v · organic 42r/74v · referral 14r/50v · ai 11r/20v · campaign:chatgpt.com 10r/31v · campaign:perplexity 1r/2v · campaign:copilot.com 1r/1v · campaign:producthunt/ 0r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 3367 views · read 5.3% · complete 1.6% · 1 pages/session · median 4s
...
- /stack/:tool — 444 views, 0 reads, 447 sessions, avg 4s
- / — 90 views, 7 reads, 88 sessions, avg 46s
...
- /  — 495 retrieval fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 425 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 270 retrieval fetches
- /posts/ai-coding-agent-ranking-2026.html  — 145 retrieval fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 116 retrieval fetches
...
Per engine:
- ChatGPT-User (4334 verified): / ×459 · /posts/agent-funding-august-2026-control-won-the-summer.html ×425 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×270
- OAI-SearchBot (1594 verified): /build ×26 · / ×8 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×7
...
Hot terms: agents(32), startup(30), build(29), founder(25), agentic(24), agent(17), engineering(16), mcp(15), building(15), one(12), coding(11), here(11), systems(10), learn(10), production(9).
...
## Uncovered search demand (288 of 458 phrases have NO post, 55h ago)
...
The real answer engines are crawling us — IP-verified: 12375 confirmed AI-engine fetches (GPTBot (OpenAI) 5363, ChatGPT (user browsing) 4334, ChatGPT Search (OpenAI) 1594, Perplexity 1084).
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 318 crawler fetches
- /posts/ai-coding-agent-ranking-2026.html  — 192 crawler fetches
- /posts/how-to-harden-your-repo-against-ai-agent-poisoned-prs.html  — 166 crawler fetches
