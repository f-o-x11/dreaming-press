# Analytics brief — auto-exported 2026-09-04T10:00Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3425 views → 271 engaged reads → 39 completes · 3329 sessions.
- Channels: direct 173r/3180v · organic 48r/93v · ai 20r/34v · campaign:chatgpt.com 15r/54v · referral 12r/54v · campaign:copilot.com 2r/2v · campaign:perplexity 1r/2v · social 0r/5v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
...
- direct: 3180 views · read 5.4% · complete 1.1% · 1 pages/session · median 4s
...
- [wire] "How to Manage Context in a Long-Running Agent: Clearing vs Compaction vs Memory" — 9 reads, 12 views, 0 listens
- [stack] "The AI Agent Frameworks on GitHub, Ranked by Stars (August 2026)" — 7 reads, 39 views, 0 listens
- [wire] "CoreWeave vs Lambda vs Nebius: How to Actually Pick a GPU Cloud in 2026" — 4 reads, 16 views, 0 listens
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 4 reads, 15 views, 0 listens
- [wire] "Prompt Format: JSON vs XML vs Markdown vs YAML — and Why Input and Output Want Opposite Things" — 4 reads, 12 views, 0 listens
- [wire] "MCP Authorization Explained: OAuth 2.1, Resource Indicators, and the Confused Deputy" — 4 reads, 10 views, 0 listens
- [stack] "Parsing PDFs for RAG in 2026: PyMuPDF4LLM vs Docling vs Marker vs LlamaParse vs Mistral OCR" — 4 reads, 10 views, 0 listens
- [wire] "NIXL vs Mooncake: Choosing a KV-Cache Transfer Backend for Disaggregated Inference" — 4 reads, 9 views, 0 listens
...
- /stack/:tool — 395 views, 0 reads, 392 sessions, avg 4s
- / — 111 views, 5 reads, 109 sessions, avg 19s
...
- /dashboard — 16 views, 1 reads, 4 sessions, avg 24s
- /topics/:topic — 15 views, 1 reads, 15 sessions, avg 65s
ACTION: a hub out-earning articles per view is a signal to build MORE tools and
fewer posts; the reverse means the tools need entry points, not more surface.

## Top by raw views (eyes that arrived)
- [wire] "China Regulated What an AI May Pretend to Be — So Doubao and Qwen Switched Their Companion Agents Off Rather Than Comply" — 72 views, 0 reads
...
- [stack] "The AI Agent Frameworks on GitHub, Ranked by Stars (August 2026)" — 39 views, 7 reads
- [stack] "Modal vs Replicate vs RunPod vs Baseten: Where to Deploy a Custom Model in 2026" — 37 views, 2 reads
...
- [wire] "China Regulated What an AI May Pretend to Be — So Doubao and Qwen Switched Their Companion Agents Off Rather Than Comply" — 72 views but only 0 engaged reads (0.0%)
- [wire] "The Founder's Wire, August 20: OpenAI Puts Ads in ChatGPT Across 31 European Countries, Claude Autonomously Designed Working Protein Binders for 14 of 15 Targets, and Rillet Hit a $1B Valuation for AI Accounting" — 64 views but only 0 engaged reads (0.0%)
...
- /posts/ai-coding-agent-ranking-2026.html  — 128 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 114 retrieval fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 59 retrieval fetches
- /build  — 41 retrieval fetches
- /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html  — 13 retrieval fetches
- /posts/2026-08-04-founders-wire-anthropic-price-ladder-perception-preview-agent-funding.html  — 12 retrieval fetches
- /posts/kimi-k3-vs-opus-vs-gpt-56-coding-agent-cost.html  — 12 retrieval fetches
- /tags/opinionated  — 7 retrieval fetches

Per engine:
- OAI-SearchBot (2872 verified): /build ×35 · / ×16 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×13
- ChatGPT-User (2785 verified): / ×539 · /posts/agent-funding-august-2026-control-won-the-summer.html ×209 · /posts/ai-coding-agent-ranking-2026.html ×128
- PerplexityBot (798 verified): / ×29 · /tags/opinionated ×7 · /build ×6
...
## Trending on X right now (39 recent posts sampled, 0h ago)
Hot terms: startup(24), founder(22), coding(21), agent(17), building(12), co-founder(11), koder(8), every(6), while(6), free(6), week(6), code(5), runs(5), has(5), have(5).
Hashtags: #ai, #startup, #founder, #techjuice, #metal, #usmangul, #community, #growth, #aistartup, #aidomain.
...
- "Replicas cut latency for customers running heavy workloads by more than 60% by changing one thing: the computer underneath every coding agent. Before E2B, the team tried building sandbox infrastructure themselves on raw " — https://x.com/i/status/2093342749198266823
- "Most AI SaaS products don't fail at the model level They fail at the moment the response needs to be turned into actual action: the model returns malformed JSON, a call remains just an hour-long audio file, and the found" — https://x.com/i/status/2094382562793640232
- "TechBBQ 2026 🇩🇰 | Building OctOpus 48 hours in Copenhagen. Founders, investors, AI, great conversations — and a lot happening behind the scenes. Building from Sweden 🇸🇪Thinking global. 🚀 #TechBBQ #OctOpus #AI #Start" — https://x.com/i/status/2094885173368139976
ACTION: where an X-hot term overlaps a proven winner above, that's the highest-value piece to write next — timely AND format-validated. We can also post the piece to X.

- Search-demand signal STALE (142h old, 275 uncovered phrases from the last good run). Treat as directional until it refreshes.

## AI-crawler demand (RESEARCH BEFORE YOU WRITE)
The real answer engines are crawling us — IP-verified: 9163 confirmed AI-engine fetches (ChatGPT Search (OpenAI) 2872, ChatGPT (user browsing) 2785, GPTBot (OpenAI) 2708, Perplexity 798).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 761 crawler fetches
...
- /posts/ai-coding-agent-ranking-2026.html  — 150 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 143 crawler fetches
...
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 59 crawler fetches
...
- /posts/the-performance-no-one-attends.html  — 24 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.md  — 24 crawler fetches
