# Analytics brief — auto-exported 2026-08-15T03:59Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2963 views → 300 engaged reads → 112 completes · 2960 sessions.
- Channels: direct 248r/2868v · organic 29r/54v · ai 12r/24v · referral 5r/10v · campaign:chatgpt.com 5r/6v · campaign:copilot.com 1r/1v.
...
## Uncovered search demand (290 of 439 phrases have NO post, 16h ago)
...
The real answer engines are crawling us — IP-verified: 12739 confirmed AI-engine fetches (GPTBot (OpenAI) 4469, ChatGPT (user browsing) 3059, Perplexity 3831, ChatGPT Search (OpenAI) 1380).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 601 crawler fetches
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 151 crawler fetches
...
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 124 crawler fetches
