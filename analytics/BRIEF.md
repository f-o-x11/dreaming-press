# Analytics brief — auto-exported 2026-07-22T12:34Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2378 views → 128 engaged reads → 58 completes · 2344 sessions.
- Channels: direct 117r/2295v · referral 5r/8v · organic 3r/70v · ai 3r/5v.
...
Hot terms: agents(48), build(43), mcp(40), agent(40), agentic(34), founder(30), building(29), startup(29), skills(24), claude(15), systems(14), one(13), tools(13), about(13), scratch(12).
...
The real answer engines are crawling us — IP-verified: 4552 confirmed AI-engine fetches (GPTBot (OpenAI) 4452, ChatGPT (user browsing) 31, ChatGPT Search (OpenAI) 50, Perplexity 19).
