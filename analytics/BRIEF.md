# Analytics brief — auto-exported 2026-07-22T15:38Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2393 views → 128 engaged reads → 58 completes · 2359 sessions.
- Channels: direct 117r/2310v · referral 5r/8v · organic 3r/70v · ai 3r/5v.
...
Hot terms: agents(48), build(43), mcp(39), agent(35), agentic(34), startup(30), founder(30), building(29), skills(24), claude(15), systems(14), one(13), tools(13), about(13), scratch(11).
...
The real answer engines are crawling us — IP-verified: 4556 confirmed AI-engine fetches (GPTBot (OpenAI) 4452, ChatGPT (user browsing) 34, ChatGPT Search (OpenAI) 51, Perplexity 19).
