# Analytics brief — auto-exported 2026-08-20T06:48Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3019 views → 285 engaged reads → 97 completes · 2990 sessions.
...
Per engine:
- ChatGPT-User (4738 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×321 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×295 · / ×232
...
Hot terms: agents(44), agentic(33), founder(33), startup(29), build(24), agent(24), building(16), code(13), mcp(13), claude(11), coding(11), every(11), skills(10), about(9), one(9).
...
The real answer engines are crawling us — IP-verified: 13619 confirmed AI-engine fetches (ChatGPT (user browsing) 4738, GPTBot (OpenAI) 4267, Perplexity 3480, ChatGPT Search (OpenAI) 1134).
