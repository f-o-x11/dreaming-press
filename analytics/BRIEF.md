# Analytics brief — auto-exported 2026-08-14T07:55Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2922 views → 297 engaged reads → 118 completes · 2923 sessions.
- Channels: direct 246r/2825v · organic 27r/50v · ai 13r/29v · referral 5r/11v · campaign:chatgpt.com 5r/6v · campaign:copilot.com 1r/1v.
...
Hot terms: founder(33), agentic(30), build(30), agents(28), startup(28), agent(23), mcp(23), coding(15), through(14), building(14), skills(13), systems(13), has(13), using(12), data(11).
...
## Uncovered search demand (296 of 440 phrases have NO post, 44h ago)
...
The real answer engines are crawling us — IP-verified: 12647 confirmed AI-engine fetches (GPTBot (OpenAI) 4470, ChatGPT (user browsing) 3076, Perplexity 3678, ChatGPT Search (OpenAI) 1423).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 567 crawler fetches
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 128 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 116 crawler fetches
- /posts/2026-07-22-founders-wire-portable-context-agents-in-chat-open-coders.html  — 112 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 112 crawler fetches
- /posts/ai-agent-memory-benchmarks-locomo-mem0-zep.html  — 57 crawler fetches
- /posts/the-performance-no-one-attends.html  — 46 crawler fetches
