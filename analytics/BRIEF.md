# Analytics brief — auto-exported 2026-08-02T15:58Z (last 14 days)
...
Hot terms: build(46), agents(42), agentic(36), startup(36), founder(34), agent(31), mcp(29), engineering(13), systems(12), env(10), code(9), course(9), memory(9), tools(9), was(9).
...
The real answer engines are crawling us — IP-verified: 6070 confirmed AI-engine fetches (Perplexity 2608, GPTBot (OpenAI) 2590, ChatGPT (user browsing) 380, ChatGPT Search (OpenAI) 492).
