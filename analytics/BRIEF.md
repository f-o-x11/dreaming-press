# Analytics brief — auto-exported 2026-08-29T19:04Z (last 14 days)
...
Per engine:
- ChatGPT-User (4046 verified): / ×480 · /posts/agent-funding-august-2026-control-won-the-summer.html ×398 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×245
- OAI-SearchBot (1804 verified): /build ×28 · / ×9 · /posts/groq-vs-cerebras-vs-sambanova-fast-inference.html ×8
...
Hot terms: agents(31), startup(30), build(28), founder(26), agentic(21), agent(19), building(16), mcp(14), coding(14), engineering(14), one(14), here(13), systems(9), production(9), has(9).
...
The real answer engines are crawling us — IP-verified: 12078 confirmed AI-engine fetches (GPTBot (OpenAI) 5364, ChatGPT (user browsing) 4046, ChatGPT Search (OpenAI) 1804, Perplexity 864).
