# Analytics brief — auto-exported 2026-08-19T01:54Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3253 views → 289 engaged reads → 107 completes · 3236 sessions.
- Channels: direct 235r/3152v · organic 35r/59v · referral 7r/13v · ai 6r/18v · campaign:chatgpt.com 5r/10v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3152 views · read 7.5% · complete 3.3% · 0.99 pages/session · median 6s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 271 retrieval fetches
...
Per engine:
- ChatGPT-User (4369 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×271 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×258 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×213
...
Hot terms: agents(34), founder(31), startup(31), agentic(30), build(25), agent(23), building(17), mcp(17), one(11), code(11), coding(11), skills(10), systems(10), engineering(10), every(10).
...
## Uncovered search demand (286 of 438 phrases have NO post, 38h ago)
...
The real answer engines are crawling us — IP-verified: 16624 confirmed AI-engine fetches (GPTBot (OpenAI) 7463, ChatGPT (user browsing) 4369, Perplexity 3541, ChatGPT Search (OpenAI) 1251).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 695 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 271 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 263 crawler fetches
