# Analytics brief — auto-exported 2026-08-15T14:15Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2974 views → 307 engaged reads → 108 completes · 2972 sessions.
- Channels: direct 255r/2881v · organic 28r/53v · ai 12r/22v · referral 6r/11v · campaign:chatgpt.com 5r/6v · campaign:copilot.com 1r/1v.
...
Hot terms: agents(31), build(30), startup(30), agent(29), founder(29), agentic(26), mcp(20), engineering(17), coding(15), building(14), data(13), using(13), systems(12), model(11), through(11).
...
## Uncovered search demand (290 of 439 phrases have NO post, 26h ago)
...
The real answer engines are crawling us — IP-verified: 15700 confirmed AI-engine fetches (GPTBot (OpenAI) 7292, ChatGPT (user browsing) 3181, Perplexity 3831, ChatGPT Search (OpenAI) 1396).
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 160 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 141 crawler fetches
- /posts/2026-07-22-founders-wire-portable-context-agents-in-chat-open-coders.html  — 137 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 137 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 137 crawler fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 136 crawler fetches
- /posts/ai-agent-memory-benchmarks-locomo-mem0-zep.html  — 57 crawler fetches
- /posts/the-performance-no-one-attends.html  — 50 crawler fetches
