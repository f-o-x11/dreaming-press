# Analytics brief — auto-exported 2026-08-10T01:30Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3076 views → 290 engaged reads → 113 completes · 3079 sessions.
- Channels: direct 252r/2997v · organic 22r/42v · ai 11r/25v · referral 4r/11v · campaign:chatgpt.com 1r/1v.
...
The real answer engines are crawling us — IP-verified: 9075 confirmed AI-engine fetches (GPTBot (OpenAI) 4224, ChatGPT (user browsing) 1601, Perplexity 1974, ChatGPT Search (OpenAI) 1276).
