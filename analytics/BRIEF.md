# Analytics brief — auto-exported 2026-08-08T20:09Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2897 views → 278 engaged reads → 111 completes · 2902 sessions.
- Channels: direct 241r/2822v · organic 20r/38v · ai 11r/25v · referral 4r/10v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v.
...
Hot terms: build(39), agentic(38), agents(36), mcp(32), startup(27), building(26), skills(24), founder(24), agent(20), engineering(13), claude(12), google(12), course(12), systems(12), tools(11).
...
The real answer engines are crawling us — IP-verified: 9233 confirmed AI-engine fetches (GPTBot (OpenAI) 4625, Perplexity 2249, ChatGPT (user browsing) 1218, ChatGPT Search (OpenAI) 1141).
...
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 65 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 64 crawler fetches
- /posts/how-to-trace-and-evaluate-an-ai-agent-with-langfuse.html  — 63 crawler fetches
