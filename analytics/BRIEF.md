# Analytics brief — auto-exported 2026-07-18T13:15Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2053 views → 100 engaged reads → 46 completes · 2023 sessions.
- Channels: direct 95r/1993v · organic 2r/53v · referral 2r/5v · ai 1r/2v.
...
Hot terms: agent(52), build(46), mcp(45), founder(45), agentic(43), agents(37), startup(34), skills(25), building(22), course(21), scratch(18), memory(17), first(15), claude(15), api(14).
