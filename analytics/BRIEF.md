# Analytics brief — auto-exported 2026-08-29T18:54Z (last 14 days)
...
Per engine:
- ChatGPT-User (4045 verified): / ×480 · /posts/agent-funding-august-2026-control-won-the-summer.html ×398 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×245
- OAI-SearchBot (1800 verified): /build ×28 · / ×9 · /posts/groq-vs-cerebras-vs-sambanova-fast-inference.html ×8
...
Hot terms: startup(32), agents(29), build(28), founder(25), agentic(21), agent(17), building(16), engineering(15), here(15), mcp(14), one(14), coding(10), systems(9), production(9), world(9).
...
The real answer engines are crawling us — IP-verified: 12070 confirmed AI-engine fetches (GPTBot (OpenAI) 5364, ChatGPT (user browsing) 4045, ChatGPT Search (OpenAI) 1800, Perplexity 861).
