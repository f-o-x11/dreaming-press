# Analytics brief — auto-exported 2026-07-31T17:07Z (last 14 days)
...
Hot terms: agents(53), build(48), mcp(42), agentic(40), founder(37), agent(35), startup(33), engineering(22), building(16), google(13), course(11), loops(11), coding(11), 1-hour(10), systems(10).
...
The real answer engines are crawling us — IP-verified: 6536 confirmed AI-engine fetches (GPTBot (OpenAI) 3377, Perplexity 2417, ChatGPT (user browsing) 273, ChatGPT Search (OpenAI) 469).
...
- /posts/lm-studio-bionic-local-agent-open-models.html  — 16 crawler fetches
