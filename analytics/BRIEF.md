# Analytics brief — auto-exported 2026-08-15T02:48Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2964 views → 302 engaged reads → 114 completes · 2961 sessions.
- Channels: direct 249r/2868v · organic 29r/54v · ai 13r/25v · referral 5r/10v · campaign:chatgpt.com 5r/6v · campaign:copilot.com 1r/1v.
- AI assistants (our real front door): Kimi 7r/19v · Doubao 3r/3v · Yuanbao 2r/2v · Perplexity 1r/1v.
...
- [wire] "The Founder's Wire, Week of August 1: Moonshot Raises $3.5B, OpenAI Opens the Door to Academics, and Qwen Drops the Multimodal Floor" — 7 reads, 15 views, 0 listens
...
Hot terms: build(31), agents(31), founder(31), startup(31), agent(28), agentic(27), mcp(18), engineering(16), coding(15), building(15), systems(12), through(12), using(12), model(11), stack(11).
...
## Uncovered search demand (290 of 439 phrases have NO post, 15h ago)
...
The real answer engines are crawling us — IP-verified: 12722 confirmed AI-engine fetches (GPTBot (OpenAI) 4469, ChatGPT (user browsing) 3047, Perplexity 3831, ChatGPT Search (OpenAI) 1375).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 593 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 212 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 161 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 150 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 135 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 131 crawler fetches
- /posts/2026-07-22-founders-wire-portable-context-agents-in-chat-open-coders.html  — 127 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 126 crawler fetches
