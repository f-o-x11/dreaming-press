# Analytics brief — auto-exported 2026-09-24T01:40Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3322 views → 344 engaged reads → 20 completes · 3193 sessions.
- Channels: direct 163r/2909v · organic 110r/150v · campaign:chatgpt.com 39r/154v · ai 16r/41v · referral 11r/59v · campaign:qwant 4r/5v · social 1r/3v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
...
- OAI-SearchBot (3833 verified): /wire.html ×53 · /tools ×35 · /posts/kimi-k3-vs-opus-vs-gpt-56-coding-agent-cost.html ×30
- ChatGPT-User (3027 verified): / ×578 · /posts/open-source-llm-for-coding-september-2026.html ×207 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×154
...
Hot terms: agents(43), founder(35), startup(33), agent(28), build(26), agentic(22), building(21), coding(18), mcp(18), google(9), claude(8), like(8), launch(8), first(8), security(7).
...
The real answer engines are crawling us — IP-verified: 19634 confirmed AI-engine fetches (Perplexity 7857, GPTBot (OpenAI) 4917, ChatGPT Search (OpenAI) 3833, ChatGPT (user browsing) 3027).
