# Analytics brief — auto-exported 2026-09-23T06:23Z (last 14 days)
...
- OAI-SearchBot (3717 verified): /wire.html ×50 · /tools ×33 · /posts/local-llm-for-coding-on-your-own-machine.html ×29
- ChatGPT-User (3072 verified): / ×588 · /posts/open-source-llm-for-coding-september-2026.html ×205 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×156
...
Hot terms: agents(41), founder(35), startup(33), agent(28), build(24), agentic(23), mcp(21), coding(17), building(16), first(10), launch(10), google(9), has(9), every(8), today(8).
...
The real answer engines are crawling us — IP-verified: 19613 confirmed AI-engine fetches (Perplexity 8376, GPTBot (OpenAI) 4448, ChatGPT Search (OpenAI) 3717, ChatGPT (user browsing) 3072).
