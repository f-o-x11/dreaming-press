# Analytics brief — auto-exported 2026-09-18T10:22Z (last 14 days)
...
Per engine:
- PerplexityBot (13552 verified): /build ×210 · /dashboard ×27 · / ×23
- OAI-SearchBot (3583 verified): /wire.html ×45 · /tools ×30 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×29
- ChatGPT-User (3052 verified): / ×580 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×147 · /posts/open-source-llm-for-coding-september-2026.html ×129
...
## Uncovered search demand (253 of 450 phrases have NO post, 23h ago)
...
The real answer engines are crawling us — IP-verified: 24442 confirmed AI-engine fetches (Perplexity 13552, GPTBot (OpenAI) 4255, ChatGPT Search (OpenAI) 3583, ChatGPT (user browsing) 3052).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 788 crawler fetches
...
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 61 crawler fetches
