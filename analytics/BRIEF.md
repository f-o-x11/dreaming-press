# Analytics brief — auto-exported 2026-09-09T14:27Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3294 views → 288 engaged reads → 50 completes · 3156 sessions.
- Channels: direct 179r/3008v · organic 51r/98v · campaign:chatgpt.com 21r/82v · referral 18r/63v · ai 17r/32v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v · social 0r/8v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
...
- OAI-SearchBot (3517 verified): /build ×28 · / ×23 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×19
...
Hot terms: startup(33), agents(32), founder(29), agentic(28), build(26), mcp(19), building(19), claude(12), code(12), agent(11), have(10), autonomous(9), co-founder(9), own(8), about(8).
...
The real answer engines are crawling us — IP-verified: 17812 confirmed AI-engine fetches (Perplexity 9011, ChatGPT Search (OpenAI) 3517, ChatGPT (user browsing) 3019, GPTBot (OpenAI) 2265).
