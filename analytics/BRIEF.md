# Analytics brief — auto-exported 2026-09-04T16:01Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3438 views → 272 engaged reads → 39 completes · 3346 sessions.
- Channels: direct 176r/3193v · organic 46r/92v · ai 20r/34v · campaign:chatgpt.com 15r/55v · referral 12r/54v · campaign:copilot.com 2r/2v · campaign:perplexity 1r/2v · social 0r/5v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
- AI assistants (our real front door): ChatGPT 16r/58v · Doubao 9r/10v · Perplexity 8r/12v · Copilot 2r/2v · Grok 1r/3v · Yuanbao 1r/1v · Kimi 0r/3v · Claude 0r/2v.
...
- direct: 3193 views · read 5.5% · complete 1.1% · 1 pages/session · median 4s
- organic: 92 views · read 50.0% · complete 1.1% · 1.08 pages/session · median 4s
...
- [wire] "How to Manage Context in a Long-Running Agent: Clearing vs Compaction vs Memory" — 10 reads, 13 views, 0 listens
- [stack] "The AI Agent Frameworks on GitHub, Ranked by Stars (August 2026)" — 7 reads, 37 views, 0 listens
- [wire] "MCP Authorization Explained: OAuth 2.1, Resource Indicators, and the Confused Deputy" — 6 reads, 12 views, 0 listens
- [wire] "CoreWeave vs Lambda vs Nebius: How to Actually Pick a GPU Cloud in 2026" — 4 reads, 17 views, 0 listens
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 4 reads, 14 views, 0 listens
...
- / — 112 views, 5 reads, 110 sessions, avg 19s
...
- [wire] "China Regulated What an AI May Pretend to Be — So Doubao and Qwen Switched Their Companion Agents Off Rather Than Comply" — 69 views, 0 reads
...
- [stack] "The AI Agent Frameworks on GitHub, Ranked by Stars (August 2026)" — 37 views, 7 reads
...
- [wire] "China Regulated What an AI May Pretend to Be — So Doubao and Qwen Switched Their Companion Agents Off Rather Than Comply" — 69 views but only 0 engaged reads (0.0%)
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 211 retrieval fetches
- /posts/ai-coding-agent-ranking-2026.html  — 129 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 116 retrieval fetches
- /build  — 70 retrieval fetches
- /posts/ai-agent-frameworks-github-ranked-by-stars-2026.html  — 60 retrieval fetches
- /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html  — 13 retrieval fetches
- /posts/2026-06-22-modal-vs-replicate-vs-runpod-vs-baseten.html  — 12 retrieval fetches
...
Per engine:
- OAI-SearchBot (2923 verified): /build ×35 · / ×16 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×13
- ChatGPT-User (2849 verified): / ×550 · /posts/agent-funding-august-2026-control-won-the-summer.html ×211 · /posts/ai-coding-agent-ranking-2026.html ×129
- PerplexityBot (2087 verified): /build ×35 · / ×29 · /tags/opinionated ×7
...
Hot terms: agents(34), agent(30), founder(27), startup(26), coding(23), build(20), agentic(19), building(16), one(11), code(11), mcp(10), week(10), systems(9), co-founder(9), launch(8).
Hashtags: #startup, #ai, #founder, #agentic, #techjuice, #metal, #usmangul, #community, #growth, #aistartup.
...
## Uncovered search demand (270 of 457 phrases have NO post, 4h ago)
Real Google + Bing autocomplete, minus everything the corpus already answers. Phrases
confirmed by BOTH engines are listed first — two independent indexes agreeing is the
closest thing to a volume signal we get without a paid keyword tool.
- "ai agent security best practices"  [google+bing+ddg]
- "ai agent security jobs"  [google+bing+ddg]
...
- "how to build an ai agent with chatgpt"  [google+bing+ddg]
- "llm api pricing calculator"  [google+bing+ddg]
- "local llm reddit"  [google+bing+ddg]
- "mcp server meaning"  [google+bing+ddg]
- "open source llm for coding"  [google+bing+ddg]
- "open source llm leaderboard"  [google+bing+ddg]
- "open source llm models to run locally"  [google+bing+ddg]
...
The real answer engines are crawling us — IP-verified: 10567 confirmed AI-engine fetches (ChatGPT Search (OpenAI) 2923, ChatGPT (user browsing) 2849, GPTBot (OpenAI) 2708, Perplexity 2087).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 802 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 211 crawler fetches
- /posts/how-to-harden-your-repo-against-ai-agent-poisoned-prs.html  — 202 crawler fetches
- /posts/ai-coding-agent-ranking-2026.html  — 151 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 145 crawler fetches
- /posts/ai-agent-frameworks-github-ranked-by-stars-2026.html  — 127 crawler fetches
...
- /posts/2026-08-23-founders-wire-openai-zero-retention-guidelight-grades-google-marvell.html  — 51 crawler fetches
...
- /posts/2026-08-20-founders-wire-chatgpt-ads-claude-protein-rillet.html  — 20 crawler fetches
