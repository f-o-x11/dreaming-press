# Analytics brief — auto-exported 2026-09-19T03:37Z (last 14 days)
...
Per engine:
- PerplexityBot (12112 verified): /build ×178 · / ×24 · /dashboard ×23
...
Hot terms: agents(33), founder(32), startup(27), mcp(25), agentic(20), build(20), agent(18), coding(15), building(11), has(11), like(9), google(9), launch(8), run(8), actually(8).
...
The real answer engines are crawling us — IP-verified: 22693 confirmed AI-engine fetches (Perplexity 12112, GPTBot (OpenAI) 4273, ChatGPT Search (OpenAI) 3326, ChatGPT (user browsing) 2982).
...
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 84 crawler fetches
