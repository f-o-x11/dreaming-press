# Analytics brief — auto-exported 2026-09-19T00:46Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3370 views → 324 engaged reads → 42 completes · 3259 sessions.
- Channels: direct 178r/3003v · organic 70r/108v · campaign:chatgpt.com 43r/150v · referral 19r/71v · ai 12r/33v · social 1r/4v · campaign:perplexity 1r/1v · internal-nav 0r/0v.
...
- direct: 3003 views · read 5.9% · complete 0.6% · 1 pages/session · median 4s
...
- OAI-SearchBot (3298 verified): /wire.html ×47 · /tools ×33 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×28
...
Hot terms: agents(32), startup(31), founder(30), mcp(25), agentic(23), build(20), agent(15), coding(13), building(12), google(9), launch(8), run(8), actually(8), every(8), like(8).
...
The real answer engines are crawling us — IP-verified: 22584 confirmed AI-engine fetches (Perplexity 12055, GPTBot (OpenAI) 4272, ChatGPT Search (OpenAI) 3298, ChatGPT (user browsing) 2959).
