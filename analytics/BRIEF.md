# Analytics brief — auto-exported 2026-09-12T19:53Z (last 14 days)
...
Per engine:
- PerplexityBot (10501 verified): /build ×165 · / ×26 · /dashboard ×20
- OAI-SearchBot (3419 verified): /posts/2026-08-04-founders-wire-anthropic-price-ladder-perception-preview-agent-funding.html ×25 · / ×25 · /posts/kimi-k3-vs-opus-vs-gpt-56-coding-agent-cost.html ×24
...
Hot terms: agents(28), agentic(28), founder(28), startup(28), build(27), mcp(19), building(18), agent(14), own(11), systems(11), python(10), about(9), has(8), have(8), model(8).
...
The real answer engines are crawling us — IP-verified: 18259 confirmed AI-engine fetches (Perplexity 10501, ChatGPT Search (OpenAI) 3419, ChatGPT (user browsing) 3022, GPTBot (OpenAI) 1317).
