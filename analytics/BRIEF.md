# Analytics brief — auto-exported 2026-08-21T01:52Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2975 views → 284 engaged reads → 96 completes · 2944 sessions.
- Channels: direct 224r/2866v · organic 39r/65v · referral 8r/18v · ai 6r/12v · campaign:chatgpt.com 6r/12v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2866 views · read 7.8% · complete 3.3% · 1 pages/session · median 5s
- organic: 65 views · read 60.0% · complete 3.1% · 1.03 pages/session · median ?s
- referral: 18 views · read 44.4% · complete 0.0% · 1 pages/session · median ?s
...
- / — 30 views, 1 reads, 29 sessions, avg 10s
...
Per engine:
- ChatGPT-User (4875 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×351 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×318 · / ×248
...
The real answer engines are crawling us — IP-verified: 13682 confirmed AI-engine fetches (ChatGPT (user browsing) 4875, GPTBot (OpenAI) 4266, Perplexity 3498, ChatGPT Search (OpenAI) 1043).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 569 crawler fetches
