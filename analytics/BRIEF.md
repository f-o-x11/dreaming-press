# Analytics brief — auto-exported 2026-08-18T19:09Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3235 views → 294 engaged reads → 111 completes · 3218 sessions.
- Channels: direct 241r/3137v · organic 34r/58v · referral 7r/13v · ai 6r/18v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
- AI assistants (our real front door): ChatGPT 5r/8v · Doubao 2r/3v · Yuanbao 2r/2v · Perplexity 2r/2v · Copilot 1r/1v · Kimi 0r/11v.
...
- direct: 3137 views · read 7.7% · complete 3.5% · 0.99 pages/session · median 6s
- organic: 58 views · read 58.6% · complete 3.4% · 1.04 pages/session · median ?s
...
One visitor from campaign:chatgpt.com is worth many from direct. Commission for the channels that read.
...
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 9 reads, 31 views, 0 listens
...
- [wire] "August's AI Money Moved Down the Stack: $1.5B in One Day for Power, Photonic Silicon, and AI-vs-AI Security" — 4 reads, 13 views, 0 listens
- [stack] "Docling vs Unstructured vs LlamaParse: Parsing Documents for RAG in 2026" — 4 reads, 10 views, 0 listens
- [stack] "AI Coding Agent Ranking, August 2026: Claude Code vs Codex vs Cursor vs Grok Build vs Gemini vs Muse Code" — 4 reads, 9 views, 0 listens
...
- /stack/:tool — 144 views, 0 reads, 148 sessions, avg 5s
- /build — 20 views, 0 reads, 19 sessions, avg 5s
- / — 14 views, 1 reads, 12 sessions, avg 13s
- /best/:cat — 14 views, 0 reads, 14 sessions, avg 4s
- /weekly — 13 views, 0 reads, 13 sessions, avg 5s
- /compare/:pair — 7 views, 0 reads, 7 sessions, avg 3s
- /tools — 7 views, 0 reads, 7 sessions, avg 8s
- /tags/captivating — 4 views, 0 reads, 3 sessions, avg 9s
...
- [wire] "The Founder's Wire, August 15: OpenAI Hits Real-Time Speed, Google Halves Gemini Flash, and China's GLM-5.3 Tops the Open-Weights Coding Board" — 81 views, 1 reads
...
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 31 views, 9 reads
...
- [wire] "The Founder's Wire, August 15: OpenAI Hits Real-Time Speed, Google Halves Gemini Flash, and China's GLM-5.3 Tops the Open-Weights Coding Board" — 81 views but only 1 engaged reads (1.2%)
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 259 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 248 retrieval fetches
- /  — 241 retrieval fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 224 retrieval fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 172 retrieval fetches
...
Per engine:
- ChatGPT-User (4326 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×259 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×248 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×224
...
Hot terms: agents(39), agentic(32), startup(31), founder(30), build(28), agent(22), mcp(19), building(17), engineering(14), code(12), one(11), coding(11), skills(10), systems(10), about(9).
...
## Uncovered search demand (286 of 438 phrases have NO post, 31h ago)
...
The real answer engines are crawling us — IP-verified: 17060 confirmed AI-engine fetches (GPTBot (OpenAI) 7468, ChatGPT (user browsing) 4326, Perplexity 3956, ChatGPT Search (OpenAI) 1310).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 711 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 259 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 253 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 224 crawler fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 172 crawler fetches
...
- /posts/the-performance-no-one-attends.html  — 67 crawler fetches
