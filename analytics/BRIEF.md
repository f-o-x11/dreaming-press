# Analytics brief — auto-exported 2026-07-31T09:33Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 1950 views → 177 engaged reads → 78 completes · 1933 sessions.
- Channels: direct 157r/1898v · organic 7r/33v · referral 7r/12v · ai 4r/5v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
- AI assistants (our real front door): Doubao 3r/4v · Perplexity 1r/1v.
- Referrers: google.com, doubao.com, bytedance.larkoffice.com, bing.com, yandex.ru, cn.bing.com, my.feishu.cn, perplexity.ai, i.zte.com.cn, beike.feishu.cn.
...
- [wire] "The Founder's Shipping Log: What Landed in AI Agent Frameworks This Quarter" — 5 reads, 24 views, 0 listens
- [wire] "The Founder's Wire, Week of July 16: MCP Goes Stateless, China's Persona Law Takes Effect, and Microsoft Ships Progressive Tool Discovery" — 5 reads, 16 views, 1 listens
- [wire] "China Just Launched a Rival AI Governance Bloc: What the WAICO vs Pax Silica Split Means for Founders" — 4 reads, 26 views, 0 listens
...
- [wire] "Agents vs Workflows: When Your LLM App Should Not Be an Agent" — 3 reads, 3 views, 0 listens

## Top by listens (audio is now on every piece — Item 1)
- [wire] "The Founder's Wire, Week of July 16: MCP Goes Stateless, China's Persona Law Takes Effect, and Microsoft Ships Progressive Tool Discovery" — 1 listens, 5 reads
...
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 226 views, 7 reads
- [wire] "July's ~$1.8B AI-Agent Funding Wave Made Two Bets: Control the Agents, or Own a Regulated Vertical" — 50 views, 3 reads
...
- Winning formats: news (13), comparison (8), how-to (2).
- Winning section mix: wire=23, stack=2.
- Words that recur in winning titles: week(10), founder(9), agent(9), july(8), ships(7), wire(6), mcp(6), stateless(5), agents(5), kimi(4), llm(4), model(3).
...
Hot terms: agents(53), build(52), mcp(44), agentic(42), founder(36), agent(35), startup(35), engineering(26), building(19), google(16), loops(14), 1-hour(13), course(13), toronto(12), scratch(11).
...
- "JUST IN: AI startup founder offers guaranteed interviews to hopeful job applicants willing to get permanent tattoos of his startup’s logo." — https://x.com/i/status/2082507616169722023
...
The real answer engines are crawling us — IP-verified: 6497 confirmed AI-engine fetches (GPTBot (OpenAI) 3375, Perplexity 2411, ChatGPT (user browsing) 245, ChatGPT Search (OpenAI) 466).
...
- /stack/pinecone-assistant  — 12 crawler fetches
- /stack/pinecone  — 12 crawler fetches
- /stack/phoenix  — 12 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 12 crawler fetches
