# Analytics brief — auto-exported 2026-08-13T00:22Z (last 14 days)
...
Hot terms: build(34), agents(33), founder(32), agentic(30), mcp(27), startup(27), agent(24), skills(22), building(16), claude(14), has(14), using(12), systems(12), engineering(11), through(10).
...
## Uncovered search demand (296 of 440 phrases have NO post, 13h ago)
...
The real answer engines are crawling us — IP-verified: 13085 confirmed AI-engine fetches (GPTBot (OpenAI) 5384, Perplexity 3576, ChatGPT (user browsing) 2695, ChatGPT Search (OpenAI) 1430).
