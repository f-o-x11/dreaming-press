# Analytics brief — auto-exported 2026-08-10T02:20Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3074 views → 291 engaged reads → 113 completes · 3077 sessions.
- Channels: direct 252r/2994v · organic 22r/42v · ai 12r/26v · referral 4r/11v · campaign:chatgpt.com 1r/1v.
...
The real answer engines are crawling us — IP-verified: 9089 confirmed AI-engine fetches (GPTBot (OpenAI) 4224, ChatGPT (user browsing) 1614, Perplexity 1975, ChatGPT Search (OpenAI) 1276).
