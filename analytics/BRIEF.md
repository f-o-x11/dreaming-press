# Analytics brief — auto-exported 2026-08-20T08:57Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3025 views → 281 engaged reads → 95 completes · 2994 sessions.
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 297 retrieval fetches
- /  — 280 retrieval fetches
...
Per engine:
- ChatGPT-User (4768 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×324 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×297 · / ×235
...
The real answer engines are crawling us — IP-verified: 13651 confirmed AI-engine fetches (ChatGPT (user browsing) 4768, GPTBot (OpenAI) 4267, Perplexity 3480, ChatGPT Search (OpenAI) 1136).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 630 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 324 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 302 crawler fetches
