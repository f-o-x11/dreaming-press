# Analytics brief — auto-exported 2026-08-22T23:48Z (last 14 days)
...
Per engine:
- ChatGPT-User (5092 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×383 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×328 · / ×310
...
Hot terms: agents(42), agentic(34), founder(31), agent(26), startup(25), build(21), mcp(18), building(16), coding(15), code(14), claude(11), first(11), about(10), every(10), one(9).
...
The real answer engines are crawling us — IP-verified: 14306 confirmed AI-engine fetches (ChatGPT (user browsing) 5092, GPTBot (OpenAI) 4723, Perplexity 3308, ChatGPT Search (OpenAI) 1183).
