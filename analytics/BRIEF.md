# Analytics brief — auto-exported 2026-08-20T09:48Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3024 views → 281 engaged reads → 96 completes · 2993 sessions.
- Channels: direct 223r/2920v · organic 38r/65v · referral 7r/15v · ai 6r/12v · campaign:chatgpt.com 6r/10v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2920 views · read 7.6% · complete 3.2% · 1 pages/session · median 5s
...
Per engine:
- ChatGPT-User (4780 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×326 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×298 · / ×236
...
The real answer engines are crawling us — IP-verified: 13663 confirmed AI-engine fetches (ChatGPT (user browsing) 4780, GPTBot (OpenAI) 4267, Perplexity 3480, ChatGPT Search (OpenAI) 1136).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 631 crawler fetches
