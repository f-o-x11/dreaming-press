# Analytics brief — auto-exported 2026-08-22T04:26Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2789 views → 272 engaged reads → 93 completes · 2747 sessions.
- Channels: direct 206r/2673v · organic 40r/64v · referral 11r/23v · campaign:chatgpt.com 7r/14v · ai 7r/13v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- [wire] "The Founder's Wire, Week of August 7: Meta Enters the Coding-Agent War, OpenAI Sunsets Atlas, and Claude Code Ships a Free Usage Window" — 7 reads, 182 views, 1 listens
...
Per engine:
- ChatGPT-User (5014 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×370 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×324 · / ×281
...
- Search-demand signal STALE (113h old, 286 uncovered phrases from the last good run). Treat as directional until it refreshes.

## AI-crawler demand (RESEARCH BEFORE YOU WRITE)
The real answer engines are crawling us — IP-verified: 14029 confirmed AI-engine fetches (ChatGPT (user browsing) 5014, GPTBot (OpenAI) 4720, Perplexity 3259, ChatGPT Search (OpenAI) 1036).
