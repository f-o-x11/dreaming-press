# Analytics brief — auto-exported 2026-07-20T14:09Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2145 views → 116 engaged reads → 51 completes · 2111 sessions.
- Channels: direct 108r/2073v · organic 3r/63v · ai 3r/4v · referral 2r/5v.
...
Hot terms: mcp(45), agent(45), agents(42), founder(39), build(38), agentic(33), startup(31), building(23), skills(22), claude(19), course(15), one(14), scratch(14), tools(13), memory(12).
...
The real answer engines are crawling us — IP-verified: 4600 confirmed AI-engine fetches (GPTBot (OpenAI) 4527, ChatGPT (user browsing) 20, ChatGPT Search (OpenAI) 39, Perplexity 14).
