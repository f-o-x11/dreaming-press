# Analytics brief — auto-exported 2026-08-18T21:01Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3239 views → 294 engaged reads → 110 completes · 3222 sessions.
- Channels: direct 239r/3137v · organic 36r/60v · referral 7r/13v · ai 6r/18v · campaign:chatgpt.com 5r/10v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3137 views · read 7.6% · complete 3.4% · 0.99 pages/session · median 6s
- organic: 60 views · read 60.0% · complete 3.3% · 1.03 pages/session · median ?s
...
- /stack/:tool — 145 views, 0 reads, 149 sessions, avg 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 262 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 251 retrieval fetches
- /  — 244 retrieval fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 225 retrieval fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 173 retrieval fetches
...
Per engine:
- ChatGPT-User (4360 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×262 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×251 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×225
...
Hot terms: agents(35), agentic(31), founder(31), startup(31), build(26), agent(23), mcp(18), building(17), one(11), coding(11), skills(10), code(10), systems(10), engineering(10), every(10).
...
The real answer engines are crawling us — IP-verified: 17094 confirmed AI-engine fetches (GPTBot (OpenAI) 7468, ChatGPT (user browsing) 4360, Perplexity 3956, ChatGPT Search (OpenAI) 1310).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 713 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 262 crawler fetches
...
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 173 crawler fetches
