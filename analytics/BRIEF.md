# Analytics brief — auto-exported 2026-08-17T06:49Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3065 views → 311 engaged reads → 109 completes · 3056 sessions.
- Channels: direct 261r/2970v · organic 31r/58v · ai 7r/16v · referral 6r/12v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v.
...
- /stack/:tool — 30 views, 0 reads, 31 sessions, avg 3s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 196 retrieval fetches
...
Per engine:
- ChatGPT-User (3629 verified): /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×217 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×205 · /posts/agent-funding-august-2026-control-won-the-summer.html ×196
...
Hot terms: agents(32), agentic(31), agent(29), founder(29), startup(27), build(20), coding(19), mcp(18), building(15), systems(13), engineering(13), skills(11), code(10), data(10), using(10).
...
The real answer engines are crawling us — IP-verified: 16530 confirmed AI-engine fetches (GPTBot (OpenAI) 7421, ChatGPT (user browsing) 3629, Perplexity 4171, ChatGPT Search (OpenAI) 1309).
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 196 crawler fetches
