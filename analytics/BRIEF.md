# Analytics brief — auto-exported 2026-08-04T00:25Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2171 views → 207 engaged reads → 90 completes · 2158 sessions.
- Channels: direct 180r/2118v · ai 9r/17v · organic 8r/21v · referral 8r/13v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
The real answer engines are crawling us — IP-verified: 6616 confirmed AI-engine fetches (Perplexity 2879, GPTBot (OpenAI) 2591, ChatGPT (user browsing) 574, ChatGPT Search (OpenAI) 572).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 68 crawler fetches
