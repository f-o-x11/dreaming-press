# Analytics brief — auto-exported 2026-08-06T06:55Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2610 views → 239 engaged reads → 108 completes · 2611 sessions.
- Channels: direct 207r/2543v · organic 14r/26v · ai 11r/25v · referral 5r/14v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
- [wire] "July's ~$1.8B AI-Agent Funding Wave Made Two Bets: Control the Agents, or Own a Regulated Vertical" — 3 reads, 37 views, 0 listens
...
- [wire] "July's ~$1.8B AI-Agent Funding Wave Made Two Bets: Control the Agents, or Own a Regulated Vertical" — 37 views, 3 reads
...
- [wire] "China Just Launched a Rival AI Governance Bloc: What the WAICO vs Pax Silica Split Means for Founders" — 26 views, 4 reads
...
Hot terms: build(43), agents(40), agentic(40), mcp(35), agent(26), startup(25), founder(23), engineering(18), building(17), coding(12), course(12), skills(11), systems(11), google(10), tools(10).
...
The real answer engines are crawling us — IP-verified: 10610 confirmed AI-engine fetches (GPTBot (OpenAI) 5437, Perplexity 3438, ChatGPT (user browsing) 904, ChatGPT Search (OpenAI) 831).
...
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 81 crawler fetches
...
- /posts/inside-mem0-2x-add-only-memory-engine.html  — 41 crawler fetches
- /posts/prompt-engineering-for-agents-tool-descriptions.html  — 41 crawler fetches
