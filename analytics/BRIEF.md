# Analytics brief — auto-exported 2026-08-02T15:17Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2079 views → 190 engaged reads → 89 completes · 2063 sessions.
- Channels: direct 163r/2023v · ai 10r/18v · organic 8r/24v · referral 7r/12v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
Hot terms: build(45), agents(41), startup(36), agentic(35), founder(34), agent(33), mcp(29), engineering(13), systems(12), env(10), code(9), course(9), memory(9), tools(9), coding(9).
...
The real answer engines are crawling us — IP-verified: 6067 confirmed AI-engine fetches (Perplexity 2608, GPTBot (OpenAI) 2590, ChatGPT (user browsing) 377, ChatGPT Search (OpenAI) 492).
...
- /posts/lm-studio-bionic-local-agent-open-models.html  — 27 crawler fetches
...
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 17 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 16 crawler fetches
