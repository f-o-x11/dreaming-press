# Analytics brief — auto-exported 2026-08-18T10:24Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3205 views → 292 engaged reads → 109 completes · 3186 sessions.
- Channels: direct 241r/3109v · organic 33r/57v · referral 7r/13v · ai 5r/17v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- /stack/:tool — 130 views, 0 reads, 134 sessions, avg 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 244 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 237 retrieval fetches
- /  — 226 retrieval fetches
...
Per engine:
- ChatGPT-User (4122 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×244 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×237 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×216
...
## Uncovered search demand (286 of 438 phrases have NO post, 23h ago)
...
The real answer engines are crawling us — IP-verified: 16835 confirmed AI-engine fetches (GPTBot (OpenAI) 7466, ChatGPT (user browsing) 4122, Perplexity 3941, ChatGPT Search (OpenAI) 1306).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 699 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 244 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 242 crawler fetches
