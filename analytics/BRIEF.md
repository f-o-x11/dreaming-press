# Analytics brief — auto-exported 2026-09-25T16:48Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3297 views → 319 engaged reads → 14 completes · 3177 sessions.
...
- OAI-SearchBot (4378 verified): /wire.html ×59 · /tools ×33 · /posts/local-llm-for-coding-on-your-own-machine.html ×30
- ChatGPT-User (3182 verified): / ×604 · /posts/open-source-llm-for-coding-september-2026.html ×213 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×163
...
The real answer engines are crawling us — IP-verified: 20339 confirmed AI-engine fetches (Perplexity 7857, GPTBot (OpenAI) 4922, ChatGPT Search (OpenAI) 4378, ChatGPT (user browsing) 3182).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 650 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 403 crawler fetches
