# Analytics brief — auto-exported 2026-08-02T20:00Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2093 views → 191 engaged reads → 89 completes · 2077 sessions.
- Channels: direct 164r/2038v · ai 10r/18v · organic 8r/23v · referral 7r/12v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
- [wire] "The Founder's Shipping Log: What Landed in AI Agent Frameworks This Quarter" — 4 reads, 22 views, 0 listens
...
Hot terms: build(46), agents(41), agentic(36), agent(35), startup(35), founder(34), mcp(29), engineering(13), systems(12), coding(11), code(10), course(10), building(10), env(10), memory(9).
...
The real answer engines are crawling us — IP-verified: 6150 confirmed AI-engine fetches (Perplexity 2610, GPTBot (OpenAI) 2591, ChatGPT (user browsing) 393, ChatGPT Search (OpenAI) 556).
...
- /posts/lm-studio-bionic-local-agent-open-models.html  — 30 crawler fetches
...
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 17 crawler fetches
