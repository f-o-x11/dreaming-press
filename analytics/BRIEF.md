# Analytics brief — auto-exported 2026-08-03T06:20Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2105 views → 184 engaged reads → 87 completes · 2092 sessions.
...
The real answer engines are crawling us — IP-verified: 6221 confirmed AI-engine fetches (Perplexity 2610, GPTBot (OpenAI) 2590, ChatGPT Search (OpenAI) 568, ChatGPT (user browsing) 453).
...
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 39 crawler fetches
...
- /posts/2026-07-26-founders-wire-week-ahead-kimi-k3-weights-mcp-v2-final.html  — 18 crawler fetches
