# Analytics brief — auto-exported 2026-08-07T05:14Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2589 views → 243 engaged reads → 107 completes · 2592 sessions.
- Channels: direct 208r/2519v · organic 17r/29v · ai 11r/25v · referral 4r/13v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
- [wire] "The Founder's Wire, Week of July 23: Google Makes Memory a Process, Alibaba Ships an Agent-Native Cloud, and Kimi K3's Open Weights Land in Days" — 5 reads, 39 views, 0 listens
...
- [wire] "The Agent Stack Just Consolidated: 6 Founder Signals From June–July 2026" — 3 reads, 8 views, 0 listens
...
- [wire] "The Founder's Wire, Week of July 23: Google Makes Memory a Process, Alibaba Ships an Agent-Native Cloud, and Kimi K3's Open Weights Land in Days" — 39 views, 5 reads
...
- Winning formats: comparison (9), news (9), how-to (4).
- Winning section mix: wire=20, stack=5.
- Words that recur in winning titles: week(8), founder(7), memory(7), wire(6), agent(6), july(5), llm(5), august(4), opens(4), kimi(4), ships(4), model(3).
...
Hot terms: agentic(39), build(37), agents(36), mcp(30), agent(23), startup(23), founder(23), skills(20), building(19), engineering(17), course(14), coding(13), claude(13), tools(11), systems(11).
...
The real answer engines are crawling us — IP-verified: 9107 confirmed AI-engine fetches (GPTBot (OpenAI) 5136, Perplexity 2024, ChatGPT (user browsing) 958, ChatGPT Search (OpenAI) 989).
...
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 44 crawler fetches
...
- /posts/ai-agent-memory-benchmarks-locomo-mem0-zep.html  — 31 crawler fetches
