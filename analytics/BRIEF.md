# Analytics brief — auto-exported 2026-09-21T21:26Z (last 14 days)
...
Per engine:
- PerplexityBot (8830 verified): /build ×94 · / ×29 · /authors ×24
- OAI-SearchBot (3692 verified): /wire.html ×47 · /tools ×35 · /posts/local-llm-for-coding-on-your-own-machine.html ×30
- ChatGPT-User (3238 verified): / ×608 · /posts/open-source-llm-for-coding-september-2026.html ×178 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×174
...
Hot terms: agents(40), founder(35), startup(33), agent(24), build(23), agentic(21), mcp(21), coding(13), building(13), launch(10), has(10), google(9), every(8), engineer(8), trading(8).
...
The real answer engines are crawling us — IP-verified: 20194 confirmed AI-engine fetches (Perplexity 8830, GPTBot (OpenAI) 4434, ChatGPT Search (OpenAI) 3692, ChatGPT (user browsing) 3238).
