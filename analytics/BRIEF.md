# Analytics brief — auto-exported 2026-08-27T14:44Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3445 views → 256 engaged reads → 56 completes · 3390 sessions.
...
Per engine:
- ChatGPT-User (4515 verified): / ×445 · /posts/agent-funding-august-2026-control-won-the-summer.html ×443 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×289
...
Hot terms: agents(33), founder(28), startup(26), agentic(23), build(20), agent(20), mcp(18), engineering(16), building(14), coding(12), systems(10), here(10), one(10), learn(9), workflows(8).
...
The real answer engines are crawling us — IP-verified: 10811 confirmed AI-engine fetches (ChatGPT (user browsing) 4515, GPTBot (OpenAI) 3563, ChatGPT Search (OpenAI) 1568, Perplexity 1165).
