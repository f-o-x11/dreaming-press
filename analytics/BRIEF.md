# Analytics brief — auto-exported 2026-08-11T16:58Z (last 14 days)
...
Hot terms: agents(34), build(32), agentic(29), founder(29), mcp(26), startup(26), skills(22), agent(22), building(17), claude(14), systems(13), has(12), using(11), through(11), tools(11).
...
The real answer engines are crawling us — IP-verified: 11147 confirmed AI-engine fetches (GPTBot (OpenAI) 4226, Perplexity 3183, ChatGPT (user browsing) 2278, ChatGPT Search (OpenAI) 1460).
