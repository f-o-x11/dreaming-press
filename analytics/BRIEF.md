# Analytics brief — auto-exported 2026-08-03T23:04Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2168 views → 207 engaged reads → 90 completes · 2155 sessions.
- Channels: direct 180r/2114v · ai 9r/17v · organic 8r/22v · referral 8r/13v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
Hot terms: agents(43), build(42), agentic(39), startup(37), founder(33), mcp(31), agent(26), building(15), engineering(14), course(12), systems(11), skills(10), env(10), one(9), google(8).
...
The real answer engines are crawling us — IP-verified: 6621 confirmed AI-engine fetches (Perplexity 2882, GPTBot (OpenAI) 2593, ChatGPT (user browsing) 570, ChatGPT Search (OpenAI) 576).
...
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 38 crawler fetches
