# Analytics brief — auto-exported 2026-08-07T02:12Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2755 views → 239 engaged reads → 111 completes · 2758 sessions.
- Channels: direct 206r/2687v · organic 14r/26v · ai 11r/25v · referral 5r/14v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
- [wire] "vLLM 0.26 and SGLang 0.5.16 Shipped the Same Day. This Time They Fought Over Memory." — 26 views, 4 reads
...
- Words that recur in winning titles: week(8), founder(7), wire(6), july(6), memory(6), agent(5), llm(5), august(4), opens(4), ships(4), kimi(4), agents(3).
...
Hot terms: agentic(39), build(38), agents(36), mcp(31), agent(23), startup(23), founder(23), skills(20), building(20), engineering(17), course(14), coding(13), claude(13), systems(12), tools(10).
...
The real answer engines are crawling us — IP-verified: 9022 confirmed AI-engine fetches (GPTBot (OpenAI) 5135, Perplexity 1983, ChatGPT (user browsing) 936, ChatGPT Search (OpenAI) 968).
...
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 43 crawler fetches
- /posts/emergent-vibe-coding-unicorn-130m-series-c.html  — 38 crawler fetches
- /posts/cloudflare-agents-week-2026-ai-gateway-email-sandboxes-founder.html  — 35 crawler fetches
