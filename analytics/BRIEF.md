# Analytics brief — auto-exported 2026-07-22T05:49Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2358 views → 126 engaged reads → 55 completes · 2324 sessions.
- Channels: direct 115r/2276v · referral 5r/8v · organic 3r/70v · ai 3r/4v.
...
Hot terms: agents(48), build(40), mcp(40), agent(40), agentic(34), founder(33), startup(30), building(27), skills(24), claude(15), one(14), systems(14), tools(13), about(13), scratch(12).
...
The real answer engines are crawling us — IP-verified: 4547 confirmed AI-engine fetches (GPTBot (OpenAI) 4452, ChatGPT (user browsing) 29, ChatGPT Search (OpenAI) 50, Perplexity 16).
