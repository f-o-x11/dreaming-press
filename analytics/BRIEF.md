# Analytics brief — auto-exported 2026-08-14T08:46Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2930 views → 297 engaged reads → 118 completes · 2931 sessions.
- Channels: direct 246r/2832v · organic 27r/51v · ai 13r/29v · referral 5r/11v · campaign:chatgpt.com 5r/6v · campaign:copilot.com 1r/1v.
...
Hot terms: founder(33), agentic(30), build(30), startup(29), agents(28), agent(23), mcp(23), coding(15), through(14), building(14), skills(13), using(13), systems(13), has(13), model(11).
...
## Uncovered search demand (296 of 440 phrases have NO post, 45h ago)
...
The real answer engines are crawling us — IP-verified: 12666 confirmed AI-engine fetches (GPTBot (OpenAI) 4470, ChatGPT (user browsing) 3095, Perplexity 3678, ChatGPT Search (OpenAI) 1423).
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 129 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 117 crawler fetches
- /posts/2026-07-22-founders-wire-portable-context-agents-in-chat-open-coders.html  — 113 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 113 crawler fetches
...
- /posts/2026-08-10-founders-wire-claude-code-codex-permission-fixes-qwen-open-weights.html  — 22 crawler fetches
