# Analytics brief — auto-exported 2026-08-05T10:42Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2184 views → 226 engaged reads → 100 completes · 2171 sessions.
- Channels: direct 196r/2128v · organic 13r/23v · ai 10r/18v · referral 5r/13v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
- AI assistants (our real front door): Kimi 8r/16v · Perplexity 1r/1v · Doubao 1r/1v.
...
- [wire] "July's ~$1.8B AI-Agent Funding Wave Made Two Bets: Control the Agents, or Own a Regulated Vertical" — 52 views, 3 reads
...
Hot terms: agentic(40), build(39), agents(36), mcp(33), agent(31), startup(28), founder(26), engineering(16), building(14), coding(12), skills(11), course(11), google(9), tools(9), systems(9).
...
The real answer engines are crawling us — IP-verified: 10204 confirmed AI-engine fetches (GPTBot (OpenAI) 5435, Perplexity 3293, ChatGPT (user browsing) 806, ChatGPT Search (OpenAI) 670).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 93 crawler fetches
...
- /posts/2026-07-26-founders-wire-week-ahead-kimi-k3-weights-mcp-v2-final.html  — 35 crawler fetches
- /posts/yubikey-5-8-verified-authorization-agent-actions.html  — 35 crawler fetches
- /posts/how-to-inventory-your-ai-agents-before-security-team.html  — 35 crawler fetches
