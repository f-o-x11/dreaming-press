# Analytics brief — auto-exported 2026-09-24T01:51Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3323 views → 344 engaged reads → 20 completes · 3194 sessions.
- Channels: direct 163r/2910v · organic 110r/150v · campaign:chatgpt.com 39r/154v · ai 16r/41v · referral 11r/59v · campaign:qwant 4r/5v · social 1r/3v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
...
- OAI-SearchBot (3835 verified): /wire.html ×53 · /tools ×35 · /posts/kimi-k3-vs-opus-vs-gpt-56-coding-agent-cost.html ×30
...
Hot terms: agents(43), founder(35), startup(33), agent(28), build(26), agentic(22), building(21), coding(18), mcp(18), google(9), claude(8), like(8), launch(8), first(8), own(7).
...
The real answer engines are crawling us — IP-verified: 19637 confirmed AI-engine fetches (Perplexity 7857, GPTBot (OpenAI) 4917, ChatGPT Search (OpenAI) 3835, ChatGPT (user browsing) 3028).
