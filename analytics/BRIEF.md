# Analytics brief — auto-exported 2026-07-31T14:56Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 1963 views → 178 engaged reads → 79 completes · 1945 sessions.
- Channels: direct 157r/1910v · organic 8r/34v · referral 7r/12v · ai 4r/5v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
Hot terms: agents(53), build(48), mcp(42), agentic(40), founder(35), agent(33), startup(33), engineering(21), building(16), google(13), toronto(12), course(11), loops(11), 1-hour(10), systems(10).
Hashtags: #ai, #startup, #founder, #agenticai, #llm, #opensource, #bhusa, #aibuilders, #okxai, #machinelearning.
...
The real answer engines are crawling us — IP-verified: 6526 confirmed AI-engine fetches (GPTBot (OpenAI) 3376, Perplexity 2417, ChatGPT (user browsing) 264, ChatGPT Search (OpenAI) 469).
...
- /posts/lm-studio-bionic-local-agent-open-models.html  — 14 crawler fetches
