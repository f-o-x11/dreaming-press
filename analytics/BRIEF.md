# Analytics brief — auto-exported 2026-09-20T21:00Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3367 views → 334 engaged reads → 40 completes · 3255 sessions.
- Channels: direct 181r/2982v · organic 75r/118v · campaign:chatgpt.com 45r/150v · referral 18r/75v · ai 13r/36v · social 1r/4v · campaign:perplexity 1r/1v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
- AI assistants (our real front door): ChatGPT 45r/160v · Doubao 9r/13v · DeepSeek 1r/4v · Perplexity 1r/3v · Yuanbao 1r/1v · Kimi 0r/4v.
...
- dg-title: 4 clicks from 2 sessions
...
- direct: 2982 views · read 6.1% · complete 0.5% · 1 pages/session · median 4s
- campaign:chatgpt.com: 150 views · read 30.0% · complete 2.7% · 1.01 pages/session · median ?s
- organic: 118 views · read 63.6% · complete 2.5% · 1.06 pages/session · median 10s
...
- [stack] "n8n vs Flowise vs Langflow: Choosing a Visual Agent Builder in 2026" — 1 listens, 3 reads

## Hubs and tools (non-article routes)
The interactive surfaces. /build is the most-crawled path on the whole domain,
so what these earn from humans is the other half of the picture.
- /stack/:tool — 393 views, 0 reads, 391 sessions, avg 4s
- / — 184 views, 1 reads, 183 sessions, avg 12s
...
- /build  — 174 retrieval fetches
- /posts/gpu-rental-price-september-2026-b200-floor-under-4.html  — 174 retrieval fetches
- /posts/open-source-llm-for-coding-september-2026.html  — 159 retrieval fetches
...
Per engine:
- PerplexityBot (12445 verified): /build ×174 · / ×27 · /dashboard ×25
- OAI-SearchBot (3626 verified): /wire.html ×48 · /tools ×34 · /posts/local-llm-for-coding-on-your-own-machine.html ×30
- ChatGPT-User (3142 verified): / ×605 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×174 · /posts/open-source-llm-for-coding-september-2026.html ×159
...
Hot terms: agents(38), startup(32), founder(31), agent(28), agentic(22), build(22), mcp(22), coding(13), building(12), has(12), google(11), co-founder(10), its(9), engineer(9), run(8).
...
## Uncovered search demand (253 of 450 phrases have NO post, 81h ago)
...
The real answer engines are crawling us — IP-verified: 23649 confirmed AI-engine fetches (Perplexity 12445, GPTBot (OpenAI) 4436, ChatGPT Search (OpenAI) 3626, ChatGPT (user browsing) 3142).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 783 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 183 crawler fetches
- /posts/2026-06-21-routellm-vs-notdiamond-vs-martian.html  — 180 crawler fetches
...
- /posts/how-to-read-an-agent-memory-benchmark.html  — 124 crawler fetches
...
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 67 crawler fetches
- /tools  — 38 crawler fetches
