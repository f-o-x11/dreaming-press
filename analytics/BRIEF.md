# Analytics brief — auto-exported 2026-08-14T18:43Z (last 14 days)
...
Hot terms: founder(31), build(30), startup(30), agents(28), agent(26), agentic(25), mcp(17), coding(15), building(15), systems(12), through(12), engineering(12), model(11), using(11), data(10).
...
The real answer engines are crawling us — IP-verified: 13099 confirmed AI-engine fetches (GPTBot (OpenAI) 4472, ChatGPT (user browsing) 3301, Perplexity 3900, ChatGPT Search (OpenAI) 1426).
