# Analytics brief — auto-exported 2026-09-24T16:04Z (last 14 days)
...
- [stack] "Open-Source LLMs for Coding, Ranked (September 2026): Which Open-Weight Model to Run and What It Takes" — 12 reads, 40 views, 1 listens
...
- [stack] "Open-Source LLMs for Coding, Ranked (September 2026): Which Open-Weight Model to Run and What It Takes" — 40 views, 12 reads
...
- OAI-SearchBot (4114 verified): /wire.html ×56 · /tools ×35 · /posts/kimi-k3-vs-opus-vs-gpt-56-coding-agent-cost.html ×30
- ChatGPT-User (3166 verified): / ×603 · /posts/open-source-llm-for-coding-september-2026.html ×213 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×160
...
Hot terms: agents(41), founder(37), agent(32), agentic(27), startup(26), build(25), coding(21), building(20), mcp(18), jev(10), security(9), claude(9), today(9), one(8), day(8).
...
The real answer engines are crawling us — IP-verified: 20122 confirmed AI-engine fetches (Perplexity 7924, GPTBot (OpenAI) 4918, ChatGPT Search (OpenAI) 4114, ChatGPT (user browsing) 3166).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 681 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 323 crawler fetches
