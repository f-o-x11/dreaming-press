# Analytics brief — auto-exported 2026-08-16T21:36Z (last 14 days)
...
Hot terms: agents(36), agentic(32), founder(30), agent(28), startup(27), build(25), mcp(20), coding(19), engineering(17), building(15), code(11), systems(11), skills(10), using(10), has(9).
...
The real answer engines are crawling us — IP-verified: 16241 confirmed AI-engine fetches (GPTBot (OpenAI) 7423, ChatGPT (user browsing) 3454, Perplexity 3966, ChatGPT Search (OpenAI) 1398).
