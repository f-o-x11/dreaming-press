# Analytics brief — auto-exported 2026-08-04T15:59Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2189 views → 208 engaged reads → 90 completes · 2177 sessions.
- Channels: direct 181r/2133v · organic 10r/23v · ai 10r/19v · referral 5r/12v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
Hot terms: agentic(41), build(40), agents(40), agent(31), mcp(30), startup(26), founder(23), building(16), engineering(13), course(11), coding(11), one(10), google(9), skills(9), claude(8).
...
The real answer engines are crawling us — IP-verified: 7126 confirmed AI-engine fetches (Perplexity 3239, GPTBot (OpenAI) 2593, ChatGPT (user browsing) 680, ChatGPT Search (OpenAI) 614).
...
- /posts/2026-07-26-founders-wire-week-ahead-kimi-k3-weights-mcp-v2-final.html  — 25 crawler fetches
- /posts/yubikey-5-8-verified-authorization-agent-actions.html  — 25 crawler fetches
