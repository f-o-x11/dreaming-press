# Analytics brief — auto-exported 2026-09-19T19:09Z (last 14 days)
...
- OAI-SearchBot (3508 verified): /wire.html ×49 · /tools ×34 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×30
...
Hot terms: agents(37), founder(31), startup(28), agent(26), agentic(25), mcp(23), build(20), coding(14), building(12), has(11), google(10), run(9), like(9), co-founder(9), every(8).
...
The real answer engines are crawling us — IP-verified: 23108 confirmed AI-engine fetches (Perplexity 12212, GPTBot (OpenAI) 4275, ChatGPT Search (OpenAI) 3508, ChatGPT (user browsing) 3113).
