# Analytics brief — auto-exported 2026-08-19T05:27Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3268 views → 285 engaged reads → 105 completes · 3252 sessions.
- Channels: direct 232r/3165v · organic 34r/58v · referral 7r/15v · ai 6r/18v · campaign:chatgpt.com 5r/10v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- /stack/:tool — 159 views, 0 reads, 163 sessions, avg 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 277 retrieval fetches
...
Per engine:
- ChatGPT-User (4420 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×277 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×263 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×214
...
The real answer engines are crawling us — IP-verified: 16677 confirmed AI-engine fetches (GPTBot (OpenAI) 7464, ChatGPT (user browsing) 4420, Perplexity 3541, ChatGPT Search (OpenAI) 1252).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 697 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 277 crawler fetches
