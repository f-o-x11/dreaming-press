# Analytics brief — auto-exported 2026-09-25T20:10Z (last 14 days)
...
- OAI-SearchBot (4470 verified): /wire.html ×59 · /tools ×34 · /posts/local-llm-for-coding-on-your-own-machine.html ×30
- ChatGPT-User (3213 verified): / ×610 · /posts/open-source-llm-for-coding-september-2026.html ×213 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×164
...
Hot terms: agents(40), founder(37), agent(35), startup(28), build(25), agentic(24), coding(20), mcp(17), building(17), jev(11), claude(10), big(8), day(8), make(8), security(7).
...
The real answer engines are crawling us — IP-verified: 20489 confirmed AI-engine fetches (Perplexity 7881, GPTBot (OpenAI) 4925, ChatGPT Search (OpenAI) 4470, ChatGPT (user browsing) 3213).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 654 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 416 crawler fetches
