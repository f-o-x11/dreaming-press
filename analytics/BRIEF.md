# Analytics brief — auto-exported 2026-08-11T19:40Z (last 14 days)
...
Hot terms: agents(35), build(31), founder(29), agentic(27), startup(26), mcp(24), skills(22), agent(21), building(17), claude(14), systems(13), has(13), using(11), coding(10), through(10).
...
## Uncovered search demand (305 of 438 phrases have NO post, 58h ago)
...
The real answer engines are crawling us — IP-verified: 11234 confirmed AI-engine fetches (GPTBot (OpenAI) 4227, Perplexity 3202, ChatGPT (user browsing) 2322, ChatGPT Search (OpenAI) 1483).
