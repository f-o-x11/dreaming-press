# Analytics brief — auto-exported 2026-09-23T02:30Z (last 14 days)
...
- OAI-SearchBot (3681 verified): /wire.html ×50 · /tools ×33 · /posts/local-llm-for-coding-on-your-own-machine.html ×29
...
The real answer engines are crawling us — IP-verified: 19540 confirmed AI-engine fetches (Perplexity 8371, GPTBot (OpenAI) 4447, ChatGPT Search (OpenAI) 3681, ChatGPT (user browsing) 3041).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 671 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 240 crawler fetches
