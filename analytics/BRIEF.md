# Analytics brief — auto-exported 2026-08-28T08:46Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3518 views → 260 engaged reads → 57 completes · 3462 sessions.
- Channels: direct 179r/3340v · organic 43r/74v · referral 14r/49v · ai 12r/21v · campaign:chatgpt.com 10r/30v · campaign:perplexity 1r/2v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 3340 views · read 5.4% · complete 1.6% · 1 pages/session · median 4s
- organic: 74 views · read 58.1% · complete 2.7% · 1.03 pages/session · median ?s
- referral: 49 views · read 28.6% · complete 2.0% · 1.07 pages/session · median ?s
...
- /stack/:tool — 439 views, 0 reads, 442 sessions, avg 4s
- / — 85 views, 7 reads, 83 sessions, avg 50s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 419 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 262 retrieval fetches
...
- /tags/opinionated  — 11 retrieval fetches
- /apps  — 9 retrieval fetches
- /series  — 9 retrieval fetches
- /posts/groq-vs-cerebras-vs-sambanova-fast-inference.html  — 7 retrieval fetches

Per engine:
- ChatGPT-User (4222 verified): / ×443 · /posts/agent-funding-august-2026-control-won-the-summer.html ×419 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×262
- OAI-SearchBot (1564 verified): /build ×26 · / ×7 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×7
...
Hot terms: agents(33), build(30), startup(28), founder(25), agentic(23), mcp(18), agent(17), engineering(15), building(14), systems(11), here(11), coding(10), one(10), production(8), learn(8).
...
## Uncovered search demand (288 of 458 phrases have NO post, 45h ago)
...
The real answer engines are crawling us — IP-verified: 10434 confirmed AI-engine fetches (ChatGPT (user browsing) 4222, GPTBot (OpenAI) 3565, ChatGPT Search (OpenAI) 1564, Perplexity 1083).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 690 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 419 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 310 crawler fetches
- /posts/ai-coding-agent-ranking-2026.html  — 188 crawler fetches
- /posts/how-to-harden-your-repo-against-ai-agent-poisoned-prs.html  — 156 crawler fetches
