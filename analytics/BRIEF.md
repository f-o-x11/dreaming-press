# Analytics brief — auto-exported 2026-07-27T02:43Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3055 views → 174 engaged reads → 81 completes · 3024 sessions.
- Channels: direct 159r/2962v · referral 7r/13v · organic 3r/73v · ai 3r/5v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
- [wire] "The Founder's Wire, Week of July 23: Google Makes Memory a Process, Alibaba Ships an Agent-Native Cloud, and Kimi K3's Open Weights Land in Days" — 7 reads, 43 views, 0 listens
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 5 reads, 95 views, 0 listens
...
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 95 views, 5 reads
- [wire] "The Founder's Wire, Week of July 23: Google Makes Memory a Process, Alibaba Ships an Agent-Native Cloud, and Kimi K3's Open Weights Land in Days" — 43 views, 7 reads
...
- Words that recur in winning titles: week(12), july(11), founder(10), mcp(8), agent(8), wire(7), ships(7), stateless(5), agents(5), microsoft(4), shipping(4), kimi(4).
...
Hot terms: agents(55), build(44), mcp(37), agentic(32), founder(30), building(29), agent(29), startup(23), engineering(21), tools(13), google(12), context(11), systems(11), about(11), co-founder(11).
...
The real answer engines are crawling us — IP-verified: 5986 confirmed AI-engine fetches (GPTBot (OpenAI) 3632, Perplexity 2154, ChatGPT (user browsing) 72, ChatGPT Search (OpenAI) 128).
