# Analytics brief — auto-exported 2026-08-08T23:42Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2906 views → 277 engaged reads → 111 completes · 2911 sessions.
...
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 8 reads, 36 views, 0 listens
...
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 36 views, 8 reads
...
The real answer engines are crawling us — IP-verified: 9337 confirmed AI-engine fetches (GPTBot (OpenAI) 4626, Perplexity 2288, ChatGPT (user browsing) 1262, ChatGPT Search (OpenAI) 1161).
