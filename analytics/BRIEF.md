# Analytics brief — auto-exported 2026-08-17T18:01Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3133 views → 292 engaged reads → 110 completes · 3114 sessions.
- Channels: direct 243r/3039v · organic 31r/55v · ai 7r/18v · referral 5r/12v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3039 views · read 8.0% · complete 3.6% · 1 pages/session · median 6s
...
- /stack/:tool — 78 views, 0 reads, 80 sessions, avg 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 214 retrieval fetches
- /  — 211 retrieval fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 164 retrieval fetches
...
Per engine:
- ChatGPT-User (3870 verified): /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×225 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×218 · /posts/agent-funding-august-2026-control-won-the-summer.html ×214
...
Hot terms: agents(33), agentic(31), agent(28), founder(28), startup(26), build(25), mcp(20), coding(18), building(13), systems(12), engineering(12), skills(10), code(10), data(10), claude(9).
...
The real answer engines are crawling us — IP-verified: 16856 confirmed AI-engine fetches (GPTBot (OpenAI) 7469, ChatGPT (user browsing) 3870, Perplexity 4199, ChatGPT Search (OpenAI) 1318).
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 214 crawler fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 169 crawler fetches
