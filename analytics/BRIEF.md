# Analytics brief — auto-exported 2026-08-06T19:37Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2747 views → 239 engaged reads → 111 completes · 2749 sessions.
- Channels: direct 206r/2679v · organic 14r/26v · ai 11r/25v · referral 6r/15v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
- [wire] "China Regulated the AI Persona, Not the Model — So Doubao and Qwen Are Killing Their Agents on July 15" — 28 views, 0 reads
...
- Words that recur in winning titles: week(8), founder(7), wire(6), july(6), memory(6), agent(5), llm(5), ships(4), kimi(4), august(4), opens(4), agents(3).
...
Hot terms: agents(38), build(38), agentic(36), mcp(32), startup(23), founder(23), agent(22), skills(19), building(19), engineering(17), coding(13), systems(12), course(11), tools(11), claude(11).
...
The real answer engines are crawling us — IP-verified: 10737 confirmed AI-engine fetches (GPTBot (OpenAI) 5439, Perplexity 3456, ChatGPT (user browsing) 899, ChatGPT Search (OpenAI) 943).
...
- /posts/lm-studio-bionic-local-agent-open-models.html  — 90 crawler fetches
...
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 39 crawler fetches
- /posts/cloudflare-agents-week-2026-ai-gateway-email-sandboxes-founder.html  — 32 crawler fetches
