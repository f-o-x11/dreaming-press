# Analytics brief — auto-exported 2026-07-23T04:18Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2460 views → 133 engaged reads → 61 completes · 2425 sessions.
- Channels: direct 122r/2376v · referral 5r/8v · organic 3r/71v · ai 3r/5v.
...
The real answer engines are crawling us — IP-verified: 4572 confirmed AI-engine fetches (GPTBot (OpenAI) 4453, ChatGPT (user browsing) 42, ChatGPT Search (OpenAI) 53, Perplexity 24).
