# Analytics brief — auto-exported 2026-08-17T19:13Z (last 14 days)
...
Per engine:
- ChatGPT-User (3898 verified): /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×227 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×219 · /posts/agent-funding-august-2026-control-won-the-summer.html ×217
...
Hot terms: agents(32), agentic(31), agent(28), founder(27), startup(27), build(25), mcp(20), coding(17), engineering(16), systems(12), building(12), skills(10), code(10), data(10), claude(9).
...
The real answer engines are crawling us — IP-verified: 16884 confirmed AI-engine fetches (GPTBot (OpenAI) 7469, ChatGPT (user browsing) 3898, Perplexity 4199, ChatGPT Search (OpenAI) 1318).
