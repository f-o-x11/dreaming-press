# Analytics brief — auto-exported 2026-08-03T12:55Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2137 views → 186 engaged reads → 88 completes · 2124 sessions.
- Channels: direct 160r/2083v · ai 9r/17v · organic 8r/23v · referral 7r/12v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
Hot terms: build(45), agents(43), agentic(39), startup(38), founder(36), mcp(30), agent(29), engineering(14), building(13), course(12), systems(11), skills(10), env(10), google(9), 1-hour(8).
...
The real answer engines are crawling us — IP-verified: 6347 confirmed AI-engine fetches (Perplexity 2684, GPTBot (OpenAI) 2590, ChatGPT (user browsing) 502, ChatGPT Search (OpenAI) 571).
...
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 54 crawler fetches
- /posts/tool-highlight-honeycomb-agent-observability-otel-native.html  — 47 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 42 crawler fetches
