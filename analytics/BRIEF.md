# Analytics brief — auto-exported 2026-08-20T08:06Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3027 views → 281 engaged reads → 95 completes · 2997 sessions.
- Channels: direct 222r/2923v · organic 38r/64v · referral 8r/16v · ai 6r/12v · campaign:chatgpt.com 6r/10v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 296 retrieval fetches
- /  — 279 retrieval fetches
...
Per engine:
- ChatGPT-User (4761 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×324 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×296 · / ×234
...
Hot terms: agents(44), founder(33), agentic(32), startup(28), agent(24), build(24), building(16), code(13), mcp(13), claude(11), coding(11), every(11), about(10), skills(10), one(9).
...
The real answer engines are crawling us — IP-verified: 13644 confirmed AI-engine fetches (ChatGPT (user browsing) 4761, GPTBot (OpenAI) 4267, Perplexity 3480, ChatGPT Search (OpenAI) 1136).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 629 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 324 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 301 crawler fetches
