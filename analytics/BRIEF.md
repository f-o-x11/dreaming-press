# Analytics brief — auto-exported 2026-08-18T16:07Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3229 views → 294 engaged reads → 111 completes · 3212 sessions.
- Channels: direct 242r/3132v · organic 33r/57v · referral 7r/13v · ai 6r/18v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3132 views · read 7.7% · complete 3.5% · 0.99 pages/session · median 6s
...
- /stack/:tool — 139 views, 0 reads, 143 sessions, avg 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 254 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 244 retrieval fetches
- /  — 235 retrieval fetches
...
Per engine:
- ChatGPT-User (4261 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×254 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×244 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×222
- PerplexityBot (3945 verified): /build ×34 · / ×29 · /apps ×16
- OAI-SearchBot (1308 verified): / ×15 · /build ×15 · /posts/groq-vs-cerebras-vs-sambanova-fast-inference.html ×5
...
Hot terms: agents(35), agentic(34), founder(31), startup(31), build(25), agent(21), mcp(18), building(16), coding(14), one(12), claude(11), code(11), skills(10), systems(10), engineering(10).
...
## Uncovered search demand (286 of 438 phrases have NO post, 28h ago)
...
The real answer engines are crawling us — IP-verified: 16981 confirmed AI-engine fetches (GPTBot (OpenAI) 7467, ChatGPT (user browsing) 4261, Perplexity 3945, ChatGPT Search (OpenAI) 1308).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 708 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 254 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 249 crawler fetches
