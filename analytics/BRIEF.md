# Analytics brief — auto-exported 2026-07-24T20:13Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2829 views → 156 engaged reads → 70 completes · 2796 sessions.
- Channels: direct 143r/2739v · referral 7r/12v · organic 3r/73v · ai 3r/5v.
...
The real answer engines are crawling us — IP-verified: 6668 confirmed AI-engine fetches (GPTBot (OpenAI) 4880, Perplexity 1671, ChatGPT (user browsing) 56, ChatGPT Search (OpenAI) 61).
...
- /posts/tool-highlight-honeycomb-agent-observability-otel-native.html  — 16 crawler fetches
