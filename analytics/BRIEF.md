# Analytics brief — auto-exported 2026-07-19T16:52Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2083 views → 104 engaged reads → 47 completes · 2051 sessions.
- Channels: direct 98r/2018v · organic 3r/58v · referral 2r/5v · ai 1r/2v.
...
- [wire] "The Founder's Shipping Log: What Landed in AI Agent Frameworks This Quarter" — 5 reads, 84 views, 0 listens
...
- [wire] "The Founder's Shipping Log: What Landed in AI Agent Frameworks This Quarter" — 84 views, 5 reads
...
- [wire] "MCP Just Deleted the Handshake: What the 2026-07-28 Stateless Core Breaks and Why It's Worth It" — 15 views, 0 reads
...
The real answer engines are crawling us — IP-verified: 4731 confirmed AI-engine fetches (GPTBot (OpenAI) 4670, ChatGPT (user browsing) 14, ChatGPT Search (OpenAI) 36, Perplexity 11).
...
- /posts/gpt-5-6-sol-vs-terra-vs-luna.html  — 8 crawler fetches
- /posts/2026-07-07-agent-tool-approval-becomes-a-framework-default.html  — 7 crawler fetches
...
- /posts/tensorrt-llm-removing-tensorrt-backend.html  — 4 crawler fetches
