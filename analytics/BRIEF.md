# Analytics brief — auto-exported 2026-08-16T22:46Z (last 14 days)
...
Hot terms: agents(33), agentic(32), founder(30), agent(28), startup(27), build(24), mcp(20), coding(19), building(15), systems(14), engineering(13), code(11), skills(10), using(10), has(9).
...
The real answer engines are crawling us — IP-verified: 16257 confirmed AI-engine fetches (GPTBot (OpenAI) 7423, ChatGPT (user browsing) 3470, Perplexity 3966, ChatGPT Search (OpenAI) 1398).
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 181 crawler fetches
