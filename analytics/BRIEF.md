# Analytics brief — auto-exported 2026-08-16T16:42Z (last 14 days)
...
Hot terms: agents(34), founder(31), agent(29), agentic(28), build(27), startup(27), mcp(19), coding(16), building(14), engineering(13), data(11), systems(11), model(10), skills(10), code(10).
...
The real answer engines are crawling us — IP-verified: 16174 confirmed AI-engine fetches (GPTBot (OpenAI) 7422, ChatGPT (user browsing) 3389, Perplexity 3966, ChatGPT Search (OpenAI) 1397).
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 192 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 172 crawler fetches
