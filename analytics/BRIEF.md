# Analytics brief — auto-exported 2026-09-26T19:41Z (last 14 days)
...
Per engine:
- PerplexityBot (7466 verified): /build ×81 · / ×27 · /posts/2026-09-08-founders-wire-nvidia-hugging-face-openai-managed-agents-anthropic-payments.html ×19
...
The real answer engines are crawling us — IP-verified: 19411 confirmed AI-engine fetches (Perplexity 7466, ChatGPT Search (OpenAI) 4712, GPTBot (OpenAI) 4081, ChatGPT (user browsing) 3152).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 613 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 473 crawler fetches
