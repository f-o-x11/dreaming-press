# Analytics brief — auto-exported 2026-09-06T20:04Z (last 14 days)
...
- OAI-SearchBot (3414 verified): /build ×33 · / ×19 · /posts/2026-08-04-founders-wire-anthropic-price-ladder-perception-preview-agent-funding.html ×17
...
Hot terms: agents(35), startup(30), founder(26), agent(24), building(24), agentic(22), coding(18), mcp(17), build(16), code(13), model(12), launch(11), claude(9), co-founder(9), first(8).
...
The real answer engines are crawling us — IP-verified: 16029 confirmed AI-engine fetches (Perplexity 7478, ChatGPT Search (OpenAI) 3414, ChatGPT (user browsing) 2875, GPTBot (OpenAI) 2262).
