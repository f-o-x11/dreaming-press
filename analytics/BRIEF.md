# Analytics brief — auto-exported 2026-08-17T20:22Z (last 14 days)
...
Per engine:
- ChatGPT-User (3921 verified): /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×227 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×220 · /posts/agent-funding-august-2026-control-won-the-summer.html ×218
...
Hot terms: agents(32), agentic(31), agent(28), founder(28), startup(28), build(25), mcp(20), coding(17), building(13), systems(12), engineering(12), code(11), skills(10), data(10), one(9).
...
The real answer engines are crawling us — IP-verified: 16907 confirmed AI-engine fetches (GPTBot (OpenAI) 7469, ChatGPT (user browsing) 3921, Perplexity 4199, ChatGPT Search (OpenAI) 1318).
