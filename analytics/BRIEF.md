# Analytics brief — auto-exported 2026-08-26T10:10Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3137 views → 246 engaged reads → 56 completes · 3089 sessions.
- Channels: direct 166r/2977v · organic 44r/75v · referral 13r/36v · ai 11r/21v · campaign:chatgpt.com 10r/24v · campaign:perplexity 1r/2v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2977 views · read 5.6% · complete 1.7% · 1 pages/session · median 4s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 439 retrieval fetches
...
Per engine:
- ChatGPT-User (4638 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×439 · / ×410 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×313
...
The real answer engines are crawling us — IP-verified: 12292 confirmed AI-engine fetches (ChatGPT (user browsing) 4638, GPTBot (OpenAI) 4721, Perplexity 1644, ChatGPT Search (OpenAI) 1289).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 754 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 439 crawler fetches
