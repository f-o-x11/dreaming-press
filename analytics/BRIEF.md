# Analytics brief — auto-exported 2026-08-11T05:49Z (last 14 days)
...
The real answer engines are crawling us — IP-verified: 9804 confirmed AI-engine fetches (GPTBot (OpenAI) 4225, ChatGPT (user browsing) 2054, Perplexity 2137, ChatGPT Search (OpenAI) 1388).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 481 crawler fetches
