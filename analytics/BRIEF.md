# Analytics brief — auto-exported 2026-08-21T02:57Z (last 14 days)
...
Per engine:
- ChatGPT-User (4888 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×353 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×319 · / ×249
- PerplexityBot (3498 verified): / ×30 · /build ×30 · /apps ×17
- OAI-SearchBot (1046 verified): /build ×17 · / ×12 · /fetch ×5
...
The real answer engines are crawling us — IP-verified: 14152 confirmed AI-engine fetches (ChatGPT (user browsing) 4888, GPTBot (OpenAI) 4720, Perplexity 3498, ChatGPT Search (OpenAI) 1046).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 615 crawler fetches
