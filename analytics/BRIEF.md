# Analytics brief — auto-exported 2026-08-20T14:19Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2991 views → 285 engaged reads → 95 completes · 2960 sessions.
- Channels: direct 226r/2886v · organic 38r/64v · referral 7r/15v · campaign:chatgpt.com 7r/12v · ai 6r/12v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2886 views · read 7.8% · complete 3.2% · 1 pages/session · median 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 336 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 303 retrieval fetches
...
Per engine:
- ChatGPT-User (4850 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×336 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×303 · / ×244
...
Hot terms: agents(37), agentic(32), founder(32), agent(27), startup(27), build(20), mcp(16), coding(14), building(13), code(13), skills(12), every(12), claude(11), one(10), about(9).
...
The real answer engines are crawling us — IP-verified: 13733 confirmed AI-engine fetches (ChatGPT (user browsing) 4850, GPTBot (OpenAI) 4267, Perplexity 3480, ChatGPT Search (OpenAI) 1136).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 665 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 336 crawler fetches
