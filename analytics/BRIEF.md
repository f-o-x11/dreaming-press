# Analytics brief — auto-exported 2026-09-19T00:35Z (last 14 days)
...
Per engine:
- PerplexityBot (12055 verified): /build ×178 · / ×24 · /dashboard ×23
- OAI-SearchBot (3296 verified): /wire.html ×47 · /tools ×33 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×28
...
Hot terms: agents(33), founder(31), startup(28), mcp(25), agentic(23), build(20), agent(17), coding(14), building(10), google(9), launch(8), run(8), actually(8), every(8), like(8).
...
The real answer engines are crawling us — IP-verified: 22582 confirmed AI-engine fetches (Perplexity 12055, GPTBot (OpenAI) 4272, ChatGPT Search (OpenAI) 3296, ChatGPT (user browsing) 2959).
