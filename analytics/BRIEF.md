# Analytics brief — auto-exported 2026-08-29T22:57Z (last 14 days)
...
- /  — 526 retrieval fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 402 retrieval fetches
...
Per engine:
- ChatGPT-User (4072 verified): / ×487 · /posts/agent-funding-august-2026-control-won-the-summer.html ×402 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×245
- OAI-SearchBot (1864 verified): /build ×28 · / ×10 · /posts/groq-vs-cerebras-vs-sambanova-fast-inference.html ×9
...
Hot terms: agents(33), startup(31), build(30), founder(26), agentic(21), building(18), agent(18), mcp(15), engineering(14), one(14), coding(13), here(12), systems(10), production(9), has(9).
...
The real answer engines are crawling us — IP-verified: 12164 confirmed AI-engine fetches (GPTBot (OpenAI) 5364, ChatGPT (user browsing) 4072, ChatGPT Search (OpenAI) 1864, Perplexity 864).
