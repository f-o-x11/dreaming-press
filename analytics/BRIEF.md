# Analytics brief — auto-exported 2026-08-19T17:12Z (last 14 days)
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 277 retrieval fetches
...
Per engine:
- ChatGPT-User (4664 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×298 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×277 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×223
...
Hot terms: agents(44), agentic(33), founder(33), startup(30), build(25), agent(22), building(16), mcp(14), code(12), skills(11), claude(10), every(10), data(10), about(9), one(9).
...
The real answer engines are crawling us — IP-verified: 17064 confirmed AI-engine fetches (GPTBot (OpenAI) 7520, ChatGPT (user browsing) 4664, Perplexity 3620, ChatGPT Search (OpenAI) 1260).
