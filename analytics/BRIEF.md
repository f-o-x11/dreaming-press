# Analytics brief — auto-exported 2026-08-27T23:25Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3465 views → 254 engaged reads → 56 completes · 3409 sessions.
- Channels: direct 177r/3291v · organic 39r/71v · referral 14r/46v · ai 12r/23v · campaign:chatgpt.com 10r/30v · campaign:perplexity 1r/2v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 3291 views · read 5.4% · complete 1.6% · 1 pages/session · median 4s
...
- /stack/:tool — 433 views, 0 reads, 436 sessions, avg 4s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 448 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 292 retrieval fetches
...
Per engine:
- ChatGPT-User (4584 verified): / ×458 · /posts/agent-funding-august-2026-control-won-the-summer.html ×448 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×292
- OAI-SearchBot (1602 verified): /build ×26 · / ×10 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×7
...
## Uncovered search demand (288 of 458 phrases have NO post, 35h ago)
...
The real answer engines are crawling us — IP-verified: 10937 confirmed AI-engine fetches (ChatGPT (user browsing) 4584, GPTBot (OpenAI) 3565, ChatGPT Search (OpenAI) 1602, Perplexity 1186).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 724 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 448 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 340 crawler fetches
- /posts/ai-coding-agent-ranking-2026.html  — 182 crawler fetches
- /posts/how-to-harden-your-repo-against-ai-agent-poisoned-prs.html  — 147 crawler fetches
