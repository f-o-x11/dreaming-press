# Analytics brief — auto-exported 2026-07-21T21:42Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2266 views → 125 engaged reads → 54 completes · 2232 sessions.
- Channels: direct 113r/2186v · referral 5r/8v · ai 4r/5v · organic 3r/67v.
...
Hot terms: agents(46), build(42), mcp(39), agent(39), agentic(32), founder(32), startup(30), building(24), skills(24), one(16), claude(15), scratch(13), systems(13), about(13), course(12).
...
The real answer engines are crawling us — IP-verified: 4666 confirmed AI-engine fetches (GPTBot (OpenAI) 4576, ChatGPT (user browsing) 27, ChatGPT Search (OpenAI) 47, Perplexity 16).
