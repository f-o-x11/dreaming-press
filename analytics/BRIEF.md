# Analytics brief — auto-exported 2026-08-10T11:47Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3077 views → 294 engaged reads → 117 completes · 3082 sessions.
- Channels: direct 253r/2995v · organic 22r/42v · ai 12r/26v · referral 6r/13v · campaign:chatgpt.com 1r/1v.
...
The real answer engines are crawling us — IP-verified: 9358 confirmed AI-engine fetches (GPTBot (OpenAI) 4225, ChatGPT (user browsing) 1774, Perplexity 2051, ChatGPT Search (OpenAI) 1308).
