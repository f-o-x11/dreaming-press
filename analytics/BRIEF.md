# Analytics brief — auto-exported 2026-09-05T18:12Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3369 views → 261 engaged reads → 35 completes · 3284 sessions.
...
Per engine:
- OAI-SearchBot (3285 verified): /build ×33 · / ×18 · /posts/kimi-k3-vs-opus-vs-gpt-56-coding-agent-cost.html ×15
...
The real answer engines are crawling us — IP-verified: 11176 confirmed AI-engine fetches (ChatGPT Search (OpenAI) 3285, ChatGPT (user browsing) 2813, Perplexity 2819, GPTBot (OpenAI) 2259).
