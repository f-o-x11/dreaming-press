# Analytics brief — auto-exported 2026-09-22T16:42Z (last 14 days)
...
Per engine:
- PerplexityBot (8678 verified): /build ×87 · / ×28 · /newsroom ×23
- OAI-SearchBot (3709 verified): /wire.html ×49 · /tools ×33 · /posts/local-llm-for-coding-on-your-own-machine.html ×30
- ChatGPT-User (3183 verified): / ×604 · /posts/open-source-llm-for-coding-september-2026.html ×194 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×168
...
Hot terms: agents(39), founder(36), startup(35), agent(26), build(24), agentic(21), mcp(21), coding(19), building(13), its(10), google(9), has(9), launch(9), grok(9), every(8).
...
The real answer engines are crawling us — IP-verified: 20001 confirmed AI-engine fetches (Perplexity 8678, GPTBot (OpenAI) 4431, ChatGPT Search (OpenAI) 3709, ChatGPT (user browsing) 3183).
