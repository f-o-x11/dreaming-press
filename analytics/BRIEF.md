# Analytics brief — auto-exported 2026-08-25T12:00Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2989 views → 236 engaged reads → 57 completes · 2940 sessions.
- Channels: direct 164r/2842v · organic 41r/73v · referral 11r/32v · campaign:chatgpt.com 11r/21v · ai 9r/19v · campaign:perplexity 0r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2842 views · read 5.8% · complete 1.9% · 1 pages/session · median 4s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 429 retrieval fetches
...
Per engine:
- ChatGPT-User (4774 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×429 · / ×381 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×327
...
Hot terms: agents(37), founder(30), startup(26), agentic(25), build(22), agent(21), mcp(19), coding(15), code(11), building(11), about(11), engineering(10), tools(10), google(9), claude(8).
...
The real answer engines are crawling us — IP-verified: 13372 confirmed AI-engine fetches (ChatGPT (user browsing) 4774, GPTBot (OpenAI) 4721, Perplexity 2729, ChatGPT Search (OpenAI) 1148).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 769 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 429 crawler fetches
...
- /posts/2026-06-27-scale-to-zero-llm-inference-gpu-cold-starts.html  — 52 crawler fetches
