# Analytics brief — auto-exported 2026-08-16T22:36Z (last 14 days)
...
Hot terms: agents(35), agentic(33), founder(30), agent(28), startup(27), build(25), coding(19), mcp(19), building(16), systems(14), engineering(13), code(11), skills(10), using(10), has(9).
...
The real answer engines are crawling us — IP-verified: 16254 confirmed AI-engine fetches (GPTBot (OpenAI) 7423, ChatGPT (user browsing) 3467, Perplexity 3966, ChatGPT Search (OpenAI) 1398).
