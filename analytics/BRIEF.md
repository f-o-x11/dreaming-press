# Analytics brief — auto-exported 2026-08-10T11:16Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3079 views → 293 engaged reads → 116 completes · 3083 sessions.
- Channels: direct 252r/2997v · organic 22r/42v · ai 12r/26v · referral 6r/13v · campaign:chatgpt.com 1r/1v.
...
Hot terms: build(35), agents(34), agentic(32), startup(32), founder(29), mcp(25), agent(22), skills(19), has(17), building(16), claude(14), systems(11), coding(10), using(10), tools(10).
...
## Uncovered search demand (305 of 438 phrases have NO post, 26h ago)
...
The real answer engines are crawling us — IP-verified: 9316 confirmed AI-engine fetches (GPTBot (OpenAI) 4225, ChatGPT (user browsing) 1769, Perplexity 2027, ChatGPT Search (OpenAI) 1295).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 496 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 142 crawler fetches
...
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 67 crawler fetches
