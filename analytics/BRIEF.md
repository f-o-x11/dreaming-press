# Analytics brief — auto-exported 2026-07-21T16:28Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2255 views → 125 engaged reads → 54 completes · 2221 sessions.
- Channels: direct 113r/2175v · referral 5r/8v · ai 4r/5v · organic 3r/67v.
...
Hot terms: agents(48), agent(41), build(40), mcp(39), agentic(31), startup(31), founder(31), building(23), skills(23), one(17), claude(16), scratch(13), systems(13), about(13), course(12).
...
The real answer engines are crawling us — IP-verified: 4662 confirmed AI-engine fetches (GPTBot (OpenAI) 4574, ChatGPT (user browsing) 25, ChatGPT Search (OpenAI) 47, Perplexity 16).
