# Analytics brief — auto-exported 2026-08-15T15:46Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2979 views → 309 engaged reads → 109 completes · 2977 sessions.
- Channels: direct 257r/2886v · organic 28r/53v · ai 12r/22v · referral 6r/11v · campaign:chatgpt.com 5r/6v · campaign:copilot.com 1r/1v.
...
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 31 views, 11 reads
...
Hot terms: agents(31), startup(30), build(29), agent(29), founder(29), agentic(26), mcp(20), engineering(17), coding(15), data(13), building(13), systems(12), using(12), model(11), through(11).
...
## Uncovered search demand (290 of 439 phrases have NO post, 28h ago)
...
The real answer engines are crawling us — IP-verified: 15737 confirmed AI-engine fetches (GPTBot (OpenAI) 7293, ChatGPT (user browsing) 3208, Perplexity 3840, ChatGPT Search (OpenAI) 1396).
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 163 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 143 crawler fetches
- /posts/2026-07-22-founders-wire-portable-context-agents-in-chat-open-coders.html  — 139 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 139 crawler fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 137 crawler fetches
