# Analytics brief — auto-exported 2026-07-18T13:55Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2057 views → 102 engaged reads → 47 completes · 2026 sessions.
- Channels: direct 97r/1996v · organic 2r/54v · referral 2r/5v · ai 1r/2v.
...
Hot terms: agent(51), mcp(46), build(45), founder(45), agentic(41), agents(37), startup(34), building(21), course(20), skills(20), scratch(17), memory(17), first(15), api(14), claude(14).
