# Analytics brief — auto-exported 2026-08-16T12:19Z (last 14 days)
...
Hot terms: founder(31), agent(30), agents(29), startup(27), build(26), agentic(25), mcp(18), coding(16), engineering(13), model(12), building(12), systems(11), using(11), data(10), skills(10).
...
The real answer engines are crawling us — IP-verified: 15878 confirmed AI-engine fetches (GPTBot (OpenAI) 7421, ChatGPT (user browsing) 3312, Perplexity 3750, ChatGPT Search (OpenAI) 1395).
