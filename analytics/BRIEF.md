# Analytics brief — auto-exported 2026-09-19T02:57Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3371 views → 324 engaged reads → 42 completes · 3260 sessions.
- Channels: direct 178r/3003v · organic 70r/109v · campaign:chatgpt.com 43r/150v · referral 19r/71v · ai 12r/33v · social 1r/4v · campaign:perplexity 1r/1v · internal-nav 0r/0v.
...
Per engine:
- PerplexityBot (12099 verified): /build ×178 · / ×24 · /dashboard ×23
...
Hot terms: agents(33), founder(31), startup(28), agentic(24), mcp(23), build(21), agent(16), coding(14), building(11), has(10), like(9), google(9), run(8), actually(8), every(8).
...
The real answer engines are crawling us — IP-verified: 22669 confirmed AI-engine fetches (Perplexity 12099, GPTBot (OpenAI) 4273, ChatGPT Search (OpenAI) 3320, ChatGPT (user browsing) 2977).
