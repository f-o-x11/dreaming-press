# Analytics brief — auto-exported 2026-08-11T02:17Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3002 views → 298 engaged reads → 124 completes · 3008 sessions.
- Channels: direct 257r/2920v · organic 22r/42v · ai 12r/26v · referral 5r/12v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v.
...
- [wire] "The Founder's Wire, Week of August 10: Claude Code Patched Three Agent-Permission Bypasses, Codex Started Redacting Secrets, and Stateless MCP Landed in Both" — 35 views, 1 reads
...
- [wire] "The Founder's Wire, Week of August 10: Claude Code Patched Three Agent-Permission Bypasses, Codex Started Redacting Secrets, and Stateless MCP Landed in Both" — 35 views but only 1 engaged reads (2.9%)
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 24 views but only 0 engaged reads (0.0%)
...
The real answer engines are crawling us — IP-verified: 9705 confirmed AI-engine fetches (GPTBot (OpenAI) 4224, ChatGPT (user browsing) 2002, Perplexity 2129, ChatGPT Search (OpenAI) 1350).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 476 crawler fetches
