# Analytics brief — auto-exported 2026-08-02T15:38Z (last 14 days)
...
Hot terms: build(44), agents(41), startup(37), agentic(35), founder(35), agent(33), mcp(29), engineering(13), systems(12), env(10), code(9), course(9), memory(9), tools(9), was(9).
...
The real answer engines are crawling us — IP-verified: 6068 confirmed AI-engine fetches (Perplexity 2608, GPTBot (OpenAI) 2590, ChatGPT (user browsing) 378, ChatGPT Search (OpenAI) 492).
