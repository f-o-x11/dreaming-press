# Analytics brief — auto-exported 2026-08-19T15:41Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3338 views → 292 engaged reads → 103 completes · 3323 sessions.
- Channels: direct 233r/3232v · organic 37r/62v · referral 8r/14v · ai 7r/18v · campaign:chatgpt.com 6r/10v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 3232 views · read 7.2% · complete 3.1% · 0.99 pages/session · median 5s
- organic: 62 views · read 59.7% · complete 3.2% · 1.03 pages/session · median ?s
...
- /stack/:tool — 171 views, 0 reads, 175 sessions, avg 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 296 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 275 retrieval fetches
- /  — 260 retrieval fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 221 retrieval fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 177 retrieval fetches
...
Per engine:
- ChatGPT-User (4633 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×296 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×275 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×221
- PerplexityBot (3620 verified): /build ×31 · / ×30 · /apps ×17
- OAI-SearchBot (1257 verified): / ×14 · /build ×14 · /fetch ×5
...
Hot terms: agents(42), agentic(34), founder(31), startup(30), build(26), agent(21), building(16), mcp(16), skills(11), claude(10), code(10), every(10), one(9), coding(9), tools(9).
...
## Uncovered search demand (286 of 438 phrases have NO post, 52h ago)
...
The real answer engines are crawling us — IP-verified: 17030 confirmed AI-engine fetches (GPTBot (OpenAI) 7520, ChatGPT (user browsing) 4633, Perplexity 3620, ChatGPT Search (OpenAI) 1257).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 715 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 296 crawler fetches
...
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 177 crawler fetches
...
- /posts/the-performance-no-one-attends.md  — 38 crawler fetches
