# Analytics brief — auto-exported 2026-08-25T14:12Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2999 views → 234 engaged reads → 57 completes · 2951 sessions.
- Channels: direct 161r/2851v · organic 41r/73v · referral 11r/32v · campaign:chatgpt.com 11r/21v · ai 10r/20v · campaign:perplexity 0r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2851 views · read 5.6% · complete 1.9% · 1 pages/session · median 4s
...
- /stack/:tool — 375 views, 0 reads, 378 sessions, avg 4s
...
- /  — 426 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 327 retrieval fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 154 retrieval fetches
...
Per engine:
- ChatGPT-User (4793 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×430 · / ×384 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×327
...
Hot terms: agents(38), founder(30), agentic(25), startup(25), mcp(22), build(22), agent(21), coding(15), code(10), building(10), engineering(10), about(10), google(10), tools(10), production(8).
...
The real answer engines are crawling us — IP-verified: 13409 confirmed AI-engine fetches (ChatGPT (user browsing) 4793, GPTBot (OpenAI) 4721, Perplexity 2730, ChatGPT Search (OpenAI) 1165).
...
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 154 crawler fetches
