# Analytics brief — auto-exported 2026-07-22T13:04Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2382 views → 128 engaged reads → 58 completes · 2348 sessions.
- Channels: direct 117r/2299v · referral 5r/8v · organic 3r/70v · ai 3r/5v.
...
Hot terms: agents(48), build(43), agent(40), mcp(39), agentic(32), building(30), founder(30), startup(29), skills(24), claude(15), systems(14), one(13), tools(13), about(13), scratch(12).
...
The real answer engines are crawling us — IP-verified: 4553 confirmed AI-engine fetches (GPTBot (OpenAI) 4452, ChatGPT (user browsing) 31, ChatGPT Search (OpenAI) 51, Perplexity 19).
