# Analytics brief — auto-exported 2026-08-18T13:24Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3205 views → 293 engaged reads → 110 completes · 3187 sessions.
- Channels: direct 242r/3109v · organic 33r/57v · referral 7r/13v · ai 5r/17v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3109 views · read 7.8% · complete 3.5% · 0.99 pages/session · median 6s
...
- /stack/:tool — 135 views, 0 reads, 139 sessions, avg 5s
- /build — 18 views, 0 reads, 16 sessions, avg 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 249 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 242 retrieval fetches
- /  — 231 retrieval fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 218 retrieval fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 171 retrieval fetches
...
Per engine:
- ChatGPT-User (4192 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×249 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×242 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×218
...
Hot terms: agents(36), agentic(32), founder(31), startup(30), build(26), agent(22), mcp(18), building(16), coding(15), one(12), code(10), systems(10), engineering(10), every(10), data(10).
...
## Uncovered search demand (286 of 438 phrases have NO post, 26h ago)
...
The real answer engines are crawling us — IP-verified: 16911 confirmed AI-engine fetches (GPTBot (OpenAI) 7466, ChatGPT (user browsing) 4192, Perplexity 3945, ChatGPT Search (OpenAI) 1308).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 701 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 249 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 247 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 218 crawler fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 176 crawler fetches
...
- /posts/the-performance-no-one-attends.html  — 66 crawler fetches
