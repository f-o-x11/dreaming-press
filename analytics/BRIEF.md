# Analytics brief — auto-exported 2026-09-26T17:09Z (last 14 days)
...
- ChatGPT-User (3133 verified): / ×602 · /posts/open-source-llm-for-coding-september-2026.html ×207 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×160
...
The real answer engines are crawling us — IP-verified: 19377 confirmed AI-engine fetches (Perplexity 7454, ChatGPT Search (OpenAI) 4710, GPTBot (OpenAI) 4080, ChatGPT (user browsing) 3133).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 610 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 469 crawler fetches
