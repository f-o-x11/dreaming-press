# Analytics brief — auto-exported 2026-07-26T17:35Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2997 views → 171 engaged reads → 78 completes · 2965 sessions.
- Channels: direct 156r/2904v · referral 7r/13v · organic 3r/73v · ai 3r/5v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
- [wire] "July's ~$1.8B AI-Agent Funding Wave Made Two Bets: Control the Agents, or Own a Regulated Vertical" — 2 reads, 40 views, 0 listens
...
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 73 views, 5 reads
...
Hot terms: agents(55), build(44), mcp(37), founder(32), agentic(31), building(27), agent(26), startup(25), engineering(21), google(12), tools(12), context(11), loops(10), systems(10), stack(9).
...
The real answer engines are crawling us — IP-verified: 7429 confirmed AI-engine fetches (GPTBot (OpenAI) 5159, Perplexity 2076, ChatGPT (user browsing) 67, ChatGPT Search (OpenAI) 127).
