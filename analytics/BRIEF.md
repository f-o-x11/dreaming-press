# Analytics brief — auto-exported 2026-08-15T05:30Z (last 14 days)
...
The real answer engines are crawling us — IP-verified: 15592 confirmed AI-engine fetches (GPTBot (OpenAI) 7292, ChatGPT (user browsing) 3076, Perplexity 3831, ChatGPT Search (OpenAI) 1393).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 619 crawler fetches
