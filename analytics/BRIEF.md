# Analytics brief — auto-exported 2026-08-18T23:22Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3254 views → 294 engaged reads → 111 completes · 3237 sessions.
- Channels: direct 240r/3153v · organic 35r/59v · referral 7r/13v · ai 6r/18v · campaign:chatgpt.com 5r/10v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3153 views · read 7.6% · complete 3.5% · 0.99 pages/session · median 6s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 266 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 255 retrieval fetches
...
Per engine:
- ChatGPT-User (4399 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×266 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×255 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×226
...
The real answer engines are crawling us — IP-verified: 17134 confirmed AI-engine fetches (GPTBot (OpenAI) 7468, ChatGPT (user browsing) 4399, Perplexity 3956, ChatGPT Search (OpenAI) 1311).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 716 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 266 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 260 crawler fetches
