# Analytics brief — auto-exported 2026-08-13T01:23Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2995 views → 312 engaged reads → 129 completes · 2998 sessions.
- Channels: direct 269r/2909v · organic 21r/43v · ai 13r/27v · referral 5r/12v · campaign:chatgpt.com 3r/3v · campaign:copilot.com 1r/1v.
...
Hot terms: build(34), agents(33), founder(32), agentic(30), startup(28), mcp(27), agent(23), skills(22), building(16), claude(14), has(14), using(12), systems(12), engineering(11), through(10).
...
## Uncovered search demand (296 of 440 phrases have NO post, 14h ago)
...
The real answer engines are crawling us — IP-verified: 13106 confirmed AI-engine fetches (GPTBot (OpenAI) 5384, Perplexity 3576, ChatGPT (user browsing) 2716, ChatGPT Search (OpenAI) 1430).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 551 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 200 crawler fetches
...
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 89 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 88 crawler fetches
- /posts/2026-07-22-founders-wire-portable-context-agents-in-chat-open-coders.html  — 86 crawler fetches
