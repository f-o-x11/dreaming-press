# Analytics brief — auto-exported 2026-08-25T09:15Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2953 views → 234 engaged reads → 60 completes · 2908 sessions.
- Channels: direct 161r/2806v · organic 42r/73v · referral 11r/32v · campaign:chatgpt.com 11r/21v · ai 9r/19v · campaign:perplexity 0r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2806 views · read 5.7% · complete 2.0% · 1 pages/session · median 4s
- organic: 73 views · read 57.5% · complete 2.7% · 1.04 pages/session · median ?s
...
- [stack] "How to Cap a Runaway Claude Code Agent: The New Per-Session Subagent and Web-Search Budgets" — 4 reads, 4 views, 0 listens
...
- /stack/:tool — 369 views, 0 reads, 372 sessions, avg 4s
...
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 23 views, 1 reads
...
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 23 views but only 1 engaged reads (4.3%)
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 426 retrieval fetches
- /  — 418 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 325 retrieval fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 153 retrieval fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 128 retrieval fetches
- /build  — 44 retrieval fetches
- /tags/opinionated  — 15 retrieval fetches
- /apps  — 15 retrieval fetches
...
Per engine:
- ChatGPT-User (4749 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×426 · / ×377 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×325
- PerplexityBot (2726 verified): / ×31 · /build ×21 · /tags/opinionated ×15
- OAI-SearchBot (1118 verified): /build ×23 · / ×10 · /posts/langfuse-vs-arize-phoenix-vs-braintrust-llm-observability-solo-founder.html ×6
...
Hot terms: agents(37), founder(30), startup(26), agentic(25), mcp(22), build(21), agent(20), coding(14), code(11), building(11), about(11), tools(11), google(10), first(9), claude(8).
...
## Uncovered search demand (282 of 447 phrases have NO post, 35h ago)
...
The real answer engines are crawling us — IP-verified: 13314 confirmed AI-engine fetches (ChatGPT (user browsing) 4749, GPTBot (OpenAI) 4721, Perplexity 2726, ChatGPT Search (OpenAI) 1118).
...
- /posts/how-to-harden-your-repo-against-ai-agent-poisoned-prs.html  — 138 crawler fetches
...
- /posts/2026-06-27-scale-to-zero-llm-inference-gpu-cold-starts.html  — 50 crawler fetches
