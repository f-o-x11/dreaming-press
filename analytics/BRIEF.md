# Analytics brief — auto-exported 2026-08-19T15:00Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3337 views → 291 engaged reads → 103 completes · 3322 sessions.
- Channels: direct 233r/3231v · organic 36r/62v · referral 8r/14v · ai 7r/18v · campaign:chatgpt.com 6r/10v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 295 retrieval fetches
...
Per engine:
- ChatGPT-User (4613 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×295 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×274 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×220
...
Hot terms: agents(41), agentic(34), founder(30), startup(30), build(25), agent(21), building(16), mcp(15), skills(11), claude(10), code(10), every(10), one(9), coding(9), engineering(9).
...
The real answer engines are crawling us — IP-verified: 17010 confirmed AI-engine fetches (GPTBot (OpenAI) 7520, ChatGPT (user browsing) 4613, Perplexity 3620, ChatGPT Search (OpenAI) 1257).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 713 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 295 crawler fetches
