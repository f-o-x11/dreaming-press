# Analytics brief — auto-exported 2026-09-01T15:59Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3649 views → 272 engaged reads → 53 completes · 3577 sessions.
- Channels: direct 175r/3427v · organic 48r/88v · referral 16r/59v · campaign:chatgpt.com 15r/44v · ai 15r/22v · campaign:copilot.com 2r/2v · campaign:perplexity 1r/2v · social 0r/4v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
...
- direct: 3427 views · read 5.1% · complete 1.4% · 1 pages/session · median 4s
...
- /stack/:tool — 431 views, 0 reads, 430 sessions, avg 4s
...
- /  — 577 retrieval fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 329 retrieval fetches
...
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 83 retrieval fetches
...
Per engine:
- ChatGPT-User (3491 verified): / ×535 · /posts/agent-funding-august-2026-control-won-the-summer.html ×329 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×188
- OAI-SearchBot (2396 verified): /build ×36 · / ×13 · /posts/serverless-inference-api-groq-fireworks-together-deepinfra-baseten.html ×9
...
Hot terms: agents(36), agent(32), agentic(30), build(28), coding(28), founder(26), startup(24), one(15), mcp(14), building(14), systems(12), here(11), code(10), engineering(9), has(8).
...
## Uncovered search demand (275 of 457 phrases have NO post, 76h ago)
...
The real answer engines are crawling us — IP-verified: 8625 confirmed AI-engine fetches (ChatGPT (user browsing) 3491, ChatGPT Search (OpenAI) 2396, GPTBot (OpenAI) 2368, Perplexity 370).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 722 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 329 crawler fetches
...
- /posts/ai-coding-agent-ranking-2026.html  — 181 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 83 crawler fetches
