# Analytics brief — auto-exported 2026-08-27T16:48Z (last 14 days)
...
Per engine:
- ChatGPT-User (4535 verified): / ×448 · /posts/agent-funding-august-2026-control-won-the-summer.html ×445 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×290
...
Hot terms: agents(33), founder(27), startup(27), agentic(24), build(22), agent(20), mcp(19), engineering(16), building(14), coding(13), systems(10), here(10), one(9), workflows(8), learn(8).
...
The real answer engines are crawling us — IP-verified: 10853 confirmed AI-engine fetches (ChatGPT (user browsing) 4535, GPTBot (OpenAI) 3564, ChatGPT Search (OpenAI) 1568, Perplexity 1186).
