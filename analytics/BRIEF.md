# Analytics brief — auto-exported 2026-08-02T20:51Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2098 views → 192 engaged reads → 89 completes · 2082 sessions.
- Channels: direct 165r/2044v · ai 10r/18v · organic 8r/22v · referral 7r/12v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
- [wire] "The Founder's Shipping Log: What Landed in AI Agent Frameworks This Quarter" — 4 reads, 21 views, 0 listens
...
Hot terms: build(46), agents(44), agentic(39), agent(36), startup(35), founder(34), mcp(31), engineering(15), course(12), building(12), systems(12), skills(11), coding(11), env(10), code(9).
...
The real answer engines are crawling us — IP-verified: 6153 confirmed AI-engine fetches (Perplexity 2610, GPTBot (OpenAI) 2591, ChatGPT (user browsing) 395, ChatGPT Search (OpenAI) 557).
...
- /posts/lm-studio-bionic-local-agent-open-models.html  — 31 crawler fetches
- /posts/waico-vs-pax-silica-two-ai-governance-blocs-founders.html  — 25 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 20 crawler fetches
- /posts/2026-07-13-founder-shipping-log-agent-frameworks-q2.html  — 18 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 18 crawler fetches
