# Analytics brief — auto-exported 2026-08-09T00:34Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2915 views → 277 engaged reads → 111 completes · 2920 sessions.
- Channels: direct 240r/2839v · organic 20r/39v · ai 11r/25v · referral 4r/10v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v.
...
- [wire] "The Founder's Wire, Week of August 7: Meta Enters the Coding-Agent War, OpenAI Sunsets Atlas, and Claude Code Ships a Free Usage Window" — 25 reads, 266 views, 0 listens
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 8 reads, 37 views, 0 listens
...
- [wire] "The Founder's Wire, Week of July 23: Google Makes Memory a Process, Alibaba Ships an Agent-Native Cloud, and Kimi K3's Open Weights Land in Days" — 3 reads, 30 views, 0 listens

## Top by listens (audio is now on every piece — Item 1)
- [wire] "How to Redact PII Before It Reaches an LLM Without Breaking the Task" — 1 listens, 1 reads

## Top by raw views (eyes that arrived)
- [wire] "The Founder's Wire, Week of August 7: Meta Enters the Coding-Agent War, OpenAI Sunsets Atlas, and Claude Code Ships a Free Usage Window" — 266 views, 25 reads
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 164 views, 2 reads
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 37 views, 8 reads
- [wire] "China Regulated the AI Persona, Not the Model — So Doubao and Qwen Are Killing Their Agents on July 15" — 34 views, 0 reads
- [wire] "The Founder's Wire, Week of July 23: Google Makes Memory a Process, Alibaba Ships an Agent-Native Cloud, and Kimi K3's Open Weights Land in Days" — 30 views, 3 reads
- [wire] "vLLM 0.26 and SGLang 0.5.16 Shipped the Same Day. This Time They Fought Over Memory." — 29 views, 4 reads

## WRITE MORE LIKE THESE (the winning pattern)
- Winning formats: comparison (8), news (8), how-to (5).
- Winning section mix: wire=18, stack=7.
- Words that recur in winning titles: august(8), agent(6), memory(6), founder(5), wire(5), week(5), llm(5), openai(4), agents(4), ships(3), sqlite-vec(3), picking(3).
...
Hot terms: build(40), agentic(38), agents(37), mcp(32), startup(28), building(26), founder(25), skills(24), agent(22), engineering(13), claude(12), google(12), course(12), systems(12), tools(11).
...
The real answer engines are crawling us — IP-verified: 9397 confirmed AI-engine fetches (GPTBot (OpenAI) 4623, Perplexity 2279, ChatGPT (user browsing) 1283, ChatGPT Search (OpenAI) 1212).
...
- /posts/lm-studio-bionic-local-agent-open-models.html  — 97 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 68 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 67 crawler fetches
- /posts/how-to-trace-and-evaluate-an-ai-agent-with-langfuse.html  — 66 crawler fetches
- /posts/mcp-stateless-core-2026-07-28-what-breaks.html  — 47 crawler fetches
- /posts/cloudflare-agents-week-2026-ai-gateway-email-sandboxes-founder.html  — 45 crawler fetches
...
- /posts/ai-agent-memory-benchmarks-locomo-mem0-zep.html  — 36 crawler fetches
