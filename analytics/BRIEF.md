# Analytics brief — auto-exported 2026-09-17T00:59Z (last 14 days)
...
- OAI-SearchBot (3406 verified): /wire.html ×40 · /posts/kimi-k3-vs-opus-vs-gpt-56-coding-agent-cost.html ×28 · /posts/ai-coding-agent-ranking-2026.html ×28
- ChatGPT-User (2895 verified): / ×560 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×127 · /posts/open-source-llm-for-coding-september-2026.html ×106
...
Hot terms: agents(27), founder(27), startup(26), agentic(25), mcp(20), build(17), agent(15), building(15), systems(13), has(11), python(10), coding(10), its(9), co-founder(9), run(8).
...
The real answer engines are crawling us — IP-verified: 21347 confirmed AI-engine fetches (Perplexity 13325, ChatGPT Search (OpenAI) 3406, ChatGPT (user browsing) 2895, GPTBot (OpenAI) 1721).
