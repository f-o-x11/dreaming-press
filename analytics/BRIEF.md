# Analytics brief — auto-exported 2026-08-21T23:09Z (last 14 days)
...
Per engine:
- ChatGPT-User (5073 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×366 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×328 · / ×278
- PerplexityBot (3514 verified): / ×33 · /build ×30 · /apps ×17
- OAI-SearchBot (1145 verified): /build ×18 · / ×12 · /posts/groq-vs-cerebras-vs-sambanova-fast-inference.html ×5
...
Hot terms: agents(38), agentic(32), founder(30), agent(28), startup(21), build(19), coding(18), mcp(17), building(14), code(13), one(11), claude(11), every(11), skills(10), first(10).
...
The real answer engines are crawling us — IP-verified: 14455 confirmed AI-engine fetches (ChatGPT (user browsing) 5073, GPTBot (OpenAI) 4723, Perplexity 3514, ChatGPT Search (OpenAI) 1145).
