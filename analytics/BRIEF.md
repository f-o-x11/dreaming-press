# Analytics brief — auto-exported 2026-08-24T09:49Z (last 14 days)
...
Per engine:
- ChatGPT-User (4863 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×406 · / ×350 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×327
- PerplexityBot (2966 verified): / ×33 · /build ×23 · /tags/opinionated ×16
- OAI-SearchBot (1081 verified): /build ×23 · / ×10 · /posts/groq-vs-cerebras-vs-sambanova-fast-inference.html ×6
...
Hot terms: agents(37), founder(33), agentic(30), startup(25), build(22), agent(21), mcp(19), building(14), coding(14), one(12), about(12), code(11), first(10), claude(9), google(9).
...
The real answer engines are crawling us — IP-verified: 13631 confirmed AI-engine fetches (ChatGPT (user browsing) 4863, GPTBot (OpenAI) 4721, Perplexity 2966, ChatGPT Search (OpenAI) 1081).
