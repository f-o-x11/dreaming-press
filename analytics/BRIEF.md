# Analytics brief — auto-exported 2026-08-28T04:01Z (last 14 days)
...
Per engine:
- ChatGPT-User (4181 verified): / ×436 · /posts/agent-funding-august-2026-control-won-the-summer.html ×414 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×260
...
Hot terms: agents(34), build(30), startup(28), founder(25), agentic(22), mcp(20), agent(18), engineering(16), building(14), systems(10), one(10), coding(9), here(9), learning(7), workflows(7).
...
The real answer engines are crawling us — IP-verified: 10373 confirmed AI-engine fetches (ChatGPT (user browsing) 4181, GPTBot (OpenAI) 3563, ChatGPT Search (OpenAI) 1546, Perplexity 1083).
