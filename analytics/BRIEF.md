# Analytics brief — auto-exported 2026-08-19T10:42Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3292 views → 289 engaged reads → 102 completes · 3277 sessions.
- Channels: direct 231r/3184v · organic 36r/62v · referral 8r/15v · ai 7r/19v · campaign:chatgpt.com 6r/10v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 3184 views · read 7.3% · complete 3.1% · 0.99 pages/session · median 5s
...
- /weekly — 15 views, 0 reads, 15 sessions, avg 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 285 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 270 retrieval fetches
- /  — 253 retrieval fetches
...
Per engine:
- ChatGPT-User (4525 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×285 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×270 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×217
...
## Uncovered search demand (286 of 438 phrases have NO post, 47h ago)
...
The real answer engines are crawling us — IP-verified: 16864 confirmed AI-engine fetches (GPTBot (OpenAI) 7464, ChatGPT (user browsing) 4525, Perplexity 3620, ChatGPT Search (OpenAI) 1255).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 706 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 285 crawler fetches
