# Analytics brief — auto-exported 2026-08-13T21:58Z (last 14 days)
...
Hot terms: founder(35), agentic(29), build(29), startup(28), agents(27), agent(22), mcp(22), building(16), skills(15), has(15), coding(14), through(13), using(13), claude(11), model(11).
...
The real answer engines are crawling us — IP-verified: 13479 confirmed AI-engine fetches (GPTBot (OpenAI) 5387, ChatGPT (user browsing) 2912, Perplexity 3681, ChatGPT Search (OpenAI) 1499).
