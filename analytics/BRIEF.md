# Analytics brief — auto-exported 2026-08-19T07:19Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3280 views → 288 engaged reads → 105 completes · 3264 sessions.
- Channels: direct 233r/3176v · organic 33r/58v · referral 8r/15v · ai 7r/19v · campaign:chatgpt.com 6r/10v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
- AI assistants (our real front door): ChatGPT 6r/10v · Doubao 3r/4v · Yuanbao 2r/2v · Perplexity 2r/2v · Copilot 1r/1v · Kimi 0r/11v.
...
- direct: 3176 views · read 7.3% · complete 3.2% · 0.99 pages/session · median 5s
- organic: 58 views · read 56.9% · complete 3.4% · 1.04 pages/session · median ?s
- ai: 19 views · read 36.8% · complete 0.0% · 0.95 pages/session · median 10s
- referral: 15 views · read 53.3% · complete 0.0% · 1 pages/session · median ?s
- campaign:chatgpt.com: 10 views · read 60.0% · complete 0.0% · 1.25 pages/session · median ?s
...
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 8 reads, 31 views, 0 listens
...
- [stack] "sqlite-vec vs LanceDB vs Chroma: The Embedded Vector Store for a Solo Builder" — 4 reads, 14 views, 0 listens
...
- /stack/:tool — 160 views, 0 reads, 164 sessions, avg 5s
- /build — 21 views, 0 reads, 20 sessions, avg 5s
- / — 19 views, 1 reads, 17 sessions, avg 12s
- /best/:cat — 15 views, 0 reads, 15 sessions, avg 4s
- /weekly — 14 views, 0 reads, 14 sessions, avg 5s
- /tools — 8 views, 0 reads, 8 sessions, avg 8s
...
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 31 views, 8 reads
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 281 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 265 retrieval fetches
- /  — 246 retrieval fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 215 retrieval fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 175 retrieval fetches
...
Per engine:
- ChatGPT-User (4460 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×281 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×265 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×215
- PerplexityBot (3541 verified): /build ×30 · / ×29 · /apps ×16
- OAI-SearchBot (1253 verified): / ×14 · /build ×14 · /fetch ×5
...
Hot terms: agents(38), agentic(33), founder(31), startup(30), agent(21), build(21), building(16), mcp(15), skills(11), every(11), claude(10), code(10), coding(10), one(9), systems(9).
...
## Uncovered search demand (286 of 438 phrases have NO post, 43h ago)
...
The real answer engines are crawling us — IP-verified: 16718 confirmed AI-engine fetches (GPTBot (OpenAI) 7464, ChatGPT (user browsing) 4460, Perplexity 3541, ChatGPT Search (OpenAI) 1253).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 699 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 281 crawler fetches
...
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 175 crawler fetches
