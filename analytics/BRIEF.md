# Analytics brief — auto-exported 2026-08-04T18:32Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2188 views → 210 engaged reads → 91 completes · 2176 sessions.
- Channels: direct 183r/2132v · organic 10r/23v · ai 10r/19v · referral 5r/12v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 6 reads, 186 views, 0 listens
...
- [wire] "The Founder's Wire, Week of July 20: MCP's Stateless Spec Locks in a Week, Kimi K3 Opens a 2.8T Model, and Claude Code Ships Eight Releases" — 186 views, 6 reads
...
Hot terms: agentic(43), build(42), agents(38), mcp(32), agent(30), startup(27), founder(24), engineering(15), building(15), course(11), coding(11), skills(10), google(9), product(8), tools(8).
...
The real answer engines are crawling us — IP-verified: 7149 confirmed AI-engine fetches (Perplexity 3243, GPTBot (OpenAI) 2594, ChatGPT (user browsing) 698, ChatGPT Search (OpenAI) 614).
...
- /posts/tool-highlight-honeycomb-agent-observability-otel-native.html  — 51 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 49 crawler fetches
...
- /posts/2026-07-26-founders-wire-week-ahead-kimi-k3-weights-mcp-v2-final.html  — 27 crawler fetches
- /posts/yubikey-5-8-verified-authorization-agent-actions.html  — 27 crawler fetches
- /posts/how-to-inventory-your-ai-agents-before-security-team.html  — 27 crawler fetches
