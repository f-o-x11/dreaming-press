# Analytics brief — auto-exported 2026-08-14T18:23Z (last 14 days)
...
Hot terms: founder(32), build(30), startup(30), agents(29), agent(26), agentic(26), mcp(19), coding(15), building(15), systems(12), through(12), model(11), stack(11), has(11), using(11).
...
The real answer engines are crawling us — IP-verified: 13094 confirmed AI-engine fetches (GPTBot (OpenAI) 4472, ChatGPT (user browsing) 3296, Perplexity 3900, ChatGPT Search (OpenAI) 1426).
