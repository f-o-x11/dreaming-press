# Analytics brief — auto-exported 2026-09-14T00:00Z (last 14 days)
...
- OAI-SearchBot (3416 verified): /wire.html ×28 · /posts/2026-08-04-founders-wire-anthropic-price-ladder-perception-preview-agent-funding.html ×26 · /posts/kimi-k3-vs-opus-vs-gpt-56-coding-agent-cost.html ×25
- ChatGPT-User (2905 verified): / ×556 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×91 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×64
...
Hot terms: founder(27), build(26), agentic(25), startup(25), agents(24), mcp(18), building(18), agent(17), systems(11), own(10), python(10), claude(9), about(9), has(8), have(8).
...
## Uncovered search demand (264 of 456 phrases have NO post, 36h ago)
...
The real answer engines are crawling us — IP-verified: 19504 confirmed AI-engine fetches (Perplexity 11872, ChatGPT Search (OpenAI) 3416, ChatGPT (user browsing) 2905, GPTBot (OpenAI) 1311).
