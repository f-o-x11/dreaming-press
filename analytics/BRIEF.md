# Analytics brief — auto-exported 2026-08-06T05:04Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2584 views → 232 engaged reads → 104 completes · 2585 sessions.
- Channels: direct 200r/2517v · organic 14r/26v · ai 11r/25v · referral 5r/14v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
Hot terms: build(42), agents(40), agentic(40), mcp(35), agent(27), startup(24), founder(23), engineering(18), building(16), coding(13), google(12), course(12), skills(11), systems(11), tools(10).
...
The real answer engines are crawling us — IP-verified: 10566 confirmed AI-engine fetches (GPTBot (OpenAI) 5437, Perplexity 3436, ChatGPT (user browsing) 880, ChatGPT Search (OpenAI) 813).
...
- /posts/inside-mem0-2x-add-only-memory-engine.html  — 40 crawler fetches
- /posts/prompt-engineering-for-agents-tool-descriptions.html  — 40 crawler fetches
