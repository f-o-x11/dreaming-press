# Analytics brief — auto-exported 2026-08-12T15:05Z (last 14 days)
...
Hot terms: agents(36), build(33), founder(33), agentic(30), mcp(27), startup(27), agent(24), skills(23), building(17), claude(14), has(14), engineering(13), using(12), systems(12), through(11).
...
The real answer engines are crawling us — IP-verified: 11995 confirmed AI-engine fetches (GPTBot (OpenAI) 4228, Perplexity 3557, ChatGPT (user browsing) 2697, ChatGPT Search (OpenAI) 1513).
