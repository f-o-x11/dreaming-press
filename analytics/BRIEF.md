# Analytics brief — auto-exported 2026-08-20T15:23Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2976 views → 279 engaged reads → 91 completes · 2945 sessions.
- Channels: direct 220r/2870v · organic 38r/64v · referral 7r/15v · campaign:chatgpt.com 7r/13v · ai 6r/12v · campaign:copilot.com 1r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2870 views · read 7.7% · complete 3.1% · 1 pages/session · median 5s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 338 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 305 retrieval fetches
...
Per engine:
- ChatGPT-User (4868 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×338 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×305 · / ×245
...
## Uncovered search demand (286 of 438 phrases have NO post, 76h ago)
...
The real answer engines are crawling us — IP-verified: 13755 confirmed AI-engine fetches (ChatGPT (user browsing) 4868, GPTBot (OpenAI) 4268, Perplexity 3480, ChatGPT Search (OpenAI) 1139).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 666 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 338 crawler fetches
