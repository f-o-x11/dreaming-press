# Analytics brief — auto-exported 2026-09-19T01:46Z (last 14 days)
...
- OAI-SearchBot (3307 verified): /wire.html ×47 · /tools ×33 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×28
...
Hot terms: agents(33), founder(31), startup(28), mcp(25), agentic(20), build(19), agent(17), coding(14), building(11), like(9), google(9), launch(8), run(8), actually(8), every(8).
...
The real answer engines are crawling us — IP-verified: 22635 confirmed AI-engine fetches (Perplexity 12085, GPTBot (OpenAI) 4273, ChatGPT Search (OpenAI) 3307, ChatGPT (user browsing) 2970).
