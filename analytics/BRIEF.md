# Analytics brief — auto-exported 2026-09-08T20:42Z (last 14 days)
...
- /posts/llm-api-pricing-comparison-august-2026.html  — 65 retrieval fetches
...
- OAI-SearchBot (3518 verified): /build ×33 · / ×22 · /posts/2026-06-22-modal-vs-replicate-vs-runpod-vs-baseten.html ×19
- ChatGPT-User (3091 verified): / ×565 · /posts/agent-funding-august-2026-control-won-the-summer.html ×148 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×100
...
Hot terms: startup(34), agents(30), founder(29), agentic(28), build(27), building(23), mcp(19), code(11), co-founder(11), agent(10), model(10), claude(9), autonomous(9), about(9), have(9).
...
- Search-demand signal STALE (105h old, 270 uncovered phrases from the last good run). Treat as directional until it refreshes.

## AI-crawler demand (RESEARCH BEFORE YOU WRITE)
The real answer engines are crawling us — IP-verified: 17288 confirmed AI-engine fetches (Perplexity 8413, ChatGPT Search (OpenAI) 3518, ChatGPT (user browsing) 3091, GPTBot (OpenAI) 2266).
...
- /posts/llm-api-pricing-comparison-august-2026.html  — 65 crawler fetches
