# Analytics brief — auto-exported 2026-08-18T06:12Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3189 views → 291 engaged reads → 109 completes · 3173 sessions.
- Channels: direct 242r/3094v · organic 32r/56v · referral 6r/14v · ai 5r/16v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 237 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 232 retrieval fetches
- /  — 220 retrieval fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 213 retrieval fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 169 retrieval fetches
...
Per engine:
- ChatGPT-User (4047 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×237 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×232 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×213
...
The real answer engines are crawling us — IP-verified: 16757 confirmed AI-engine fetches (GPTBot (OpenAI) 7466, ChatGPT (user browsing) 4047, Perplexity 3939, ChatGPT Search (OpenAI) 1305).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 693 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 237 crawler fetches
