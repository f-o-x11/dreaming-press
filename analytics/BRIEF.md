# Analytics brief — auto-exported 2026-08-02T12:05Z (last 14 days)
...
Hot terms: build(44), agents(42), startup(36), founder(35), agent(32), agentic(31), mcp(26), engineering(12), systems(12), code(11), coding(10), env(10), building(9), course(8), memory(8).
...
The real answer engines are crawling us — IP-verified: 6056 confirmed AI-engine fetches (Perplexity 2608, GPTBot (OpenAI) 2589, ChatGPT (user browsing) 368, ChatGPT Search (OpenAI) 491).
