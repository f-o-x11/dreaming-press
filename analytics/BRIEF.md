# Analytics brief — auto-exported 2026-08-06T12:50Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2673 views → 232 engaged reads → 107 completes · 2675 sessions.
- Channels: direct 199r/2604v · organic 14r/27v · ai 11r/25v · referral 6r/15v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
The real answer engines are crawling us — IP-verified: 10701 confirmed AI-engine fetches (GPTBot (OpenAI) 5437, Perplexity 3444, ChatGPT (user browsing) 969, ChatGPT Search (OpenAI) 851).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 97 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 89 crawler fetches
