# Analytics brief — auto-exported 2026-08-06T18:06Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2749 views → 238 engaged reads → 111 completes · 2751 sessions.
- Channels: direct 205r/2681v · organic 14r/26v · ai 11r/25v · referral 6r/15v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
The real answer engines are crawling us — IP-verified: 10862 confirmed AI-engine fetches (GPTBot (OpenAI) 5439, Perplexity 3456, ChatGPT (user browsing) 1024, ChatGPT Search (OpenAI) 943).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 98 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 95 crawler fetches
