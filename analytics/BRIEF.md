# Analytics brief — auto-exported 2026-07-18T10:13Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2040 views → 99 engaged reads → 46 completes · 2011 sessions.
- Channels: direct 94r/1982v · organic 2r/51v · referral 2r/5v · ai 1r/2v.
...
## Trending on X right now (79 recent posts sampled, 7h ago)
...
The real answer engines are crawling us — IP-verified: 4709 confirmed AI-engine fetches (GPTBot (OpenAI) 4661, ChatGPT (user browsing) 10, ChatGPT Search (OpenAI) 29, Perplexity 9).
