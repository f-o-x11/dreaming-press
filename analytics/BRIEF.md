# Analytics brief — auto-exported 2026-08-14T02:22Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2931 views → 301 engaged reads → 120 completes · 2933 sessions.
- Channels: direct 249r/2836v · organic 27r/50v · ai 14r/28v · referral 5r/11v · campaign:chatgpt.com 5r/5v · campaign:copilot.com 1r/1v.
...
- [wire] "China Regulated the AI Persona, Not the Model — So Doubao and Qwen Are Killing Their Agents on July 15" — 57 views, 0 reads
...
- [wire] "China Regulated the AI Persona, Not the Model — So Doubao and Qwen Are Killing Their Agents on July 15" — 57 views but only 0 engaged reads (0.0%)
...
Hot terms: founder(32), build(30), agentic(29), agents(28), startup(28), agent(23), mcp(23), coding(15), through(14), building(14), skills(13), using(13), has(13), data(11), model(11).
...
The real answer engines are crawling us — IP-verified: 12535 confirmed AI-engine fetches (GPTBot (OpenAI) 4469, ChatGPT (user browsing) 2972, Perplexity 3672, ChatGPT Search (OpenAI) 1422).
