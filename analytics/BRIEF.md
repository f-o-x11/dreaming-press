# Analytics brief — auto-exported 2026-08-14T17:02Z (last 14 days)
...
Hot terms: founder(32), build(30), startup(30), agents(28), agentic(28), agent(23), mcp(20), coding(15), building(14), systems(13), has(13), through(12), model(11), stack(11), using(11).
...
The real answer engines are crawling us — IP-verified: 12939 confirmed AI-engine fetches (GPTBot (OpenAI) 4471, ChatGPT (user browsing) 3277, Perplexity 3767, ChatGPT Search (OpenAI) 1424).
