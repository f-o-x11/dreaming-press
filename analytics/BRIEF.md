# Analytics brief — auto-exported 2026-08-04T18:01Z (last 14 days)
...
Hot terms: build(42), agentic(41), agents(39), agent(30), mcp(30), startup(27), founder(24), building(17), engineering(15), course(11), coding(11), skills(10), one(10), google(9), tools(8).
...
The real answer engines are crawling us — IP-verified: 7145 confirmed AI-engine fetches (Perplexity 3242, GPTBot (OpenAI) 2594, ChatGPT (user browsing) 695, ChatGPT Search (OpenAI) 614).
...
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 48 crawler fetches
