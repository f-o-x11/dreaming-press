# Analytics brief — auto-exported 2026-08-07T02:24Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2755 views → 239 engaged reads → 111 completes · 2759 sessions.
...
The real answer engines are crawling us — IP-verified: 9062 confirmed AI-engine fetches (GPTBot (OpenAI) 5135, Perplexity 2021, ChatGPT (user browsing) 938, ChatGPT Search (OpenAI) 968).
