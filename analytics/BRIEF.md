# Analytics brief — auto-exported 2026-08-18T15:25Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3222 views → 293 engaged reads → 111 completes · 3205 sessions.
- Channels: direct 242r/3126v · organic 33r/57v · referral 7r/13v · ai 5r/17v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3126 views · read 7.7% · complete 3.5% · 0.99 pages/session · median 6s
...
- /compare/:pair — 6 views, 0 reads, 6 sessions, avg 3s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 253 retrieval fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 243 retrieval fetches
- /  — 234 retrieval fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 221 retrieval fetches
...
Per engine:
- ChatGPT-User (4242 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×253 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×243 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×221
...
Hot terms: agents(34), agentic(32), founder(31), startup(31), build(25), agent(21), mcp(18), building(16), coding(14), one(12), code(10), systems(10), engineering(10), every(10), claude(10).
...
The real answer engines are crawling us — IP-verified: 16962 confirmed AI-engine fetches (GPTBot (OpenAI) 7467, ChatGPT (user browsing) 4242, Perplexity 3945, ChatGPT Search (OpenAI) 1308).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 706 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 253 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 248 crawler fetches
