# Analytics brief — auto-exported 2026-08-09T11:31Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3101 views → 281 engaged reads → 113 completes · 3103 sessions.
- Channels: direct 245r/3026v · organic 20r/39v · ai 11r/25v · referral 4r/10v · campaign:chatgpt.com 1r/1v.
...
- [wire] "China Regulated the AI Persona, Not the Model — So Doubao and Qwen Are Killing Their Agents on July 15" — 36 views, 0 reads
...
Hot terms: agentic(41), build(38), agents(35), startup(32), mcp(31), founder(28), skills(24), building(22), agent(22), claude(16), engineering(13), has(13), coding(12), google(12), course(12).
...
## Uncovered search demand (305 of 438 phrases have NO post, 2h ago)
...
The real answer engines are crawling us — IP-verified: 9614 confirmed AI-engine fetches (GPTBot (OpenAI) 4624, Perplexity 2319, ChatGPT (user browsing) 1426, ChatGPT Search (OpenAI) 1245).
...
- /posts/lm-studio-bionic-local-agent-open-models.html  — 100 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 75 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 73 crawler fetches
- /posts/how-to-trace-and-evaluate-an-ai-agent-with-langfuse.html  — 72 crawler fetches
