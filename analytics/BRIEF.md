# Analytics brief — auto-exported 2026-09-23T11:27Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3341 views → 349 engaged reads → 18 completes · 3231 sessions.
...
- direct: 2933 views · read 5.5% · complete 0.4% · 0.99 pages/session · median 4s
...
- OAI-SearchBot (3777 verified): /wire.html ×51 · /tools ×33 · /posts/2026-08-26-founders-wire-stability-labels-slack-code-general-intuition.html ×30
- ChatGPT-User (3139 verified): / ×596 · /posts/open-source-llm-for-coding-september-2026.html ×209 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×157
...
Hot terms: agents(41), founder(35), startup(31), agent(29), build(25), mcp(23), agentic(22), coding(17), building(16), first(11), launch(10), claude(9), google(9), connect(8), has(8).
...
The real answer engines are crawling us — IP-verified: 19750 confirmed AI-engine fetches (Perplexity 8385, GPTBot (OpenAI) 4449, ChatGPT Search (OpenAI) 3777, ChatGPT (user browsing) 3139).
