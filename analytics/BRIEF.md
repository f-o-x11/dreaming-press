# Analytics brief — auto-exported 2026-08-06T02:32Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2552 views → 232 engaged reads → 104 completes · 2552 sessions.
- Channels: direct 201r/2488v · organic 14r/26v · ai 10r/22v · referral 5r/14v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
- AI assistants (our real front door): Kimi 8r/20v · Perplexity 1r/1v · Doubao 1r/1v.
...
- [wire] "July's ~$1.8B AI-Agent Funding Wave Made Two Bets: Control the Agents, or Own a Regulated Vertical" — 3 reads, 39 views, 0 listens
...
- [wire] "July's ~$1.8B AI-Agent Funding Wave Made Two Bets: Control the Agents, or Own a Regulated Vertical" — 39 views, 3 reads
...
Hot terms: build(42), agents(41), agentic(40), mcp(35), agent(27), startup(24), founder(24), engineering(18), building(16), coding(13), course(12), skills(11), systems(11), google(10), tools(10).
...
The real answer engines are crawling us — IP-verified: 10541 confirmed AI-engine fetches (GPTBot (OpenAI) 5436, Perplexity 3434, ChatGPT (user browsing) 867, ChatGPT Search (OpenAI) 804).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 97 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 83 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 78 crawler fetches
...
- /posts/inside-mem0-2x-add-only-memory-engine.html  — 39 crawler fetches
- /posts/prompt-engineering-for-agents-tool-descriptions.html  — 39 crawler fetches
