# Analytics brief — auto-exported 2026-08-18T01:27Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3175 views → 292 engaged reads → 109 completes · 3157 sessions.
- Channels: direct 242r/3079v · organic 32r/56v · ai 7r/18v · referral 5r/13v · campaign:chatgpt.com 5r/8v · campaign:copilot.com 1r/1v · internal-nav 0r/0v.
...
- direct: 3079 views · read 7.9% · complete 3.5% · 1 pages/session · median 6s
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 228 retrieval fetches
...
Per engine:
- ChatGPT-User (3945 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×228 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×226 · /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html ×212
...
The real answer engines are crawling us — IP-verified: 16644 confirmed AI-engine fetches (GPTBot (OpenAI) 7465, ChatGPT (user browsing) 3945, Perplexity 3931, ChatGPT Search (OpenAI) 1303).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 684 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 231 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 228 crawler fetches
