# Analytics brief — auto-exported 2026-09-23T06:33Z (last 14 days)
...
- OAI-SearchBot (3719 verified): /wire.html ×51 · /tools ×33 · /posts/local-llm-for-coding-on-your-own-machine.html ×29
- ChatGPT-User (3074 verified): / ×588 · /posts/open-source-llm-for-coding-september-2026.html ×205 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×156
...
Hot terms: agents(40), founder(35), startup(33), agent(28), build(24), agentic(22), mcp(21), coding(17), building(15), first(10), launch(10), google(9), has(9), every(8), today(8).
...
The real answer engines are crawling us — IP-verified: 19617 confirmed AI-engine fetches (Perplexity 8376, GPTBot (OpenAI) 4448, ChatGPT Search (OpenAI) 3719, ChatGPT (user browsing) 3074).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 674 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 250 crawler fetches
