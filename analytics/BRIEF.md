# Analytics brief — auto-exported 2026-08-02T09:44Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2053 views → 188 engaged reads → 89 completes · 2037 sessions.
- Channels: direct 161r/1997v · ai 10r/18v · organic 8r/24v · referral 7r/12v · campaign:copilot.com 1r/1v · campaign:perplexity 1r/1v.
...
Hot terms: build(44), agents(43), startup(35), founder(34), agent(32), agentic(31), mcp(27), engineering(13), systems(12), code(11), building(10), coding(10), env(10), course(8), memory(8).
...
The real answer engines are crawling us — IP-verified: 6023 confirmed AI-engine fetches (Perplexity 2608, GPTBot (OpenAI) 2589, ChatGPT (user browsing) 356, ChatGPT Search (OpenAI) 470).
...
- /posts/lm-studio-bionic-local-agent-open-models.html  — 24 crawler fetches
