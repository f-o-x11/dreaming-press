# Analytics brief — auto-exported 2026-08-25T11:50Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2988 views → 237 engaged reads → 58 completes · 2938 sessions.
- Channels: direct 165r/2841v · organic 41r/73v · referral 11r/32v · campaign:chatgpt.com 11r/21v · ai 9r/19v · campaign:perplexity 0r/1v · social 0r/1v · internal-nav 0r/0v.
...
- direct: 2841 views · read 5.8% · complete 1.9% · 1 pages/session · median 4s
...
- [stack] "Neo4j vs FalkorDB vs Memgraph: Choosing a Graph Database for GraphRAG" — 6 reads, 14 views, 0 listens
- [stack] "What It Actually Costs to Rent an H100, H200, or B200 in August 2026" — 5 reads, 23 views, 0 listens
- [wire] "Reasoning Effort vs. Thinking Budget: How to Control How Much Your Model Thinks" — 5 reads, 8 views, 0 listens
...
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 428 retrieval fetches
- /  — 423 retrieval fetches
...
Per engine:
- ChatGPT-User (4772 verified): /posts/agent-funding-august-2026-control-won-the-summer.html ×428 · / ×381 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×326
- PerplexityBot (2729 verified): / ×32 · /build ×21 · /tags/opinionated ×15
- OAI-SearchBot (1148 verified): /build ×24 · / ×10 · /posts/langfuse-vs-arize-phoenix-vs-braintrust-llm-observability-solo-founder.html ×6
...
Hot terms: agents(37), founder(30), startup(26), agentic(24), mcp(22), build(22), agent(21), coding(15), code(11), about(11), building(10), engineering(10), google(10), tools(10), claude(8).
...
## Uncovered search demand (277 of 442 phrases have NO post, 1h ago)
...
The real answer engines are crawling us — IP-verified: 13370 confirmed AI-engine fetches (ChatGPT (user browsing) 4772, GPTBot (OpenAI) 4721, Perplexity 2729, ChatGPT Search (OpenAI) 1148).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 768 crawler fetches
- /posts/agent-funding-august-2026-control-won-the-summer.html  — 428 crawler fetches
...
- /posts/how-to-harden-your-repo-against-ai-agent-poisoned-prs.html  — 140 crawler fetches
...
- /posts/2026-06-27-scale-to-zero-llm-inference-gpu-cold-starts.html  — 51 crawler fetches
