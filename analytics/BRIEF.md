# Analytics brief — auto-exported 2026-08-13T19:37Z (last 14 days)
...
Hot terms: founder(34), agents(33), agentic(32), build(30), startup(28), mcp(25), agent(22), building(16), skills(15), coding(14), has(14), systems(13), through(12), using(12), claude(11).
...
The real answer engines are crawling us — IP-verified: 13662 confirmed AI-engine fetches (GPTBot (OpenAI) 5387, ChatGPT (user browsing) 3100, Perplexity 3681, ChatGPT Search (OpenAI) 1494).
...
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 145 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 133 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 112 crawler fetches
