# Analytics brief — auto-exported 2026-08-31T05:10Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3705 views → 258 engaged reads → 59 completes · 3631 sessions.
...
- OAI-SearchBot (2020 verified): /build ×31 · / ×11 · /posts/cheapest-terminal-coding-agent-august-2026-free-floor.html ×8
...
The real answer engines are crawling us — IP-verified: 8663 confirmed AI-engine fetches (ChatGPT (user browsing) 3643, GPTBot (OpenAI) 2412, ChatGPT Search (OpenAI) 2020, Perplexity 588).
