# Analytics brief — auto-exported 2026-09-26T11:26Z (last 14 days)
...
- OAI-SearchBot (4648 verified): /wire.html ×59 · /tools ×35 · /posts/2026-08-31-founders-wire-openai-cursor-cutoff-claudeforce-a16z-machine-age.html ×31
...
Hot terms: agents(39), founder(37), agent(34), startup(28), agentic(26), build(23), coding(20), building(17), mcp(16), claude(14), jev(11), code(9), one(9), workflows(9), research(7).
...
The real answer engines are crawling us — IP-verified: 19254 confirmed AI-engine fetches (Perplexity 7436, ChatGPT Search (OpenAI) 4648, GPTBot (OpenAI) 4074, ChatGPT (user browsing) 3096).
