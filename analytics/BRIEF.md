# Analytics brief — auto-exported 2026-07-23T00:04Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2417 views → 132 engaged reads → 60 completes · 2382 sessions.
- Channels: direct 121r/2333v · referral 5r/8v · organic 3r/71v · ai 3r/5v.
...
The real answer engines are crawling us — IP-verified: 4563 confirmed AI-engine fetches (GPTBot (OpenAI) 4452, ChatGPT (user browsing) 37, ChatGPT Search (OpenAI) 52, Perplexity 22).
