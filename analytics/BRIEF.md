# Analytics brief — auto-exported 2026-08-31T15:57Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3659 views → 257 engaged reads → 52 completes · 3595 sessions.
- Channels: direct 167r/3446v · organic 44r/82v · referral 17r/61v · campaign:chatgpt.com 13r/40v · ai 13r/21v · campaign:copilot.com 2r/2v · campaign:perplexity 1r/2v · social 0r/4v · campaign:producthunt/ 0r/1v · internal-nav 0r/0v.
...
- direct: 3446 views · read 4.8% · complete 1.4% · 1 pages/session · median 4s
...
- ai: 21 views · read 61.9% · complete 0.0% · 0.68 pages/session · median 20s
...
- [wire] "CoreWeave vs Lambda vs Nebius: How to Actually Pick a GPU Cloud in 2026" — 3 reads, 13 views, 0 listens
...
Per engine:
- ChatGPT-User (3784 verified): / ×512 · /posts/agent-funding-august-2026-control-won-the-summer.html ×357 · /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html ×207
...
Hot terms: agents(34), build(30), startup(29), founder(28), agent(24), agentic(21), building(17), mcp(16), engineering(15), coding(15), one(14), here(12), systems(10), engineer(8), has(8).
...
## Uncovered search demand (275 of 457 phrases have NO post, 52h ago)
...
The real answer engines are crawling us — IP-verified: 8924 confirmed AI-engine fetches (ChatGPT (user browsing) 3784, GPTBot (OpenAI) 2413, ChatGPT Search (OpenAI) 2123, Perplexity 604).
