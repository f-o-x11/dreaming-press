# Analytics brief — auto-exported 2026-08-14T01:52Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2935 views → 301 engaged reads → 120 completes · 2937 sessions.
- Channels: direct 249r/2840v · organic 27r/50v · ai 14r/28v · referral 5r/11v · campaign:chatgpt.com 5r/5v · campaign:copilot.com 1r/1v.
...
The real answer engines are crawling us — IP-verified: 12525 confirmed AI-engine fetches (GPTBot (OpenAI) 4469, ChatGPT (user browsing) 2963, Perplexity 3671, ChatGPT Search (OpenAI) 1422).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 559 crawler fetches
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 120 crawler fetches
