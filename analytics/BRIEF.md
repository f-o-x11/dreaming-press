# Analytics brief — auto-exported 2026-08-08T11:43Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2890 views → 272 engaged reads → 110 completes · 2893 sessions.
- Channels: direct 237r/2818v · organic 18r/35v · ai 11r/25v · referral 4r/10v · campaign:chatgpt.com 1r/1v · campaign:copilot.com 1r/1v.
...
- [stack] "sqlite-vec vs LanceDB vs Qdrant: Picking the Vector Store for Agent Memory" — 5 reads, 9 views, 0 listens
...
Hot terms: build(41), agentic(39), agents(34), mcp(31), startup(26), skills(24), building(23), founder(23), agent(20), engineering(14), claude(12), course(12), coding(11), systems(11), using(10).
...
The real answer engines are crawling us — IP-verified: 8943 confirmed AI-engine fetches (GPTBot (OpenAI) 4623, Perplexity 2096, ChatGPT (user browsing) 1132, ChatGPT Search (OpenAI) 1092).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 117 crawler fetches
...
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 61 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 60 crawler fetches
- /posts/how-to-trace-and-evaluate-an-ai-agent-with-langfuse.html  — 59 crawler fetches
