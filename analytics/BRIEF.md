# Analytics brief — auto-exported 2026-09-17T23:22Z (last 14 days)
...
- OAI-SearchBot (3660 verified): /wire.html ×46 · /tools ×31 · /posts/ai-coding-agent-ranking-2026.html ×30
- ChatGPT-User (3134 verified): / ×599 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×141 · /posts/open-source-llm-for-coding-september-2026.html ×122
...
Hot terms: agents(32), agentic(28), startup(28), founder(27), mcp(19), building(18), agent(17), build(15), systems(14), coding(11), actually(9), about(9), learn(9), google(9), run(8).
...
The real answer engines are crawling us — IP-verified: 24718 confirmed AI-engine fetches (Perplexity 13666, GPTBot (OpenAI) 4258, ChatGPT Search (OpenAI) 3660, ChatGPT (user browsing) 3134).
