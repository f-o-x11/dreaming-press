# Analytics brief — auto-exported 2026-08-14T05:24Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2923 views → 296 engaged reads → 117 completes · 2924 sessions.
- Channels: direct 244r/2827v · organic 27r/50v · ai 14r/28v · referral 5r/11v · campaign:chatgpt.com 5r/6v · campaign:copilot.com 1r/1v.
...
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 12 reads, 64 views, 0 listens
...
- [wire] "The Founder's Wire, Week of August 10: Claude Code Patched Three Agent-Permission Bypasses, Codex Started Redacting Secrets, and Stateless MCP Landed in Both" — 3 reads, 59 views, 0 listens
...
- [wire] "AI-Agent Funding, August 2026: 'Control the Agents' Won the Summer" — 64 views, 12 reads
...
- [wire] "China Regulated the AI Persona, Not the Model — So Doubao and Qwen Are Killing Their Agents on July 15" — 56 views, 0 reads
...
- [wire] "China Regulated the AI Persona, Not the Model — So Doubao and Qwen Are Killing Their Agents on July 15" — 56 views but only 0 engaged reads (0.0%)
...
Hot terms: founder(32), agentic(31), build(30), startup(28), agents(27), agent(23), mcp(22), building(15), coding(15), through(14), systems(14), engineering(14), skills(13), using(13), has(13).
Hashtags: #ai, #startup, #startups, #founder, #buildinpublic, #saas, #helyes, #googlecloud, #agenticai, #gemini.
...
## Uncovered search demand (296 of 440 phrases have NO post, 42h ago)
...
The real answer engines are crawling us — IP-verified: 12591 confirmed AI-engine fetches (GPTBot (OpenAI) 4470, ChatGPT (user browsing) 3021, Perplexity 3677, ChatGPT Search (OpenAI) 1423).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 563 crawler fetches
- /posts/coreweave-vs-lambda-vs-nebius-gpu-cloud.html  — 209 crawler fetches
- /posts/agent-funding-july-2026-control-vs-vertical-bet.html  — 151 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 136 crawler fetches
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 125 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 114 crawler fetches
- /posts/2026-07-22-founders-wire-portable-context-agents-in-chat-open-coders.html  — 110 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 110 crawler fetches
- /posts/ai-agent-memory-benchmarks-locomo-mem0-zep.html  — 56 crawler fetches
...
- /posts/pre-filtering-vs-post-filtering-vector-search.html  — 21 crawler fetches
