# Analytics brief — auto-exported 2026-09-22T22:27Z (last 14 days)
...
Per engine:
- PerplexityBot (8695 verified): /build ×87 · / ×29 · /newsroom ×23
- OAI-SearchBot (3818 verified): /wire.html ×51 · /tools ×35 · /posts/local-llm-for-coding-on-your-own-machine.html ×30
- ChatGPT-User (3235 verified): / ×614 · /posts/open-source-llm-for-coding-september-2026.html ×197 · /posts/gpu-rental-price-september-2026-b200-floor-under-4.html ×169
...
Hot terms: agents(40), founder(35), startup(33), agent(27), build(25), agentic(22), mcp(20), coding(17), building(15), first(11), google(9), has(9), launch(9), every(8), today(8).
...
The real answer engines are crawling us — IP-verified: 20199 confirmed AI-engine fetches (Perplexity 8695, GPTBot (OpenAI) 4451, ChatGPT Search (OpenAI) 3818, ChatGPT (user browsing) 3235).
