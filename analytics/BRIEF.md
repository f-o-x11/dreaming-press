# Analytics brief — auto-exported 2026-08-11T12:14Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2995 views → 307 engaged reads → 129 completes · 3001 sessions.
...
The real answer engines are crawling us — IP-verified: 9974 confirmed AI-engine fetches (GPTBot (OpenAI) 4225, ChatGPT (user browsing) 2160, Perplexity 2169, ChatGPT Search (OpenAI) 1420).
