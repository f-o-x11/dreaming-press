# Analytics brief — auto-exported 2026-09-01T19:01Z (last 14 days)
...
- OAI-SearchBot (2410 verified): /build ×36 · / ×13 · /posts/kimi-k3-vs-opus-vs-gpt-56-coding-agent-cost.html ×10
...
Hot terms: agents(33), agentic(31), agent(30), build(28), coding(28), founder(26), startup(23), one(16), building(14), mcp(13), systems(12), here(12), code(10), engineering(9), has(9).
...
The real answer engines are crawling us — IP-verified: 8677 confirmed AI-engine fetches (ChatGPT (user browsing) 3518, ChatGPT Search (OpenAI) 2410, GPTBot (OpenAI) 2370, Perplexity 379).
