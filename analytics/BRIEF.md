# Analytics brief — auto-exported 2026-08-15T04:39Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 2965 views → 300 engaged reads → 112 completes · 2962 sessions.
- Channels: direct 248r/2870v · organic 29r/54v · ai 12r/24v · referral 5r/10v · campaign:chatgpt.com 5r/6v · campaign:copilot.com 1r/1v.
...
Hot terms: build(31), agents(31), startup(31), founder(29), agent(28), agentic(27), mcp(18), coding(15), building(15), engineering(15), systems(12), through(12), using(12), model(11), stack(11).
...
## Uncovered search demand (290 of 439 phrases have NO post, 17h ago)
...
The real answer engines are crawling us — IP-verified: 12760 confirmed AI-engine fetches (GPTBot (OpenAI) 4469, ChatGPT (user browsing) 3068, Perplexity 3831, ChatGPT Search (OpenAI) 1392).
...
- /posts/gpu-rental-price-map-h100-h200-b200-august-2026.html  — 152 crawler fetches
- /posts/lm-studio-bionic-local-agent-open-models.html  — 135 crawler fetches
- /posts/2026-07-20-founders-wire-mcp-locks-kimi-k3-claude-code.html  — 133 crawler fetches
- /posts/2026-07-22-founders-wire-portable-context-agents-in-chat-open-coders.html  — 129 crawler fetches
- /posts/2026-07-30-founders-wire-mcp-final-tasks-mcp-apps-what-shipped.html  — 128 crawler fetches
- /posts/claude-code-auto-mode-default-august-14-what-founders-check.html  — 125 crawler fetches
