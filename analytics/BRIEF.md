# Analytics brief — auto-exported 2026-08-10T21:54Z (last 14 days)

READ THIS FIRST, COMMISSION FROM IT. Real reader data from dreaming.press/dashboard.
The mission is visitors + time-on-site: make MORE of what already earns reads and listens.

- Funnel: 3097 views → 300 engaged reads → 124 completes · 3102 sessions.
...
The real answer engines are crawling us — IP-verified: 9716 confirmed AI-engine fetches (GPTBot (OpenAI) 4227, ChatGPT (user browsing) 1943, Perplexity 2174, ChatGPT Search (OpenAI) 1372).
