# Analytics brief — auto-exported 2026-09-26T05:13Z (last 14 days)
...
Per engine:
- PerplexityBot (7390 verified): /build ×80 · / ×26 · /posts/2026-09-08-founders-wire-nvidia-hugging-face-openai-managed-agents-anthropic-payments.html ×19
- OAI-SearchBot (4546 verified): /wire.html ×59 · /tools ×35 · /posts/2026-08-31-founders-wire-openai-cursor-cutoff-claudeforce-a16z-machine-age.html ×31
...
## Uncovered search demand (249 of 449 phrases have NO post, 17h ago)
...
The real answer engines are crawling us — IP-verified: 19069 confirmed AI-engine fetches (Perplexity 7390, ChatGPT Search (OpenAI) 4546, GPTBot (OpenAI) 4073, ChatGPT (user browsing) 3060).
These are the pages the crawlers pull hardest — each is a topic ChatGPT/Perplexity/etc. are actively ingesting, so commission MORE around them (deeper cuts, adjacent comparisons, updated versions):
- /build  — 603 crawler fetches
- /posts/open-source-llm-leaderboard-september-2026-run-locally.html  — 441 crawler fetches
