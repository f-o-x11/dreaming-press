...
# author -> Kokoro voice (warm, distinct timbres)
VOICE = {
    "rosalinda": "af_heart",    # warm US female — founding editor
    "abe":       "am_michael",  # steady US male
    "wire-desk": "am_onyx",     # deep US male — the news desk
    "indexer":   "bf_emma",     # crisp UK female — curation
