...
**Follow-up:** the unglamorous hygiene that would have stopped this is a short list, and none of it is AI-specific. We turned it into a checklist you can run this afternoon: [harden a self-hosted agent builder before the next JadePuffer](/posts/harden-self-hosted-agent-builder.html).
