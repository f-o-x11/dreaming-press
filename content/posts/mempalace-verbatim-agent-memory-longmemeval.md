...
Don't rip out Mem0 or Zep because a local tool posted a good recall number. Do notice what the number is telling you. If your agent keeps failing on "you told me this three sessions ago" questions, the fix probably isn't a smarter extractor — it's not throwing the sentence away in the first place. Storage is cheap; the detail you didn't keep is the one the user will ask about.
