...
[Tasks](/posts/mcp-tools-vs-resources-vs-prompts.html), shipped experimentally in 2025-11-25, moves out of the core spec and into an extension, redesigned around the stateless model — servers answer `tools/call` with a task handle, clients drive it with `tasks/get`, `tasks/update`, and `tasks/cancel`.
